...
namespace Spartane.Services.User.Mock
{
    public class MockSpartanUserFavoriteListService : ISpartanUserFavoriteListService
    {
        ...
        public MockSpartanUserFavoriteListService()
        {
            ...
            {
                new Spartan_User_Favorite_List{ Favorite_ListId=1, Order_Shown=1, Object = new Spartan_Object { ObjectId=1, Url = "Users/Index", Name = "Usuarios" }},
                new Spartan_User_Favorite_List{ Favorite_ListId=2, Order_Shown=2, Object = new Spartan_Object { ObjectId=2, Url = "Users/GridMvvm", Name = "Usuarios MVVM" }}
            };
        }
