...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_ActionController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50003, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50003);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50003, PermissionType = PermissionTypes.New,
        ...
        public ActionResult Create(int Id = 0,  int consult = 0)
        {
            ...
            var permissionSpartan_BR_Action_Configuration_Detail = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50006);
            ViewBag.PermissionSpartan_BR_Action_Configuration_Detail = permissionSpartan_BR_Action_Configuration_Detail;
            var permissionSpartan_BR_Attribute_Restrictions_Detail = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50004);
            ViewBag.PermissionSpartan_BR_Attribute_Restrictions_Detail = permissionSpartan_BR_Attribute_Restrictions_Detail;
            var permissionSpartan_BR_Operation_Restrictions_Detail = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50009);
            ViewBag.PermissionSpartan_BR_Operation_Restrictions_Detail = permissionSpartan_BR_Operation_Restrictions_Detail;
            var permissionSpartan_BR_Event_Restrictions_Detail = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50007);
