...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Action_ClassificationController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50005, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50005);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50005, PermissionType = PermissionTypes.New,
