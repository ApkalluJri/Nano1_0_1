...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Action_Param_TypeController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50010, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50010);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50010, PermissionType = PermissionTypes.New,
