...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Condition_OperatorController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50014, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50014);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50014, PermissionType = PermissionTypes.New,
