...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_OperationController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50016, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50016);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50016, PermissionType = PermissionTypes.New,
