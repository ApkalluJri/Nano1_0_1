...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Operator_TypeController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50018, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50018);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50018, PermissionType = PermissionTypes.New,
