...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_Presentation_Control_TypeController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50019, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50019);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50019, PermissionType = PermissionTypes.New,
