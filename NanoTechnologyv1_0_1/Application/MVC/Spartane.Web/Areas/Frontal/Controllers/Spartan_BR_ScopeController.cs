...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_ScopeController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50022, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50022);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50022, PermissionType = PermissionTypes.New,
