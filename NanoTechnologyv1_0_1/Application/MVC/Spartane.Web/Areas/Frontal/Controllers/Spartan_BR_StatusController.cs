...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_BR_StatusController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50024, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 50024);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)50024, PermissionType = PermissionTypes.New,
