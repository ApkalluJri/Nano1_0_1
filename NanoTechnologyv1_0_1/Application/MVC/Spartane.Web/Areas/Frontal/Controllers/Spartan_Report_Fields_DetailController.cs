...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Spartan_Report_Fields_DetailController : Controller
    {
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)32035, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 32035);
        ...
        [ObjectAuth(ObjectId = (ModuleObjectId)32035, PermissionType = PermissionTypes.New,
        ...
        public ActionResult Create(int Id = 0,  int consult = 0)
        {
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || (Id.GetType() == typeof(int) && Id.ToString() != "0"))
            {
                ...
                varSpartan_Report_Fields_Detail = new Spartan_Report_Fields_DetailModel
                {
                    ...
                    ,AttributeIdPhysical_Name =  (string)Spartan_Report_Fields_DetailData.AttributeId_Spartan_Metadata.Physical_Name
            ...
            var Spartan_Report_Functions = _ISpartan_Report_FunctionApiConsumer.SelAll(true);
            if (Spartan_Report_Functions != null && Spartan_Report_Functions.Resource != null)
                ViewBag.Spartan_Report_Functions = Spartan_Report_Functions.Resource.Select(m => new SelectListItem
                {
            ...
            var Spartan_Report_Formats = _ISpartan_Report_FormatApiConsumer.SelAll(true);
            if (Spartan_Report_Formats != null && Spartan_Report_Formats.Resource != null)
                ViewBag.Spartan_Report_Formats = Spartan_Report_Formats.Resource.Select(m => new SelectListItem
                {
            ...
            var Spartan_Report_Order_Types = _ISpartan_Report_Order_TypeApiConsumer.SelAll(true);
            if (Spartan_Report_Order_Types != null && Spartan_Report_Order_Types.Resource != null)
                ViewBag.Spartan_Report_Order_Types = Spartan_Report_Order_Types.Resource.Select(m => new SelectListItem
                {
            ...
            var Spartan_Report_Field_Types = _ISpartan_Report_Field_TypeApiConsumer.SelAll(true);
            if (Spartan_Report_Field_Types != null && Spartan_Report_Field_Types.Resource != null)
                ViewBag.Spartan_Report_Field_Types = Spartan_Report_Field_Types.Resource.Select(m => new SelectListItem
                {
            ...
            var Spartan_Metadatas = _ISpartan_MetadataApiConsumer.SelAll(true);
            if (Spartan_Metadatas != null && Spartan_Metadatas.Resource != null)
                ViewBag.Spartan_Metadatas = Spartan_Metadatas.Resource.Select(m => new SelectListItem
                {
	...
	[HttpGet]
        public ActionResult AddSpartan_Report_Fields_Detail(int rowIndex = 0, int functionMode = 0, int id = 0)
        {
           ...
           _ISpartan_Report_Fields_DetailApiConsumer.SetAuthHeader(_tokenManager.Token);
            ...
            if (id.ToString() != "0")
            {
                var Spartan_Report_Fields_DetailsData = _ISpartan_Report_Fields_DetailApiConsumer.ListaSelAll(0, 1000, "DesignDetailId=" + id, "").Resource.Spartan_Report_Fields_Details;
        ...
        public ActionResult Get()
        {
			...
			,Order_Number = m.Order_Number
                        ,AttributeIdPhysical_Name = (string)m.AttributeId_Spartan_Metadata.Physical_Name
