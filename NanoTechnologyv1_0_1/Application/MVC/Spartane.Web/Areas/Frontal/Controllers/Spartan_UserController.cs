        ...
        public ActionResult Post(bool IsNew, Spartan_UserModel varSpartan_User)
        {
            try
            {
				...
				//{
                    ...
                    {
                        Id_User = varSpartan_User.Id_User
                        ,Name = varSpartan_User.Name
                        ,Role = varSpartan_User.Role
                        ,Image = varSpartan_User.Image ?? varSpartan_User.Image
                        ,Email = varSpartan_User.Email
                        ,Status = varSpartan_User.Status
                        ,Username = varSpartan_User.Username
                        ,Password = varSpartan_User.Password
