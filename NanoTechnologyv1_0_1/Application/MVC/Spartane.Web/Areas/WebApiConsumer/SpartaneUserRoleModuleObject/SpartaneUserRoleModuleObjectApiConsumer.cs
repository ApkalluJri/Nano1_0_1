...
namespace Spartane.Web.Areas.WebApiConsumer.SpartaneUserRoleModuleObject
{
    public class SpartaneUserRoleModuleObjectApiConsumer : BaseApiConsumer, ISpartaneUserRoleModuleObjectApiConsumer
    {
        ...
        public ApiResponse<IList<Core.Domain.Spartan_Additional_Menu.Spartan_Additional_Menu>> GetAdditionalMenu(int user_Role_Id)
        {
            try
            {
                var AdditionalMenus = RestApiHelper.InvokeApi<IList<Spartane.Core.Domain.Spartan_Additional_Menu.Spartan_Additional_Menu>>(baseApi, AdditionalMenuApiControllerUrl + "/GetMenu?user=" + user_Role_Id.ToString(),
                      Method.GET, ApiHeader);
