            ...
            if (CurrentUser != null && CurrentUser.Identity != null && CurrentUser.Identity.IsAuthenticated)
            {
                ...
                if (authCookie != null && !string.IsNullOrWhiteSpace(authCookie.Value))
                {
                    ...
                    if (SessionHelper.UserEntity == null || SessionHelper.UserCredential == null)
                    {
                        ...
                        Spartan_User_Core UserDetails = _IUseroApiConsumer.ValidateUser(1, 10, "Username = '" + auth.UserContext.CurrentUser.UserName + "'  COLLATE SQL_Latin1_General_CP1_CS_AS And Password = '" + auth.UserContext.CurrentUser.UserName + "'  COLLATE SQL_Latin1_General_CP1_CS_AS").Resource;
