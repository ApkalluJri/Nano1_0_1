...
namespace Spartane.Web.Helpers
{
    ...
    public static class MenuHelper
    {
        ...
        public static void GetLatestMenu()
        {
            ...
            _SpartaneUserRoleModuleObject = _spartaneUserRoleModuleObjectApiConsumer.SelAll(true).Resource.ToList();
            ...
            {
                var UserAdditionalMenu = _spartaneUserRoleModuleObjectApiConsumer.GetAdditionalMenu(userRole.User_Role_Id).Resource.ToList();
                lstUserRoleModules = userRoleModuleAll.Where(m => m.Spartan_User_Role == userRole.User_Role_Id).ToList();
        ...
        public static List<RecursiveInnerObject> GetModuleObjects(int roleId, long moduleId)
        {
            ...
            var userRoleModuleObjects =
                _SpartaneUserRoleModuleObject.Where(m => m.Module_Id == moduleId && m.Spartan_User_Role == roleId);
