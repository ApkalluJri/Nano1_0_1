...
function CheckValidation() {
    ...
    {
        alert('Ha dejado un renglón pendiente de guardar en Configuration')
        return false;
    }
    if (Spartan_BR_Attribute_Restrictions_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Attribute Restrictions')
        return false;
    }
    if (Spartan_BR_Operation_Restrictions_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Operation Restrictions')
        return false;
    }
    if (Spartan_BR_Event_Restrictions_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Process Event Restrictions')
        return false;
    }
