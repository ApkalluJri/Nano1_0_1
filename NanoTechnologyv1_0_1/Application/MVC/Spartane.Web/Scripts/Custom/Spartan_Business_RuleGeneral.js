...
function GetInsertSpartan_BR_Actions_True_DetailRowControls(index) {
    ...
    columnData[5] = $($.parseHTML(inputData)).addClass('Spartan_BR_Actions_True_Detail_Paramater_3').attr('id', 'Spartan_BR_Actions_True_Detail_Paramater_3_' + index);
    columnData[6] = $($.parseHTML(inputData)).addClass('Spartan_BR_Actions_True_Detail_Paramater_4').attr('id', 'Spartan_BR_Actions_True_Detail_Paramater_4_' + index);
...
function Spartan_BR_Actions_True_DetailInsertRow(rowIndex) {
    ...
    var newData = {
        ...
        ,Paramater_3: data.childNodes[6].childNodes[0].value
        ,Paramater_4: data.childNodes[7].childNodes[0].value
    ...
    for (var i = 0; i < gridData.length; i++) {
        if (gridData[i].IsInsertRow == null || !gridData[i].IsInsertRow)
            Spartan_BR_Actions_True_DetailData.push({
                ...
                ,Paramater_3: gridData[i].Paramater_3
                ,Paramater_4: gridData[i].Paramater_4
    ...
    for (i = 0; i < removedSpartan_BR_Actions_True_DetailData.length; i++) {
        if (removedSpartan_BR_Actions_True_DetailData[i] != null && removedSpartan_BR_Actions_True_DetailData[i].ActionsTrueDetailId > 0)
            Spartan_BR_Actions_True_DetailData.push({
                ...
                ,Paramater_3: removedData[i].Paramater_3
                ,Paramater_4: removedData[i].Paramater_4
...
function Spartan_BR_Actions_True_DetailEditRowPopup(rowIndex) {
    ...
    $('#Paramater_3Pop').val(prevData.Paramater_3);
    $('#Paramater_4Pop').val(prevData.Paramater_4);
...
function GetSpartan_BR_Actions_True_Detail() {
    ...
    for (var i = 0; i < Spartan_BR_Actions_True_DetailData.length; i++) {
        ...
        form_data.append('[' + i + '].Paramater_3', Spartan_BR_Actions_True_DetailData[i].Paramater_3);
        form_data.append('[' + i + '].Paramater_4', Spartan_BR_Actions_True_DetailData[i].Paramater_4);
...
function Spartan_BR_Actions_True_DetailInsertRowFromPopup(rowIndex) {
    ...
    var newData = {
        ...
        ,Paramater_3: $('#Paramater_3Pop').val()
        ,Paramater_4: $('#Paramater_4Pop').val()
...
function CheckValidation() {
    ...
    {
        alert('Ha dejado un renglón pendiente de guardar en Scope')
        return false;
    }
    if (Spartan_BR_Operation_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Operation')
        return false;
    }
    if (Spartan_BR_Process_Event_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Process Event')
        return false;
    }
    if (Spartan_BR_Conditions_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Conditions')
        return false;
    }
    if (Spartan_BR_Actions_True_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Actions if Fulfills')
        return false;
    }
    if (Spartan_BR_Actions_False_DetailcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Actions if not Fulfills')
        return false;
    }
    if (Spartan_BR_Modifications_LogcountRowsChecked > 0)
    {
        alert('Ha dejado un renglón pendiente de guardar en Modifications Log')
        return false;
    }
