function setFilter(tableId, tableInstance) {
    ...
    $('#' + tableId + ' > tfoot > tr > .filterColumn').each(function () {
        ...
        switch ($(this).attr('s-spartan')) {
            ...
            case "checkbox":
                ...
                break;
            case "date":
                $(this).html("<div class=\"input-group date\"><span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span><input type=\"text\" style=\"width:100px !important\" class=\"datepicker filterData form-control\"  /></div>");
                break;
            case "time":
                $(this).html("<div data-autoclose=\"true\" class=\"input-group clockpicker\"><input type=\"text\" style=\"width:100px!important\" class=\"clockpicker filterData form-control\"  /><span class=\"input-group-addon\"><span class=\"fa fa-clock-o\"></span></span></div>");
                break;
            case "dropdown":
    ...
    tableInstance.columns().every(function () {
        ...
        //Esto es para que funcione en IE
