...
function ParentescoDisplayBusinessRule() {
    if (!ParentescoisdisplayBusinessPropery) {
        $('#CreateParentesco').find('.col-sm-8').each(function () {
            ...
            mainElementAttributes += '<div class="displayBusinessPropery"><button type="button" data-field-id="' + fieldId + '" data-field-name="' + fieldName + '" data-attribute="' + attribute + '" class="btn btn-info btn-lg btnPopupBusinessRules" data-toggle="modal" data-target="#ParentescoPropertyBusinessModal-form"><i class="fa fa-cogs fa-spin"></i></button></div>';
            mainElementAttributes += '</div>';
