...
namespace AutorizacionCS
{
    public class AutorizacionFilters
    {
...
public class objectBussinessAutorizacion : IDisposable
{
    ...
    private AutorizacionFilters[] filters; 
    ...
    public AutorizacionFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public AutorizacionFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new AutorizacionFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Autorizacion_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Autorizacion";
            ...
            if (this.filters !=null)
                foreach (AutorizacionCS.AutorizacionFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Autorizacion", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllAutorizacion";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (AutorizacionCS.AutorizacionFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Autorizacion", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Autorizacion WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Autorizacion_Clave": sortExpression = "Autorizacion.Clave"; break;  case "Autorizacion_Descripcion": sortExpression = "Autorizacion.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Autorizacion.Clave, Autorizacion.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Autorizacion.Clave As Autorizacion_Clave,        Autorizacion.Descripcion As Autorizacion_Descripcion ";             string fieldsForExport = " Autorizacion.Clave As [Clave],        Autorizacion.Descripcion As [Descripcion] ";             string from = " from  Autorizacion WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Autorizacion.Clave As Autorizacion_Clave,        Autorizacion.Descripcion As Autorizacion_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Autorizacion.Clave, Autorizacion.Descripcion" : Order);         string from = " from  Autorizacion WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Autorizacion");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsAutorizacion";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Autorizacion");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdAutorizacion";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelAutorizacion";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Autorizacion_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Autorizacion_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Autorizacion";
            else
                com.CommandText="sp_GetAutorizacion";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Autorizacion.Clave As Autorizacion_Clave,        Autorizacion.Descripcion As Autorizacion_Descripcion   from  Autorizacion           Where Autorizacion.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Autorizacion.Clave As Autorizacion_Clave,        Autorizacion.Descripcion As Autorizacion_Descripcion   from  Autorizacion           Where Autorizacion.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Autorizacion_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
