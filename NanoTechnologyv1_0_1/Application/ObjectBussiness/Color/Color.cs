...
namespace ColorCS
{
    public class ColorFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.String varCodigo_RGB = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Codigo_RGB
        {
            get { return varCodigo_RGB; }
            set { varCodigo_RGB = value; }
        }

    }
public class objectBussinessColor : IDisposable
{
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Color_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Color";
            ...
            if (this.filters !=null)
                foreach (ColorCS.ColorFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Color", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllColor";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (ColorCS.ColorFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Color", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Color WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Color_Clave": sortExpression = "Color.Clave"; break;  case "Color_Descripcion": sortExpression = "Color.Descripcion"; break;  case "Color_Codigo_RGB": sortExpression = "Color.Codigo_RGB"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Color.Clave, Color.Descripcion, Color.Codigo_RGB" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Color.Clave As Color_Clave,        Color.Descripcion As Color_Descripcion,        Color.Codigo_RGB As Color_Codigo_RGB ";             string fieldsForExport = " Color.Clave As [Clave],        Color.Descripcion As [Descripcion],        Color.Codigo_RGB As [Codigo RGB] ";             string from = " from  Color WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Color.Clave As Color_Clave,        Color.Descripcion As Color_Descripcion,        Color.Codigo_RGB As Color_Codigo_RGB ";         Order = (Order == string.Empty || Order == null ? "Color.Clave, Color.Descripcion, Color.Codigo_RGB" : Order);         string from = " from  Color WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Color");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsColor";
            ...
            {
                com.Parameters.AddWithValue("@Descripcion", DBNull.Value);
            }            if (varCodigo_RGB!=null)
            {
                if (varCodigo_RGB != "")
                    com.Parameters.AddWithValue("@Codigo_RGB", Convierte(varCodigo_RGB, ConvierteAMayusculas));
                else
                    com.Parameters.AddWithValue("@Codigo_RGB", DBNull.Value);
            }
            else
            {
                com.Parameters.AddWithValue("@Codigo_RGB", DBNull.Value);
...
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Color_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Color_Descripcion"].ToString();
            Codigo_RGB = ds.Tables[0].Rows[0]["Color_Codigo_RGB"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Color";
            else
                com.CommandText="sp_GetColor";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Color.Clave As Color_Clave,        Color.Descripcion As Color_Descripcion,        Color.Codigo_RGB As Color_Codigo_RGB   from  Color           Where Color.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Color.Clave As Color_Clave,        Color.Descripcion As Color_Descripcion,        Color.Codigo_RGB As Color_Codigo_RGB   from  Color           Where Color.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyCodigo_RGB(String Key){
        DataSet ds;
        if (Key==null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Color.Clave As Color_Clave,        Color.Descripcion As Color_Descripcion,        Color.Codigo_RGB As Color_Codigo_RGB   from  Color           Where Color.Codigo_RGB = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Color_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
