...
namespace Detalle_de_Etiquetas_ContenidoCS
{
    public class Detalle_de_Etiquetas_ContenidoFilters
    {
...
public class objectBussinessDetalle_de_Etiquetas_Contenido : IDisposable
{
    ...
    private Detalle_de_Etiquetas_ContenidoFilters[] filters; 
    ...
    public Detalle_de_Etiquetas_ContenidoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Detalle_de_Etiquetas_ContenidoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Detalle_de_Etiquetas_ContenidoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Detalle_de_Etiquetas_Contenido_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Detalle_de_Etiquetas_Contenido";
            ...
            if (this.filters !=null)
                foreach (Detalle_de_Etiquetas_ContenidoCS.Detalle_de_Etiquetas_ContenidoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Detalle_de_Etiquetas_Contenido", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllDetalle_de_Etiquetas_Contenido";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Detalle_de_Etiquetas_ContenidoCS.Detalle_de_Etiquetas_ContenidoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Detalle_de_Etiquetas_Contenido", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Detalle_de_Etiquetas_Contenido WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Detalle_de_Etiquetas_Contenido_Clave": sortExpression = "Detalle_de_Etiquetas_Contenido.Clave"; break;  case "Detalle_de_Etiquetas_Contenido_Descripcion": sortExpression = "Detalle_de_Etiquetas_Contenido.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Detalle_de_Etiquetas_Contenido.Clave, Detalle_de_Etiquetas_Contenido.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Detalle_de_Etiquetas_Contenido.Clave As Detalle_de_Etiquetas_Contenido_Clave,        Detalle_de_Etiquetas_Contenido.Descripcion As Detalle_de_Etiquetas_Contenido_Descripcion ";             string fieldsForExport = " Detalle_de_Etiquetas_Contenido.Clave As [Clave],        Detalle_de_Etiquetas_Contenido.Descripcion As [Descripcion] ";             string from = " from  Detalle_de_Etiquetas_Contenido WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Detalle_de_Etiquetas_Contenido.Clave As Detalle_de_Etiquetas_Contenido_Clave,        Detalle_de_Etiquetas_Contenido.Descripcion As Detalle_de_Etiquetas_Contenido_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Detalle_de_Etiquetas_Contenido.Clave, Detalle_de_Etiquetas_Contenido.Descripcion" : Order);         string from = " from  Detalle_de_Etiquetas_Contenido WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Detalle_de_Etiquetas_Contenido");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsDetalle_de_Etiquetas_Contenido";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Detalle_de_Etiquetas_Contenido");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdDetalle_de_Etiquetas_Contenido";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelDetalle_de_Etiquetas_Contenido";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Detalle_de_Etiquetas_Contenido_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Detalle_de_Etiquetas_Contenido_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Detalle_de_Etiquetas_Contenido";
            else
                com.CommandText="sp_GetDetalle_de_Etiquetas_Contenido";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Etiquetas_Contenido.Clave As Detalle_de_Etiquetas_Contenido_Clave,        Detalle_de_Etiquetas_Contenido.Descripcion As Detalle_de_Etiquetas_Contenido_Descripcion   from  Detalle_de_Etiquetas_Contenido           Where Detalle_de_Etiquetas_Contenido.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Etiquetas_Contenido.Clave As Detalle_de_Etiquetas_Contenido_Clave,        Detalle_de_Etiquetas_Contenido.Descripcion As Detalle_de_Etiquetas_Contenido_Descripcion   from  Detalle_de_Etiquetas_Contenido           Where Detalle_de_Etiquetas_Contenido.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Detalle_de_Etiquetas_Contenido_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
