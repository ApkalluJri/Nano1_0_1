...
namespace Detalle_de_Notificacion_por_ObservatorioCS
{
    public class Detalle_de_Notificacion_por_ObservatorioFilters
    {
...
public class objectBussinessDetalle_de_Notificacion_por_Observatorio : IDisposable
{
    ...
    private Detalle_de_Notificacion_por_ObservatorioFilters[] filters; 
    ...
    public Detalle_de_Notificacion_por_ObservatorioFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Detalle_de_Notificacion_por_ObservatorioFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Detalle_de_Notificacion_por_ObservatorioFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Detalle_de_Notificacion_por_Observatorio_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Detalle_de_Notificacion_por_Observatorio";
            ...
            if (this.filters !=null)
                foreach (Detalle_de_Notificacion_por_ObservatorioCS.Detalle_de_Notificacion_por_ObservatorioFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Detalle_de_Notificacion_por_Observatorio", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllDetalle_de_Notificacion_por_Observatorio";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Detalle_de_Notificacion_por_ObservatorioCS.Detalle_de_Notificacion_por_ObservatorioFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Detalle_de_Notificacion_por_Observatorio", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from (( Detalle_de_Notificacion_por_Observatorio WITH(NoLock) LEFT JOIN Registro_de_Contenido as Contenido WITH(NoLock) ON Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio as Observatorio WITH(NoLock) ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)        " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Detalle_de_Notificacion_por_Observatorio_Clave": sortExpression = "Detalle_de_Notificacion_por_Observatorio.Clave"; break;  case "Detalle_de_Notificacion_por_Observatorio_Contenido": sortExpression = "Detalle_de_Notificacion_por_Observatorio.Contenido"; break;  case "Contenido_Folio": sortExpression = "Contenido.Folio"; break;  case "Detalle_de_Notificacion_por_Observatorio_Notificar": sortExpression = "Detalle_de_Notificacion_por_Observatorio.Notificar"; break;  case "Detalle_de_Notificacion_por_Observatorio_Observatorio": sortExpression = "Detalle_de_Notificacion_por_Observatorio.Observatorio"; break;  case "Observatorio_Nombre": sortExpression = "Observatorio.Nombre"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Detalle_de_Notificacion_por_Observatorio.Clave, Detalle_de_Notificacion_por_Observatorio.Contenido, Contenido.Folio, Detalle_de_Notificacion_por_Observatorio.Notificar, Detalle_de_Notificacion_por_Observatorio.Observatorio, Observatorio.Nombre" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Contenido.Folio AS Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre ";             string fieldsForExport = " Detalle_de_Notificacion_por_Observatorio.Clave As [Clave],        Detalle_de_Notificacion_por_Observatorio.Contenido AS [Contenido],        Contenido.Folio AS [Contenido Folio],        Detalle_de_Notificacion_por_Observatorio.Notificar As [Notificar],        Detalle_de_Notificacion_por_Observatorio.Observatorio AS [Observatorio],        Observatorio.Nombre AS [Observatorio Nombre] ";             string from = " from (( Detalle_de_Notificacion_por_Observatorio WITH(NoLock) LEFT JOIN Registro_de_Contenido as Contenido WITH(NoLock) ON Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio as Observatorio WITH(NoLock) ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)        " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Contenido.Folio AS Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre ";         Order = (Order == string.Empty || Order == null ? "Detalle_de_Notificacion_por_Observatorio.Clave, Detalle_de_Notificacion_por_Observatorio.Contenido, Contenido.Folio, Detalle_de_Notificacion_por_Observatorio.Notificar, Detalle_de_Notificacion_por_Observatorio.Observatorio, Observatorio.Nombre" : Order);         string from = " from (( Detalle_de_Notificacion_por_Observatorio WITH(NoLock) LEFT JOIN Registro_de_Contenido as Contenido WITH(NoLock) ON Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio as Observatorio WITH(NoLock) ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)        " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Detalle_de_Notificacion_por_Observatorio");
        int? sKeyClave = -1;
        try
        {
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Detalle_de_Notificacion_por_Observatorio");
            }
            catch{}
            throw ex; 
        }
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, int? KeyContenido, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelDetalle_de_Notificacion_por_Observatorio";
com.Parameters.AddWithValue("@Clave",KeyClave);com.Parameters.AddWithValue("@Contenido",KeyContenido);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Detalle_de_Notificacion_por_Observatorio_Clave"]);
            Contenido = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Detalle_de_Notificacion_por_Observatorio_Contenido"]);
            if (ds.Tables[0].Rows[0]["Detalle_de_Notificacion_por_Observatorio_Notificar"] != DBNull.Value)
                Notificar = Convert.ToBoolean(ds.Tables[0].Rows[0]["Detalle_de_Notificacion_por_Observatorio_Notificar"]);
            Observatorio = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Detalle_de_Notificacion_por_Observatorio_Observatorio"]);
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Detalle_de_Notificacion_por_Observatorio";
            else
                com.CommandText="sp_GetDetalle_de_Notificacion_por_Observatorio";
com.Parameters.AddWithValue("@Clave",KeyClave);com.Parameters.AddWithValue("@Contenido",KeyContenido);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Registro_de_Contenido.Folio AS Registro_de_Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre   from (( Detalle_de_Notificacion_por_Observatorio       LEFT JOIN Registro_de_Contenido ON Registro_de_Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)           Where Detalle_de_Notificacion_por_Observatorio.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Registro_de_Contenido.Folio AS Registro_de_Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre   from (( Detalle_de_Notificacion_por_Observatorio       LEFT JOIN Registro_de_Contenido ON Registro_de_Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)           Where Detalle_de_Notificacion_por_Observatorio.Contenido = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Registro_de_Contenido.Folio AS Registro_de_Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre   from (( Detalle_de_Notificacion_por_Observatorio       LEFT JOIN Registro_de_Contenido ON Registro_de_Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)           Where Detalle_de_Notificacion_por_Observatorio.Notificar = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Detalle_de_Notificacion_por_Observatorio.Clave As Detalle_de_Notificacion_por_Observatorio_Clave,        Detalle_de_Notificacion_por_Observatorio.Contenido AS Detalle_de_Notificacion_por_Observatorio_Contenido,        Registro_de_Contenido.Folio AS Registro_de_Contenido_Folio,        Detalle_de_Notificacion_por_Observatorio.Notificar As Detalle_de_Notificacion_por_Observatorio_Notificar,        Detalle_de_Notificacion_por_Observatorio.Observatorio AS Detalle_de_Notificacion_por_Observatorio_Observatorio,        Observatorio.Nombre AS Observatorio_Nombre   from (( Detalle_de_Notificacion_por_Observatorio       LEFT JOIN Registro_de_Contenido ON Registro_de_Contenido.Folio=Detalle_de_Notificacion_por_Observatorio.Contenido)       LEFT JOIN Observatorio ON Observatorio.Clave=Detalle_de_Notificacion_por_Observatorio.Observatorio)           Where Detalle_de_Notificacion_por_Observatorio.Observatorio = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave, int? KeyContenido)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Detalle_de_Notificacion_por_Observatorio_Clave"]) == KeyClave&& Function.FormatNumberNull(dt.Rows[i]["Detalle_de_Notificacion_por_Observatorio_Contenido"]) == KeyContenido)
                return i;
        }
        return -1;
    }
...
*///            public DataTable FillDataContenido(Object ctr, String Filtro){
            public DataTable FillDataContenido(String Filtro){
                TTDataLayerCS.BD db = new TTDataLayerCS.BD();
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_selDetalle_de_Notificacion_por_Observatorio_Relacion_Registro_de_Contenido";
                com.CommandType = CommandType.StoredProcedure;
                //ctr.Items.Clear();
                DataTable dt = db.Consulta(com).Tables[0];
...
*///            public DataTable FillDataObservatorio(Object ctr, String Filtro){
            public DataTable FillDataObservatorio(String Filtro){
                TTDataLayerCS.BD db = new TTDataLayerCS.BD();
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_selDetalle_de_Notificacion_por_Observatorio_Relacion_Observatorio";
                com.CommandType = CommandType.StoredProcedure;
                //ctr.Items.Clear();
                DataTable dt = db.Consulta(com).Tables[0];
                DataView d = new DataView(dt, Filtro, "", DataViewRowState.CurrentRows);
