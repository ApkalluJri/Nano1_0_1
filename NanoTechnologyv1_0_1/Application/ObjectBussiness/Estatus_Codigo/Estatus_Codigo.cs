...
namespace Estatus_CodigoCS
{
    public class Estatus_CodigoFilters
    {
...
public class objectBussinessEstatus_Codigo : IDisposable
{
    ...
    private Estatus_CodigoFilters[] filters; 
    ...
    public Estatus_CodigoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Estatus_CodigoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Estatus_CodigoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Estatus_Codigo_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Estatus_Codigo";
            ...
            if (this.filters !=null)
                foreach (Estatus_CodigoCS.Estatus_CodigoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Estatus_Codigo", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllEstatus_Codigo";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Estatus_CodigoCS.Estatus_CodigoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Estatus_Codigo", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Estatus_Codigo WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Estatus_Codigo_Clave": sortExpression = "Estatus_Codigo.Clave"; break;  case "Estatus_Codigo_Descripcion": sortExpression = "Estatus_Codigo.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Estatus_Codigo.Clave, Estatus_Codigo.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Estatus_Codigo.Clave As Estatus_Codigo_Clave,        Estatus_Codigo.Descripcion As Estatus_Codigo_Descripcion ";             string fieldsForExport = " Estatus_Codigo.Clave As [Clave],        Estatus_Codigo.Descripcion As [Descripcion] ";             string from = " from  Estatus_Codigo WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Estatus_Codigo.Clave As Estatus_Codigo_Clave,        Estatus_Codigo.Descripcion As Estatus_Codigo_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Estatus_Codigo.Clave, Estatus_Codigo.Descripcion" : Order);         string from = " from  Estatus_Codigo WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Estatus_Codigo");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsEstatus_Codigo";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Estatus_Codigo");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdEstatus_Codigo";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelEstatus_Codigo";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Estatus_Codigo_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Estatus_Codigo_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Estatus_Codigo";
            else
                com.CommandText="sp_GetEstatus_Codigo";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estatus_Codigo.Clave As Estatus_Codigo_Clave,        Estatus_Codigo.Descripcion As Estatus_Codigo_Descripcion   from  Estatus_Codigo           Where Estatus_Codigo.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estatus_Codigo.Clave As Estatus_Codigo_Clave,        Estatus_Codigo.Descripcion As Estatus_Codigo_Descripcion   from  Estatus_Codigo           Where Estatus_Codigo.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Estatus_Codigo_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
