...
namespace Estatus_de_ContenidoCS
{
    public class Estatus_de_ContenidoFilters
    {
...
public class objectBussinessEstatus_de_Contenido : IDisposable
{
    ...
    private Estatus_de_ContenidoFilters[] filters; 
    ...
    public Estatus_de_ContenidoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Estatus_de_ContenidoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Estatus_de_ContenidoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Estatus_de_Contenido_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Estatus_de_Contenido";
            ...
            if (this.filters !=null)
                foreach (Estatus_de_ContenidoCS.Estatus_de_ContenidoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Estatus_de_Contenido", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllEstatus_de_Contenido";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Estatus_de_ContenidoCS.Estatus_de_ContenidoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Estatus_de_Contenido", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Estatus_de_Contenido WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Estatus_de_Contenido_Clave": sortExpression = "Estatus_de_Contenido.Clave"; break;  case "Estatus_de_Contenido_Descripcion": sortExpression = "Estatus_de_Contenido.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Estatus_de_Contenido.Clave, Estatus_de_Contenido.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Estatus_de_Contenido.Clave As Estatus_de_Contenido_Clave,        Estatus_de_Contenido.Descripcion As Estatus_de_Contenido_Descripcion ";             string fieldsForExport = " Estatus_de_Contenido.Clave As [Clave],        Estatus_de_Contenido.Descripcion As [Descripcion] ";             string from = " from  Estatus_de_Contenido WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Estatus_de_Contenido.Clave As Estatus_de_Contenido_Clave,        Estatus_de_Contenido.Descripcion As Estatus_de_Contenido_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Estatus_de_Contenido.Clave, Estatus_de_Contenido.Descripcion" : Order);         string from = " from  Estatus_de_Contenido WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Estatus_de_Contenido");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsEstatus_de_Contenido";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Estatus_de_Contenido");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdEstatus_de_Contenido";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelEstatus_de_Contenido";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Estatus_de_Contenido_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Estatus_de_Contenido_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Estatus_de_Contenido";
            else
                com.CommandText="sp_GetEstatus_de_Contenido";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estatus_de_Contenido.Clave As Estatus_de_Contenido_Clave,        Estatus_de_Contenido.Descripcion As Estatus_de_Contenido_Descripcion   from  Estatus_de_Contenido           Where Estatus_de_Contenido.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estatus_de_Contenido.Clave As Estatus_de_Contenido_Clave,        Estatus_de_Contenido.Descripcion As Estatus_de_Contenido_Descripcion   from  Estatus_de_Contenido           Where Estatus_de_Contenido.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Estatus_de_Contenido_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
