...
namespace Estilo_de_ArticuloCS
{
    public class Estilo_de_ArticuloFilters
    {
...
public class objectBussinessEstilo_de_Articulo : IDisposable
{
    ...
    private Estilo_de_ArticuloFilters[] filters; 
    ...
    public Estilo_de_ArticuloFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Estilo_de_ArticuloFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Estilo_de_ArticuloFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Estilo_de_Articulo_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Estilo_de_Articulo";
            ...
            if (this.filters !=null)
                foreach (Estilo_de_ArticuloCS.Estilo_de_ArticuloFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Estilo_de_Articulo", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllEstilo_de_Articulo";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Estilo_de_ArticuloCS.Estilo_de_ArticuloFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Estilo_de_Articulo", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Estilo_de_Articulo WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Estilo_de_Articulo_Clave": sortExpression = "Estilo_de_Articulo.Clave"; break;  case "Estilo_de_Articulo_Descripcion": sortExpression = "Estilo_de_Articulo.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Estilo_de_Articulo.Clave, Estilo_de_Articulo.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Estilo_de_Articulo.Clave As Estilo_de_Articulo_Clave,        Estilo_de_Articulo.Descripcion As Estilo_de_Articulo_Descripcion ";             string fieldsForExport = " Estilo_de_Articulo.Clave As [Clave],        Estilo_de_Articulo.Descripcion As [Descripcion] ";             string from = " from  Estilo_de_Articulo WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Estilo_de_Articulo.Clave As Estilo_de_Articulo_Clave,        Estilo_de_Articulo.Descripcion As Estilo_de_Articulo_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Estilo_de_Articulo.Clave, Estilo_de_Articulo.Descripcion" : Order);         string from = " from  Estilo_de_Articulo WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Estilo_de_Articulo");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsEstilo_de_Articulo";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Estilo_de_Articulo");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdEstilo_de_Articulo";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelEstilo_de_Articulo";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Estilo_de_Articulo_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Estilo_de_Articulo_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Estilo_de_Articulo";
            else
                com.CommandText="sp_GetEstilo_de_Articulo";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estilo_de_Articulo.Clave As Estilo_de_Articulo_Clave,        Estilo_de_Articulo.Descripcion As Estilo_de_Articulo_Descripcion   from  Estilo_de_Articulo           Where Estilo_de_Articulo.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Estilo_de_Articulo.Clave As Estilo_de_Articulo_Clave,        Estilo_de_Articulo.Descripcion As Estilo_de_Articulo_Descripcion   from  Estilo_de_Articulo           Where Estilo_de_Articulo.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Estilo_de_Articulo_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
