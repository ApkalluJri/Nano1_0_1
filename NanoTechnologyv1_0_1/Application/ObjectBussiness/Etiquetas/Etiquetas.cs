...
namespace EtiquetasCS
{
    public class EtiquetasFilters
    {
...
public class objectBussinessEtiquetas : IDisposable
{
    ...
    private EtiquetasFilters[] filters; 
    ...
    public EtiquetasFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public EtiquetasFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new EtiquetasFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Etiquetas_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Etiquetas";
            ...
            if (this.filters !=null)
                foreach (EtiquetasCS.EtiquetasFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Etiquetas", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllEtiquetas";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (EtiquetasCS.EtiquetasFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Etiquetas", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Etiquetas WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Etiquetas_Clave": sortExpression = "Etiquetas.Clave"; break;  case "Etiquetas_Descripcion": sortExpression = "Etiquetas.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Etiquetas.Clave, Etiquetas.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Etiquetas.Clave As Etiquetas_Clave,        Etiquetas.Descripcion As Etiquetas_Descripcion ";             string fieldsForExport = " Etiquetas.Clave As [Clave],        Etiquetas.Descripcion As [Descripcion] ";             string from = " from  Etiquetas WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Etiquetas.Clave As Etiquetas_Clave,        Etiquetas.Descripcion As Etiquetas_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Etiquetas.Clave, Etiquetas.Descripcion" : Order);         string from = " from  Etiquetas WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Etiquetas");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsEtiquetas";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Etiquetas");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdEtiquetas";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelEtiquetas";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Etiquetas_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Etiquetas_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Etiquetas";
            else
                com.CommandText="sp_GetEtiquetas";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Etiquetas.Clave As Etiquetas_Clave,        Etiquetas.Descripcion As Etiquetas_Descripcion   from  Etiquetas           Where Etiquetas.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Etiquetas.Clave As Etiquetas_Clave,        Etiquetas.Descripcion As Etiquetas_Descripcion   from  Etiquetas           Where Etiquetas.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Etiquetas_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
