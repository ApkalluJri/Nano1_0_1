...
namespace Opciones_de_Solicitud_via_AppCS
{
    public class Opciones_de_Solicitud_via_AppFilters
    {
...
public class objectBussinessOpciones_de_Solicitud_via_App : IDisposable
{
    ...
    private Opciones_de_Solicitud_via_AppFilters[] filters; 
    ...
    public Opciones_de_Solicitud_via_AppFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Opciones_de_Solicitud_via_AppFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Opciones_de_Solicitud_via_AppFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Opciones_de_Solicitud_via_App_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Opciones_de_Solicitud_via_App";
            ...
            if (this.filters !=null)
                foreach (Opciones_de_Solicitud_via_AppCS.Opciones_de_Solicitud_via_AppFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Opciones_de_Solicitud_via_App", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllOpciones_de_Solicitud_via_App";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Opciones_de_Solicitud_via_AppCS.Opciones_de_Solicitud_via_AppFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Opciones_de_Solicitud_via_App", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Opciones_de_Solicitud_via_App WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Opciones_de_Solicitud_via_App_Clave": sortExpression = "Opciones_de_Solicitud_via_App.Clave"; break;  case "Opciones_de_Solicitud_via_App_Descripcion": sortExpression = "Opciones_de_Solicitud_via_App.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Opciones_de_Solicitud_via_App.Clave, Opciones_de_Solicitud_via_App.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Opciones_de_Solicitud_via_App.Clave As Opciones_de_Solicitud_via_App_Clave,        Opciones_de_Solicitud_via_App.Descripcion As Opciones_de_Solicitud_via_App_Descripcion ";             string fieldsForExport = " Opciones_de_Solicitud_via_App.Clave As [Clave],        Opciones_de_Solicitud_via_App.Descripcion As [Descripcion] ";             string from = " from  Opciones_de_Solicitud_via_App WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Opciones_de_Solicitud_via_App.Clave As Opciones_de_Solicitud_via_App_Clave,        Opciones_de_Solicitud_via_App.Descripcion As Opciones_de_Solicitud_via_App_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Opciones_de_Solicitud_via_App.Clave, Opciones_de_Solicitud_via_App.Descripcion" : Order);         string from = " from  Opciones_de_Solicitud_via_App WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Opciones_de_Solicitud_via_App");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsOpciones_de_Solicitud_via_App";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Opciones_de_Solicitud_via_App");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdOpciones_de_Solicitud_via_App";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelOpciones_de_Solicitud_via_App";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Opciones_de_Solicitud_via_App_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Opciones_de_Solicitud_via_App_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Opciones_de_Solicitud_via_App";
            else
                com.CommandText="sp_GetOpciones_de_Solicitud_via_App";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Opciones_de_Solicitud_via_App.Clave As Opciones_de_Solicitud_via_App_Clave,        Opciones_de_Solicitud_via_App.Descripcion As Opciones_de_Solicitud_via_App_Descripcion   from  Opciones_de_Solicitud_via_App           Where Opciones_de_Solicitud_via_App.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Opciones_de_Solicitud_via_App.Clave As Opciones_de_Solicitud_via_App_Clave,        Opciones_de_Solicitud_via_App.Descripcion As Opciones_de_Solicitud_via_App_Descripcion   from  Opciones_de_Solicitud_via_App           Where Opciones_de_Solicitud_via_App.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Opciones_de_Solicitud_via_App_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
