...
namespace SubCategoriaCS
{
    public class SubCategoriaFilters
    {
...
public class objectBussinessSubCategoria : IDisposable
{
    ...
    private SubCategoriaFilters[] filters; 
    ...
    public SubCategoriaFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public SubCategoriaFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new SubCategoriaFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_SubCategoria_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_SubCategoria";
            ...
            if (this.filters !=null)
                foreach (SubCategoriaCS.SubCategoriaFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("SubCategoria", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllSubCategoria";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (SubCategoriaCS.SubCategoriaFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("SubCategoria", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from ( SubCategoria WITH(NoLock) LEFT JOIN Categoria as Categoria WITH(NoLock) ON Categoria.Clave=SubCategoria.Categoria)        " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "SubCategoria_Clave": sortExpression = "SubCategoria.Clave"; break;  case "SubCategoria_Descripcion": sortExpression = "SubCategoria.Descripcion"; break;  case "SubCategoria_Categoria": sortExpression = "SubCategoria.Categoria"; break;  case "Categoria_Descripcion": sortExpression = "Categoria.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "SubCategoria.Clave, SubCategoria.Descripcion, SubCategoria.Categoria, Categoria.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " SubCategoria.Clave As SubCategoria_Clave,        SubCategoria.Descripcion As SubCategoria_Descripcion,        SubCategoria.Categoria AS SubCategoria_Categoria,        Categoria.Descripcion AS Categoria_Descripcion ";             string fieldsForExport = " SubCategoria.Clave As [Clave],        SubCategoria.Descripcion As [Descripcion],        SubCategoria.Categoria AS [Categoria],        Categoria.Descripcion AS [Categoria Descripcion] ";             string from = " from ( SubCategoria WITH(NoLock) LEFT JOIN Categoria as Categoria WITH(NoLock) ON Categoria.Clave=SubCategoria.Categoria)        " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " SubCategoria.Clave As SubCategoria_Clave,        SubCategoria.Descripcion As SubCategoria_Descripcion,        SubCategoria.Categoria AS SubCategoria_Categoria,        Categoria.Descripcion AS Categoria_Descripcion ";         Order = (Order == string.Empty || Order == null ? "SubCategoria.Clave, SubCategoria.Descripcion, SubCategoria.Categoria, Categoria.Descripcion" : Order);         string from = " from ( SubCategoria WITH(NoLock) LEFT JOIN Categoria as Categoria WITH(NoLock) ON Categoria.Clave=SubCategoria.Categoria)        " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("SubCategoria");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsSubCategoria";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("SubCategoria");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdSubCategoria";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelSubCategoria";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["SubCategoria_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["SubCategoria_Descripcion"].ToString();
            Categoria = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["SubCategoria_Categoria"]);
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_SubCategoria";
            else
                com.CommandText="sp_GetSubCategoria";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         SubCategoria.Clave As SubCategoria_Clave,        SubCategoria.Descripcion As SubCategoria_Descripcion,        SubCategoria.Categoria AS SubCategoria_Categoria,        Categoria.Descripcion AS Categoria_Descripcion   from ( SubCategoria       LEFT JOIN Categoria ON Categoria.Clave=SubCategoria.Categoria)           Where SubCategoria.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["SubCategoria_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
...
*///            public DataTable FillDataCategoria(Object ctr, String Filtro){
            public DataTable FillDataCategoria(String Filtro){
                TTDataLayerCS.BD db = new TTDataLayerCS.BD();
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_selSubCategoria_Relacion_Categoria";
                com.CommandType = CommandType.StoredProcedure;
                //ctr.Items.Clear();
                DataTable dt = db.Consulta(com).Tables[0];
