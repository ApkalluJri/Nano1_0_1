...
namespace TTBusinessRules_AlcanceCS
{
    public class TTBusinessRules_AlcanceFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric varidAlcance = new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idAlcance
        {
            get { return varidAlcance; }
            set { varidAlcance = value; }
        }
    ...
    public class objectBussinessTTBusinessRules_Alcance
    {
        public int iProcess = 6762;
        ...
        private TTBusinessRules_AlcanceFilters[] filters;
        ...
        public TTBusinessRules_AlcanceFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_AlcanceFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_AlcanceFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Alcance_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Alcance";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_AlcanceCS.TTBusinessRules_AlcanceFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_Alcance", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_Alcance";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_AlcanceCS.TTBusinessRules_AlcanceFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_Alcance", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Alcance");
            int? sKeyidAlcance = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_Alcance";
                com.Parameters.AddWithValue("@idAlcance", Conversion.FormatNull(varidAlcance));
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidAlcance = Function.FormatNumberNull(db.EjecutaInsert(com, UserInformation, DataReference));
            ...
            {
                db.RollBackTransaction("TTBusinessRules_Alcance");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_Alcance";
                com.Parameters.AddWithValue("@idAlcance", Conversion.FormatNull(varidAlcance));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidAlcance = Function.FormatNumberNull(db.EjecutaUpdate(com, UserInformation, DataReference));
                //            varidAlcance = sKeyidAlcance;
        ...
        public bool Delete(int? KeyidAlcance, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            //        if (Key == ""){
            ...
            //        }else{
            Boolean result;
            DataReference.Folio = KeyidAlcance.ToString();
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Alcance");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_Alcance";
                com.Parameters.AddWithValue("@idAlcance", KeyidAlcance);
                com.CommandType = CommandType.StoredProcedure;
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idAlcance = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_Alcance_idAlcance"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_Alcance_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidAlcance, Boolean ConRelaciones)
        {
            DataSet ds;
            if (KeyidAlcance == null)
            {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_Alcance";
            else
                com.CommandText = "sp_GetTTBusinessRules_Alcance";
            com.Parameters.AddWithValue("@idAlcance", KeyidAlcance);
        ...
        public DataSet GetByKeyidAlcance(int? Key)
        {
            DataSet ds;
            if (Key == null)
            {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Alcance.idAlcance As TTBusinessRules_Alcance_idAlcance,        TTBusinessRules_Alcance.Descripcion As TTBusinessRules_Alcance_Descripcion   from  TTBusinessRules_Alcance           Where TTBusinessRules_Alcance.idAlcance = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Alcance.idAlcance As TTBusinessRules_Alcance_idAlcance,        TTBusinessRules_Alcance.Descripcion As TTBusinessRules_Alcance_Descripcion   from  TTBusinessRules_Alcance           Where TTBusinessRules_Alcance.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidAlcance)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_Alcance";
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_Alcance_idAlcance"]) == KeyidAlcance)
                    return i;
            }
            return -1;
        }
        public Boolean ValidaExistencia(int? KeyidAlcance)
        {
            Boolean result;
            DataSet ds;
            //        if (Key == null ){
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "14953")
            {
                this.Filters[indexFilter].idAlcance = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "14954")
            {
