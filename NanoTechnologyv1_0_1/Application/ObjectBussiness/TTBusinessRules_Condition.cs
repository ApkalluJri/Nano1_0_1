...
namespace TTBusinessRules_ConditionCS
{
    public class TTBusinessRules_ConditionFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric varidCondicion = new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idCondicion
        {
            get { return varidCondicion; }
            set { varidCondicion = value; }
        }
    ...
    public class objectBussinessTTBusinessRules_Condition
    {
        public int iProcess = 6767;
        ...
        private TTBusinessRules_ConditionFilters[] filters;
        ...
        public TTBusinessRules_ConditionFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_ConditionFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_ConditionFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Condition_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Condition";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_ConditionCS.TTBusinessRules_ConditionFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_Condition", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_Condition";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_ConditionCS.TTBusinessRules_ConditionFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_Condition", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Condition");
            int? sKeyidCondicion = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_Condition";
                com.Parameters.AddWithValue("@idCondicion", Conversion.FormatNull(varidCondicion));
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidCondicion = Function.FormatNumberNull(db.EjecutaInsert(com, UserInformation, DataReference));
            ...
            {
                db.RollBackTransaction("TTBusinessRules_Condition");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_Condition";
                com.Parameters.AddWithValue("@idCondicion", Conversion.FormatNull(varidCondicion));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidCondicion = Function.FormatNumberNull(db.EjecutaUpdate(com, UserInformation, DataReference));
                //            varidCondicion = sKeyidCondicion;
        ...
        public bool Delete(int? KeyidCondicion, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            //        if (Key == ""){
            ...
            //        }else{
            Boolean result;
            DataReference.Folio = KeyidCondicion.ToString();
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Condition");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_Condition";
                com.Parameters.AddWithValue("@idCondicion", KeyidCondicion);
                com.CommandType = CommandType.StoredProcedure;
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idCondicion = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_Condition_idCondicion"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_Condition_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidCondicion, Boolean ConRelaciones)
        {
            DataSet ds;
            if (KeyidCondicion == null)
            {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_Condition";
            else
                com.CommandText = "sp_GetTTBusinessRules_Condition";
            com.Parameters.AddWithValue("@idCondicion", KeyidCondicion);
        ...
        public DataSet GetByKeyidCondicion(int? Key)
        {
            DataSet ds;
            if (Key == null)
            {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Condition.idCondicion As TTBusinessRules_Condition_idCondicion,        TTBusinessRules_Condition.Descripcion As TTBusinessRules_Condition_Descripcion   from  TTBusinessRules_Condition           Where TTBusinessRules_Condition.idCondicion = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Condition.idCondicion As TTBusinessRules_Condition_idCondicion,        TTBusinessRules_Condition.Descripcion As TTBusinessRules_Condition_Descripcion   from  TTBusinessRules_Condition           Where TTBusinessRules_Condition.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidCondicion)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_Condition";
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_Condition_idCondicion"]) == KeyidCondicion)
                    return i;
            }
            return -1;
        }
        public Boolean ValidaExistencia(int? KeyidCondicion)
        {
            Boolean result;
            DataSet ds;
            //        if (Key == null ){
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "14963")
            {
                this.Filters[indexFilter].idCondicion = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "14964")
            {
