...
namespace TTBusinessRules_FieldEventCS
{
    public class TTBusinessRules_FieldEventFilters
    {
    ...
    public class objectBussinessTTBusinessRules_FieldEvent
    {
        public int iProcess = 6765;
        ...
        private TTBusinessRules_FieldEventFilters[] filters;
        ...
        public TTBusinessRules_FieldEventFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_FieldEventFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_FieldEventFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_FieldEvent_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_FieldEvent";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_FieldEventCS.TTBusinessRules_FieldEventFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_FieldEvent", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_FieldEvent";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_FieldEventCS.TTBusinessRules_FieldEventFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_FieldEvent", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_FieldEvent");
            int? sKeyidEvent = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_FieldEvent";
            ...
            {
                db.RollBackTransaction("TTBusinessRules_FieldEvent");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_FieldEvent";
                com.Parameters.AddWithValue("@idEvent", Conversion.FormatNull(varidEvent));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
        ...
        public bool Delete(int? KeyidEvent, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_FieldEvent";
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idEvent = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_FieldEvent_idEvent"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_FieldEvent_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidEvent, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_FieldEvent";
            else
                com.CommandText = "sp_GetTTBusinessRules_FieldEvent";
            com.Parameters.AddWithValue("@idEvent", KeyidEvent);
        ...
        public DataSet GetByKeyidEvent(int? Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_FieldEvent.idEvent As TTBusinessRules_FieldEvent_idEvent,        TTBusinessRules_FieldEvent.Descripcion As TTBusinessRules_FieldEvent_Descripcion   from  TTBusinessRules_FieldEvent           Where TTBusinessRules_FieldEvent.idEvent = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_FieldEvent.idEvent As TTBusinessRules_FieldEvent_idEvent,        TTBusinessRules_FieldEvent.Descripcion As TTBusinessRules_FieldEvent_Descripcion   from  TTBusinessRules_FieldEvent           Where TTBusinessRules_FieldEvent.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidEvent)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_FieldEvent_idEvent"]) == KeyidEvent)
                    return i;
            }
            return -1;
        }
