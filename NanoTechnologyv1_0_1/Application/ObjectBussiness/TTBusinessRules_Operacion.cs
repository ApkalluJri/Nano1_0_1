...
namespace TTBusinessRules_OperacionCS
{
    public class TTBusinessRules_OperacionFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric varidOperacion = new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idOperacion
        {
    ...
    public class objectBussinessTTBusinessRules_Operacion
    {
        public int iProcess = 6763;
        ...
        private TTBusinessRules_OperacionFilters[] filters;
        ...
        public TTBusinessRules_OperacionFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_OperacionFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_OperacionFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Operacion_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_Operacion";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_OperacionCS.TTBusinessRules_OperacionFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_Operacion", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_Operacion";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_OperacionCS.TTBusinessRules_OperacionFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_Operacion", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Operacion");
            int? sKeyidOperacion = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_Operacion";
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidOperacion = Function.FormatNumberNull(db.EjecutaInsert(com, UserInformation, DataReference));
            ...
            {
                db.RollBackTransaction("TTBusinessRules_Operacion");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_Operacion";
                com.Parameters.AddWithValue("@idOperacion", Conversion.FormatNull(varidOperacion));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidOperacion = Function.FormatNumberNull(db.EjecutaUpdate(com, UserInformation, DataReference));
                //            varidOperacion = sKeyidOperacion;
        ...
        public bool Delete(int? KeyidOperacion, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            //        if (Key == ""){
            ...
            //        }else{
            Boolean result;
            DataReference.Folio = KeyidOperacion.ToString();
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_Operacion");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_Operacion";
                com.Parameters.AddWithValue("@idOperacion", KeyidOperacion);
                com.CommandType = CommandType.StoredProcedure;
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idOperacion = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_Operacion_idOperacion"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_Operacion_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidOperacion, Boolean ConRelaciones)
        {
            DataSet ds;
            if (KeyidOperacion == null)
            {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_Operacion";
            else
                com.CommandText = "sp_GetTTBusinessRules_Operacion";
            com.Parameters.AddWithValue("@idOperacion", KeyidOperacion);
        ...
        public DataSet GetByKeyidOperacion(int? Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Operacion.idOperacion As TTBusinessRules_Operacion_idOperacion,        TTBusinessRules_Operacion.Descripcion As TTBusinessRules_Operacion_Descripcion   from  TTBusinessRules_Operacion           Where TTBusinessRules_Operacion.idOperacion = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_Operacion.idOperacion As TTBusinessRules_Operacion_idOperacion,        TTBusinessRules_Operacion.Descripcion As TTBusinessRules_Operacion_Descripcion   from  TTBusinessRules_Operacion           Where TTBusinessRules_Operacion.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidOperacion)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_Operacion_idOperacion"]) == KeyidOperacion)
                    return i;
            }
            return -1;
        }
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "14955")
            {
                this.Filters[indexFilter].idOperacion = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "14956")
            {
