...
namespace TTBusinessRules_ProcessEventCS
{
    public class TTBusinessRules_ProcessEventFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric varidEvent = new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idEvent
        {
            get { return varidEvent; }
            set { varidEvent = value; }
        }
    ...
    public class objectBussinessTTBusinessRules_ProcessEvent
    {
        public int iProcess = 6764;
        ...
        private TTBusinessRules_ProcessEventFilters[] filters;
        ...
        public TTBusinessRules_ProcessEventFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_ProcessEventFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_ProcessEventFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_ProcessEvent_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_ProcessEvent";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_ProcessEventCS.TTBusinessRules_ProcessEventFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_ProcessEvent", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_ProcessEvent";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_ProcessEventCS.TTBusinessRules_ProcessEventFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_ProcessEvent", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_ProcessEvent");
            int? sKeyidEvent = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_ProcessEvent";
                com.Parameters.AddWithValue("@idEvent", Conversion.FormatNull(varidEvent));
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidEvent = Function.FormatNumberNull(db.EjecutaInsert(com, UserInformation, DataReference));

                db.CommitTransaction();
            }
            catch (Exception ex)
            {
                db.RollBackTransaction("TTBusinessRules_ProcessEvent");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_ProcessEvent";
                com.Parameters.AddWithValue("@idEvent", Conversion.FormatNull(varidEvent));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
                ...
                com.CommandType = CommandType.StoredProcedure;
                sKeyidEvent = Function.FormatNumberNull(db.EjecutaUpdate(com, UserInformation, DataReference));
                //            varidEvent = sKeyidEvent;
        ...
        public bool Delete(int? KeyidEvent, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            //        if (Key == ""){
            ...
            //        }else{
            Boolean result;
            DataReference.Folio = KeyidEvent.ToString();
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_ProcessEvent");
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_ProcessEvent";
                com.Parameters.AddWithValue("@idEvent", KeyidEvent);
                com.CommandType = CommandType.StoredProcedure;
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idEvent = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_ProcessEvent_idEvent"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_ProcessEvent_Descripcion"].ToString().TrimEnd(' ');
            }
            return ds;
        }
        public DataSet GetByKey(int? KeyidEvent, Boolean ConRelaciones)
        {
            DataSet ds;
            if (KeyidEvent == null)
            {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_ProcessEvent";
            else
                com.CommandText = "sp_GetTTBusinessRules_ProcessEvent";
            com.Parameters.AddWithValue("@idEvent", KeyidEvent);
        ...
        public DataSet GetByKeyidEvent(int? Key)
        {
            DataSet ds;
            if (Key == null)
            {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_ProcessEvent.idEvent As TTBusinessRules_ProcessEvent_idEvent,        TTBusinessRules_ProcessEvent.Descripcion As TTBusinessRules_ProcessEvent_Descripcion   from  TTBusinessRules_ProcessEvent           Where TTBusinessRules_ProcessEvent.idEvent = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_ProcessEvent.idEvent As TTBusinessRules_ProcessEvent_idEvent,        TTBusinessRules_ProcessEvent.Descripcion As TTBusinessRules_ProcessEvent_Descripcion   from  TTBusinessRules_ProcessEvent           Where TTBusinessRules_ProcessEvent.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidEvent)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_ProcessEvent";
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_ProcessEvent_idEvent"]) == KeyidEvent)
                    return i;
            }
            return -1;
        }
        public Boolean ValidaExistencia(int? KeyidEvent)
        {
            Boolean result;
            DataSet ds;
            //        if (Key == null ){
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "14957")
            {
                this.Filters[indexFilter].idEvent = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "14958")
            {
