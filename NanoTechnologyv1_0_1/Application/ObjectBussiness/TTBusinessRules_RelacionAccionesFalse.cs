...
namespace TTBusinessRules_RelacionAccionesFalseCS
{
    public class TTBusinessRules_RelacionAccionesFalseFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Dependientes varTipo_Accion = new TTClassSpecials.FiltersTypes.Dependientes();
        //        private TTBusinessRules_ActionTypeCS.TTBusinessRules_ActionTypeFilters[] varTipo_Accion;
        public TTClassSpecials.FiltersTypes.Dependientes Tipo_Accion
        {
            get { return varTipo_Accion; }
            set { varTipo_Accion = value; }
        }
        private TTClassSpecials.FiltersTypes.Dependientes varTipo_Accion_Resultado = new TTClassSpecials.FiltersTypes.Dependientes();
        //        private TTBusinessRules_ActionResultTypeCS.TTBusinessRules_ActionResultTypeFilters[] varTipo_Accion_Resultado;
        public TTClassSpecials.FiltersTypes.Dependientes Tipo_Accion_Resultado
        {
            get { return varTipo_Accion_Resultado; }
            set { varTipo_Accion_Resultado = value; }
        }
        private TTClassSpecials.FiltersTypes.String varParametro1 = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Parametro1
        {
            get { return varParametro1; }
            set { varParametro1 = value; }
        }
        private TTClassSpecials.FiltersTypes.String varParametro2 = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Parametro2
        {
            get { return varParametro2; }
            set { varParametro2 = value; }
        }
        private TTClassSpecials.FiltersTypes.String varParametro3 = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Parametro3
        {
            get { return varParametro3; }
            set { varParametro3 = value; }
        }
        private TTClassSpecials.FiltersTypes.String varParametro4 = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Parametro4
        {
            get { return varParametro4; }
            set { varParametro4 = value; }
        }
        private TTClassSpecials.FiltersTypes.String varParametro5 = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Parametro5
        {
            get { return varParametro5; }
            set { varParametro5 = value; }
        }

    }
    public class objectBussinessTTBusinessRules_RelacionAccionesFalse
    {
        public int iProcess = 6779;
        ...
        private TTBusinessRules_RelacionAccionesFalseFilters[] filters;
        ...
        private int? varTipo_Accion;
        private int? varTipo_Accion_Resultado;
        private String varParametro1;
        private String varParametro2;
        private String varParametro3;
        private String varParametro4;
        private String varParametro5;
        ...
        public TTBusinessRules_RelacionAccionesFalseFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_RelacionAccionesFalseFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_RelacionAccionesFalseFilters[1];
                filters[0] = value;
            }
        }
        ...
        public int? Tipo_Accion_Resultado
        {
            get { return varTipo_Accion_Resultado; }
            set { varTipo_Accion_Resultado = value; }
        }
        ...
        public Int32 SelCount()
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_RelacionAccionesFalse";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            string swhere = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionAccionesFalseCS.TTBusinessRules_RelacionAccionesFalseFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_RelacionAccionesFalse", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_RelacionAccionesFalse";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            String swhere = "";
            String sOrderBy = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionAccionesFalseCS.TTBusinessRules_RelacionAccionesFalseFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_RelacionAccionesFalse", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_RelacionAccionesFalse");
            int? sKey1 = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                ...
                com.Parameters.AddWithValue("@Tipo_Accion", Conversion.FormatNull(varTipo_Accion));
                com.Parameters.AddWithValue("@Tipo_Accion_Resultado", Conversion.FormatNull(varTipo_Accion_Resultado));
                if (varParametro1 != null)
                    com.Parameters.AddWithValue("@Parametro1", varParametro1);
                else
                    com.Parameters.AddWithValue("@Parametro1", DBNull.Value);
                if (varParametro2 != null)
                    com.Parameters.AddWithValue("@Parametro2", varParametro2);
                else
                    com.Parameters.AddWithValue("@Parametro2", DBNull.Value);
                if (varParametro3 != null)
                    com.Parameters.AddWithValue("@Parametro3", varParametro3);
                else
                    com.Parameters.AddWithValue("@Parametro3", DBNull.Value);
                if (varParametro4 != null)
                    com.Parameters.AddWithValue("@Parametro4", varParametro4);
                else
                    com.Parameters.AddWithValue("@Parametro4", DBNull.Value);
                if (varParametro5 != null)
                    com.Parameters.AddWithValue("@Parametro5", varParametro5);
                else
            ...
            {
                db.RollBackTransaction("TTBusinessRules_RelacionAccionesFalse");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_RelacionAccionesFalse";
                com.Parameters.AddWithValue("@idBusinessRules", Conversion.FormatNull(varidBusinessRules));
        ...
        public bool Delete(int? Key1, int? Key2, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_RelacionAccionesFalse";
        ...
        public DataSet GetByKey(int? Key1, int? Key2, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_RelacionAccionesFalse";
            else
                com.CommandText = "sp_GetTTBusinessRules_RelacionAccionesFalse";
            com.Parameters.AddWithValue("@idBusinessRules", Key1); com.Parameters.AddWithValue("@idFolio", Key2);
            ...
            {
                idBusinessRules = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_idBusinessRules"]);
                idFolio = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_idFolio"]);
                Tipo_Accion = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Tipo_Accion"]);
                Tipo_Accion_Resultado = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Tipo_Accion_Resultado"]);
                Parametro1 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Parametro1"].ToString().TrimEnd(' ');
                Parametro2 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Parametro2"].ToString().TrimEnd(' ');
                Parametro3 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Parametro3"].ToString().TrimEnd(' ');
                Parametro4 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Parametro4"].ToString().TrimEnd(' ');
                Parametro5 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesFalse_Parametro5"].ToString().TrimEnd(' ');
        ...
        public Int32 CurrentPosicion(int? Key1, int? Key2)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionAccionesFalse_idBusinessRules"]) == Key1 && Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionAccionesFalse_idFolio"]) == Key2)
                    return i;
            }
            return -1;
        }
        ...
        public DataTable FillDataidBusinessRules(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
        ...
        public DataTable FillDataidBusinessRules(Object ctr)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules";
        ...
        public DataTable FillDataTipo_Accion(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules_ActionType";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
            DataView d = new DataView(dt, Filtro, "", DataViewRowState.CurrentRows);
        ...
        public DataTable FillDataTipo_Accion(Object ctr)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules_ActionType";
        ...
        public DataTable FillDataTipo_Accion_Resultado(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules_ActionResultType";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
            DataView d = new DataView(dt, Filtro, "", DataViewRowState.CurrentRows);
        ...
        public DataTable FillDataTipo_Accion_Resultado(Object ctr)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesFalse_Relacion_TTBusinessRules_ActionResultType";
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            ...
            if (sDTid == "15004")
            {
                this.Filters[indexFilter].Tipo_Accion = (TTClassSpecials.FiltersTypes.Dependientes)filter;//(TTBusinessRules_ActionTypeCS.TTBusinessRules_ActionTypeFilters[])filter;
            }
            if (sDTid == "15005")
            {
                this.Filters[indexFilter].Tipo_Accion_Resultado = (TTClassSpecials.FiltersTypes.Dependientes)filter;//(TTBusinessRules_ActionResultTypeCS.TTBusinessRules_ActionResultTypeFilters[])filter;
            }
            if (sDTid == "15017")
            {
                this.Filters[indexFilter].Parametro1 = (TTClassSpecials.FiltersTypes.String)filter;
            }
            if (sDTid == "15018")
            {
                this.Filters[indexFilter].Parametro2 = (TTClassSpecials.FiltersTypes.String)filter;
            }
            if (sDTid == "15019")
            {
                this.Filters[indexFilter].Parametro3 = (TTClassSpecials.FiltersTypes.String)filter;
            }
            if (sDTid == "15020")
            {
                this.Filters[indexFilter].Parametro4 = (TTClassSpecials.FiltersTypes.String)filter;
            }
            if (sDTid == "15021")
            {
                this.Filters[indexFilter].Parametro5 = (TTClassSpecials.FiltersTypes.String)filter;
            }
