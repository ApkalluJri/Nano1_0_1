...
namespace TTBusinessRules_RelacionAccionesTrueCS
{
    public class TTBusinessRules_RelacionAccionesTrueFilters
    {
    ...
    public class objectBussinessTTBusinessRules_RelacionAccionesTrue
    {
        public int iProcess = 6778;
        ...
        private TTBusinessRules_RelacionAccionesTrueFilters[] filters;
        ...
        public TTBusinessRules_RelacionAccionesTrueFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_RelacionAccionesTrueFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_RelacionAccionesTrueFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_RelacionAccionesTrue";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            string swhere = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionAccionesTrueCS.TTBusinessRules_RelacionAccionesTrueFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_RelacionAccionesTrue", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_RelacionAccionesTrue";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            String swhere = "";
            String sOrderBy = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionAccionesTrueCS.TTBusinessRules_RelacionAccionesTrueFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_RelacionAccionesTrue", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_RelacionAccionesTrue");
            int? sKey1 = -1;
            try
            {
                SqlCommand com = new SqlCommand();
            ...
            {
                db.RollBackTransaction("TTBusinessRules_RelacionAccionesTrue");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_RelacionAccionesTrue";
                com.Parameters.AddWithValue("@idBusinessRules", Conversion.FormatNull(varidBusinessRules));
        ...
        public bool Delete(int? Key1, int? Key2, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_RelacionAccionesTrue";
        ...
        public DataSet GetByKey(int? Key1, int? Key2, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_RelacionAccionesTrue";
            else
                com.CommandText = "sp_GetTTBusinessRules_RelacionAccionesTrue";
            com.Parameters.AddWithValue("@idBusinessRules", Key1); com.Parameters.AddWithValue("@idFolio", Key2);
            ...
            {
                idBusinessRules = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_idBusinessRules"]);
                idFolio = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_idFolio"]);
                Tipo_Accion = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Tipo_Accion"]);
                Tipo_Accion_Resultado = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Tipo_Accion_Resultado"]);
                Parametro1 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Parametro1"].ToString().TrimEnd(' ');
                Parametro2 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Parametro2"].ToString().TrimEnd(' ');
                Parametro3 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Parametro3"].ToString().TrimEnd(' ');
                Parametro4 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Parametro4"].ToString().TrimEnd(' ');
                Parametro5 = ds.Tables[0].Rows[0]["TTBusinessRules_RelacionAccionesTrue_Parametro5"].ToString().TrimEnd(' ');
            }
            return ds;
            //}
        }
        public Int32 CurrentPosicion(int? Key1, int? Key2)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionAccionesTrue_idBusinessRules"]) == Key1 && Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionAccionesTrue_idFolio"]) == Key2)
                    return i;
            }
            return -1;
        }
        ...
        public DataTable FillDataidBusinessRules(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesTrue_Relacion_TTBusinessRules";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
        ...
        public DataTable FillDataTipo_Accion(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesTrue_Relacion_TTBusinessRules_ActionType";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
            DataView d = new DataView(dt, Filtro, "", DataViewRowState.CurrentRows);
        ...
        public DataTable FillDataTipo_Accion()
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesTrue_Relacion_TTBusinessRules_ActionType";
        ...
        public DataTable FillDataTipo_Accion_Resultado(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesTrue_Relacion_TTBusinessRules_ActionResultType";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
            DataView d = new DataView(dt, Filtro, "", DataViewRowState.CurrentRows);
        ...
        public DataTable FillDataTipo_Accion_Resultado()
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionAccionesTrue_Relacion_TTBusinessRules_ActionResultType";
