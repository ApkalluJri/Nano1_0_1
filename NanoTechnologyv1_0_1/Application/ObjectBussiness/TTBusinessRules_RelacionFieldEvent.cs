...
namespace TTBusinessRules_RelacionFieldEventCS
{
    public class TTBusinessRules_RelacionFieldEventFilters
    {
        ...
        //        private TTBusinessRules_FieldEventCS.TTBusinessRules_FieldEventFilters[] varidEvent;
    ...
    public class objectBussinessTTBusinessRules_RelacionFieldEvent
    {
        public int iProcess = 6776;
        ...
        private TTBusinessRules_RelacionFieldEventFilters[] filters;
        ...
        public TTBusinessRules_RelacionFieldEventFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_RelacionFieldEventFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_RelacionFieldEventFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_RelacionFieldEvent";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            string swhere = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionFieldEventCS.TTBusinessRules_RelacionFieldEventFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_RelacionFieldEvent", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_RelacionFieldEvent";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            String swhere = "";
            String sOrderBy = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionFieldEventCS.TTBusinessRules_RelacionFieldEventFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_RelacionFieldEvent", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_RelacionFieldEvent");
            int? sKey1 = -1;
            try
            {
                SqlCommand com = new SqlCommand();
            ...
            {
                db.RollBackTransaction("TTBusinessRules_RelacionFieldEvent");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_RelacionFieldEvent";
                com.Parameters.AddWithValue("@idBusinessRules", Conversion.FormatNull(varidBusinessRules));
                com.Parameters.AddWithValue("@idEvent", Conversion.FormatNull(varidEvent));
        ...
        public bool Delete(int? Key1, int? Key2, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_RelacionFieldEvent";
        ...
        public DataSet GetByKey(int? Key1, int? Key2, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_RelacionFieldEvent";
            else
                com.CommandText = "sp_GetTTBusinessRules_RelacionFieldEvent";
            com.Parameters.AddWithValue("@idBusinessRules", Key1); com.Parameters.AddWithValue("@idEvent", Key2);
            ...
            {
                idBusinessRules = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionFieldEvent_idBusinessRules"]);
                idEvent = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionFieldEvent_idEvent"]);
        ...
        public Int32 CurrentPosicion(int? Key1, int? Key2)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionFieldEvent_idBusinessRules"]) == Key1 && Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionFieldEvent_idEvent"]) == Key2)
                    return i;
            }
            return -1;
        }
        ...
        public DataTable FillDataidBusinessRules(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionFieldEvent_Relacion_TTBusinessRules";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            ...
            if (sDTid == "14986")
            {
                this.Filters[indexFilter].idEvent = (TTClassSpecials.FiltersTypes.Dependientes)filter;//(TTBusinessRules_FieldEventCS.TTBusinessRules_FieldEventFilters[])filter;
            }
