...
namespace TTBusinessRules_RelacionProcessEventCS
{
    public class TTBusinessRules_RelacionProcessEventFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Dependientes varidEvent = new TTClassSpecials.FiltersTypes.Dependientes();
        //        private TTBusinessRules_ProcessEventCS.TTBusinessRules_ProcessEventFilters[] varidEvent;
        public TTClassSpecials.FiltersTypes.Dependientes idEvent
        {
    ...
    public class objectBussinessTTBusinessRules_RelacionProcessEvent
    {
        public int iProcess = 6775;
        ...
        private TTBusinessRules_RelacionProcessEventFilters[] filters;
        ...
        public TTBusinessRules_RelacionProcessEventFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_RelacionProcessEventFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_RelacionProcessEventFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTBusinessRules_RelacionProcessEvent";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            string swhere = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionProcessEventCS.TTBusinessRules_RelacionProcessEventFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_RelacionProcessEvent", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_RelacionProcessEvent";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            String swhere = "";
            String sOrderBy = "";
            if (this.filters != null)
                foreach (TTBusinessRules_RelacionProcessEventCS.TTBusinessRules_RelacionProcessEventFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_RelacionProcessEvent", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_RelacionProcessEvent");
            int? sKey1 = -1;
            try
            {
                SqlCommand com = new SqlCommand();
            ...
            {
                db.RollBackTransaction("TTBusinessRules_RelacionProcessEvent");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_RelacionProcessEvent";
                com.Parameters.AddWithValue("@idBusinessRules", Conversion.FormatNull(varidBusinessRules));
                com.Parameters.AddWithValue("@idEvent", Conversion.FormatNull(varidEvent));
        ...
        public bool Delete(int? Key1, int? Key2, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_RelacionProcessEvent";
                com.Parameters.AddWithValue("@idBusinessRules", Key1); com.Parameters.AddWithValue("@idEvent", Key2);
                com.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetByKey(int? Key1, int? Key2, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_RelacionProcessEvent";
            else
                com.CommandText = "sp_GetTTBusinessRules_RelacionProcessEvent";
            com.Parameters.AddWithValue("@idBusinessRules", Key1); com.Parameters.AddWithValue("@idEvent", Key2);
            ...
            {
                idBusinessRules = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionProcessEvent_idBusinessRules"]);
                idEvent = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_RelacionProcessEvent_idEvent"]);
            }
            return ds;
            //}
        }
        public Int32 CurrentPosicion(int? Key1, int? Key2)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionProcessEvent_idBusinessRules"]) == Key1 && Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_RelacionProcessEvent_idEvent"]) == Key2)
                    return i;
            }
            return -1;
        }
        ...
        public DataTable FillDataidBusinessRules(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionProcessEvent_Relacion_TTBusinessRules";
            com.CommandType = CommandType.StoredProcedure;
            //ctr.Items.Clear();
            DataTable dt = db.Consulta(com).Tables[0];
        ...
        public DataTable FillDataidEvent(String Filtro)
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
        ...
        public DataTable FillDataidEvent()
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "sp_selTTBusinessRules_RelacionProcessEvent_Relacion_TTBusinessRules_ProcessEvent";
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            ...
            if (sDTid == "14983")
            {
                this.Filters[indexFilter].idEvent = (TTClassSpecials.FiltersTypes.Dependientes)filter;//(TTBusinessRules_ProcessEventCS.TTBusinessRules_ProcessEventFilters[])filter;
            }
