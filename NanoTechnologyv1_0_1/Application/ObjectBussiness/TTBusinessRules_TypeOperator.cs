...
namespace TTBusinessRules_TypeOperatorCS
{
    public class TTBusinessRules_TypeOperatorFilters
    {
    ...
    public class objectBussinessTTBusinessRules_TypeOperator
    {
        public int iProcess = 6768;
        ...
        private TTBusinessRules_TypeOperatorFilters[] filters;
        ...
        public TTBusinessRules_TypeOperatorFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_TypeOperatorFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_TypeOperatorFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_TypeOperator_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_TypeOperator";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_TypeOperatorCS.TTBusinessRules_TypeOperatorFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_TypeOperator", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_TypeOperator";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_TypeOperatorCS.TTBusinessRules_TypeOperatorFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_TypeOperator", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_TypeOperator");
            int? sKeyidOperator = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_TypeOperator";
            ...
            {
                db.RollBackTransaction("TTBusinessRules_TypeOperator");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_TypeOperator";
                com.Parameters.AddWithValue("@idOperator", Conversion.FormatNull(varidOperator));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
        ...
        public bool Delete(int? KeyidOperator, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_TypeOperator";
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idOperator = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_TypeOperator_idOperator"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_TypeOperator_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidOperator, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_TypeOperator";
            else
                com.CommandText = "sp_GetTTBusinessRules_TypeOperator";
            com.Parameters.AddWithValue("@idOperator", KeyidOperator);
        ...
        public DataSet GetByKeyidOperator(int? Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_TypeOperator.idOperator As TTBusinessRules_TypeOperator_idOperator,        TTBusinessRules_TypeOperator.Descripcion As TTBusinessRules_TypeOperator_Descripcion   from  TTBusinessRules_TypeOperator           Where TTBusinessRules_TypeOperator.idOperator = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_TypeOperator.idOperator As TTBusinessRules_TypeOperator_idOperator,        TTBusinessRules_TypeOperator.Descripcion As TTBusinessRules_TypeOperator_Descripcion   from  TTBusinessRules_TypeOperator           Where TTBusinessRules_TypeOperator.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidOperator)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_TypeOperator_idOperator"]) == KeyidOperator)
                    return i;
            }
            return -1;
        }
