...
namespace TTBusinessRules_TypeOperator2CS
{
    public class TTBusinessRules_TypeOperator2Filters
    {
    ...
    public class objectBussinessTTBusinessRules_TypeOperator2
    {
        public int iProcess = 6769;
        ...
        private TTBusinessRules_TypeOperator2Filters[] filters;
        ...
        public TTBusinessRules_TypeOperator2Filters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTBusinessRules_TypeOperator2Filters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTBusinessRules_TypeOperator2Filters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            if (swhere != "")
            {
                ...
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_TypeOperator2_WithFilter";
            }
            else
                com.CommandText = "sp_SelAllComplete_TTBusinessRules_TypeOperator2";
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_TypeOperator2CS.TTBusinessRules_TypeOperator2Filters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTBusinessRules_TypeOperator2", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTBusinessRules_TypeOperator2";
            ds = db.Consulta(com);
            ...
            if (this.filters != null)
                foreach (TTBusinessRules_TypeOperator2CS.TTBusinessRules_TypeOperator2Filters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTBusinessRules_TypeOperator2", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTBusinessRules_TypeOperator2");
            int? sKeyidOperator = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTBusinessRules_TypeOperator2";
            ...
            {
                db.RollBackTransaction("TTBusinessRules_TypeOperator2");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTBusinessRules_TypeOperator2";
                com.Parameters.AddWithValue("@idOperator", Conversion.FormatNull(varidOperator));
                if (varDescripcion != null)
                    com.Parameters.AddWithValue("@Descripcion", varDescripcion);
                else
        ...
        public bool Delete(int? KeyidOperator, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTBusinessRules_TypeOperator2";
        ...
        private DataSet GetByKey(DataSet ds)
        {
            ...
            {
                idOperator = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTBusinessRules_TypeOperator2_idOperator"]);
                Descripcion = ds.Tables[0].Rows[0]["TTBusinessRules_TypeOperator2_Descripcion"].ToString().TrimEnd(' ');
        ...
        public DataSet GetByKey(int? KeyidOperator, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTBusinessRules_TypeOperator2";
            else
                com.CommandText = "sp_GetTTBusinessRules_TypeOperator2";
            com.Parameters.AddWithValue("@idOperator", KeyidOperator);
        ...
        public DataSet GetByKeyidOperator(int? Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_TypeOperator2.idOperator As TTBusinessRules_TypeOperator2_idOperator,        TTBusinessRules_TypeOperator2.Descripcion As TTBusinessRules_TypeOperator2_Descripcion   from  TTBusinessRules_TypeOperator2           Where TTBusinessRules_TypeOperator2.idOperator = '" + Key + "'";
        ...
        public DataSet GetByKeyDescripcion(String Key)
        {
            ...
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText = "Select         TTBusinessRules_TypeOperator2.idOperator As TTBusinessRules_TypeOperator2_idOperator,        TTBusinessRules_TypeOperator2.Descripcion As TTBusinessRules_TypeOperator2_Descripcion   from  TTBusinessRules_TypeOperator2           Where TTBusinessRules_TypeOperator2.Descripcion = '" + Key + "'";
            com.CommandType = CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
            //}
        ...
        public Int32 CurrentPosicion(int? KeyidOperator)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTBusinessRules_TypeOperator2_idOperator"]) == KeyidOperator)
                    return i;
            }
            return -1;
        }
