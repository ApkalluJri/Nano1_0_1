...
namespace TTConfigurationServers_TipoServidorCS
{
    public class TTConfigurationServers_TipoServidorFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric varidServer = new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idServer
        {
            get { return varidServer; }
            set { varidServer = value; }
        }
    ...
    public class objectBussinessTTConfigurationServers_TipoServidor
    {
        public int iProcess = 6782;
        ...
        private TTConfigurationServers_TipoServidorFilters[] filters;
        ...
        public TTConfigurationServers_TipoServidorFilters[] Filters
        {
            get { return filters; }
            set { filters = value; }
        }
        public TTConfigurationServers_TipoServidorFilters Filter
        {
            ///Cuando es llamada desde las relaciones de algun catalago
            set
            {
                filters = new TTConfigurationServers_TipoServidorFilters[1];
                filters[0] = value;
            }
        }
        ...
        public Int32 SelCount()
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTConfigurationServers_TipoServidor";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            string swhere = "";
            if (this.filters != null)
                foreach (TTConfigurationServers_TipoServidorCS.TTConfigurationServers_TipoServidorFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTConfigurationServers_TipoServidor", fil);
                    if (sWhereT != "")
        ...
        public DataSet SelAll(Boolean ConRelaciones)
        {
            ...
            if (ConRelaciones == true)
                ...
                com.CommandText = "sp_SelAllTTConfigurationServers_TipoServidor";
            com.CommandType = CommandType.StoredProcedure;
            ds = db.Consulta(com);
            String swhere = "";
            String sOrderBy = "";
            if (this.filters != null)
                foreach (TTConfigurationServers_TipoServidorCS.TTConfigurationServers_TipoServidorFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And " + sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTConfigurationServers_TipoServidor", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
            if (swhere != "")
        ...
        {
            TTDataLayerCS.BD db = new TTDataLayerCS.BD();
            db.BeginTransaction("TTConfigurationServers_TipoServidor");
            int? sKey1 = -1;
            try
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_InsTTConfigurationServers_TipoServidor";
                if (varNombre != null)
            ...
            {
                db.RollBackTransaction("TTConfigurationServers_TipoServidor");
                throw ex;
            }
            //return sKey;
        }
        public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            {
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_UpdTTConfigurationServers_TipoServidor";
                com.Parameters.AddWithValue("@idServer", Conversion.FormatNull(varidServer));
                if (varNombre != null)
                    com.Parameters.AddWithValue("@Nombre", varNombre);
                else
                    com.Parameters.AddWithValue("@Nombre", DBNull.Value);
        ...
        public bool Delete(int? Key1, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_DelTTConfigurationServers_TipoServidor";
                com.Parameters.AddWithValue("@idServer", Key1);
                com.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetByKey(int? Key1, Boolean ConRelaciones)
        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones == true)
                com.CommandText = "sp_GetComplete_TTConfigurationServers_TipoServidor";
            else
                com.CommandText = "sp_GetTTConfigurationServers_TipoServidor";
            com.Parameters.AddWithValue("@idServer", Key1);
            ...
            {
                idServer = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTConfigurationServers_TipoServidor_idServer"]);
                Nombre = ds.Tables[0].Rows[0]["TTConfigurationServers_TipoServidor_Nombre"].ToString().TrimEnd(' ');
            }
            return ds;
            //}
        }
        public Int32 CurrentPosicion(int? Key1)
        {
            ...
            {
                if (Function.FormatNumberNull(dt.Rows[i]["TTConfigurationServers_TipoServidor_idServer"]) == Key1)
                    return i;
            }
            return -1;
        }
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "15037")
            {
                this.Filters[indexFilter].idServer = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "15038")
            {
