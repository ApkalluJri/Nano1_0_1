...
namespace TTDashBoard_ComponentTypeCS
{
    public class TTDashBoard_ComponentTypeFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric  varidType =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idType{
            get { return varidType; }
            set { varidType = value; }
        }
...
public class objectBussinessTTDashBoard_ComponentType{
    public int iProcess = 6810;
    ...
    private TTDashBoard_ComponentTypeFilters[] filters; 
    ...
    public TTDashBoard_ComponentTypeFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTDashBoard_ComponentTypeFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTDashBoard_ComponentTypeFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTDashBoard_ComponentType_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTDashBoard_ComponentType";
            ...
            if (this.filters !=null)
                foreach (TTDashBoard_ComponentTypeCS.TTDashBoard_ComponentTypeFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTDashBoard_ComponentType", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTDashBoard_ComponentType";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTDashBoard_ComponentTypeCS.TTDashBoard_ComponentTypeFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTDashBoard_ComponentType", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        TTDataLayerCS.BD db =new TTDataLayerCS.BD();
        db.BeginTransaction("TTDashBoard_ComponentType");
        int? sKey1 = -1;
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTDashBoard_ComponentType";
        ...
        {
            db.RollBackTransaction("TTDashBoard_ComponentType");
            throw ex; 
        }
        //return sKey;
    }
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTDashBoard_ComponentType";
            com.Parameters.AddWithValue("@idType",Conversion.FormatNull(varidType));
            if (varDescripcion!=null)
                com.Parameters.AddWithValue("@Descripcion", varDescripcion);
            else
                com.Parameters.AddWithValue("@Descripcion", DBNull.Value);
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTDashBoard_ComponentType";
com.Parameters.AddWithValue("@idType",Key1);
                com.CommandType =CommandType.StoredProcedure;
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTDashBoard_ComponentType";
            else
                com.CommandText="sp_GetTTDashBoard_ComponentType";
com.Parameters.AddWithValue("@idType",Key1);
            ...
            {
            idType = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTDashBoard_ComponentType_idType"]);
            Descripcion = ds.Tables[0].Rows[0]["TTDashBoard_ComponentType_Descripcion"].ToString().TrimEnd(' ');
    ...
    public Int32 CurrentPosicion(int? Key1)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTDashBoard_ComponentType_idType"]) == Key1)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@idType",Key1);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTDashBoard ComponentType", printFont, Brushes.Black, 80, yPos, new StringFormat());
        yPos += printFont.Height+5;
        printFont = new Font("Arial", 10, FontStyle.Regular);
        ev.Graphics.DrawString("Folio: " + this.varidType, printFont, Brushes.Black, 10, yPos, new StringFormat());
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "15223")
            {
                this.Filters[indexFilter].idType = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "15224")
            {
