...
namespace TTDashBoards_RelacionGrupoUsuariosCS
{
    public class TTDashBoards_RelacionGrupoUsuariosFilters
    {
...
public class objectBussinessTTDashBoards_RelacionGrupoUsuarios{
    public int iProcess = 6813;
    ...
    private TTDashBoards_RelacionGrupoUsuariosFilters[] filters; 
    ...
    public TTDashBoards_RelacionGrupoUsuariosFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTDashBoards_RelacionGrupoUsuariosFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTDashBoards_RelacionGrupoUsuariosFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTDashBoards_RelacionGrupoUsuarios_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTDashBoards_RelacionGrupoUsuarios";
            ...
            if (this.filters !=null)
                foreach (TTDashBoards_RelacionGrupoUsuariosCS.TTDashBoards_RelacionGrupoUsuariosFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTDashBoards_RelacionGrupoUsuarios", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTDashBoards_RelacionGrupoUsuarios";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTDashBoards_RelacionGrupoUsuariosCS.TTDashBoards_RelacionGrupoUsuariosFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTDashBoards_RelacionGrupoUsuarios", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        TTDataLayerCS.BD db =new TTDataLayerCS.BD();
        db.BeginTransaction("TTDashBoards_RelacionGrupoUsuarios");
        int? sKey1 = -1;
        try
        {
            SqlCommand com = new SqlCommand();
        ...
        {
            db.RollBackTransaction("TTDashBoards_RelacionGrupoUsuarios");
            throw ex; 
        }
        //return sKey;
    }
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTDashBoards_RelacionGrupoUsuarios";
            com.Parameters.AddWithValue("@idDashBoard",Conversion.FormatNull(varidDashBoard));
            com.Parameters.AddWithValue("@idGrupoUsuario",Conversion.FormatNull(varidGrupoUsuario));
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTDashBoards_RelacionGrupoUsuarios";
com.Parameters.AddWithValue("@idDashBoard",Key1);com.Parameters.AddWithValue("@idGrupoUsuario",Key2);
                com.CommandType =CommandType.StoredProcedure;
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTDashBoards_RelacionGrupoUsuarios";
            else
                com.CommandText="sp_GetTTDashBoards_RelacionGrupoUsuarios";
com.Parameters.AddWithValue("@idDashBoard",Key1);com.Parameters.AddWithValue("@idGrupoUsuario",Key2);
            ...
            {
            idDashBoard = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTDashBoards_RelacionGrupoUsuarios_idDashBoard"]);
            idGrupoUsuario = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTDashBoards_RelacionGrupoUsuarios_idGrupoUsuario"]);
    ...
    public Int32 CurrentPosicion(int? Key1, int? Key2)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTDashBoards_RelacionGrupoUsuarios_idDashBoard"]) == Key1&& Function.FormatNumberNull(dt.Rows[i]["TTDashBoards_RelacionGrupoUsuarios_idGrupoUsuario"]) == Key2)
                return i;
        }
        return -1;
    }
...
*///            public DataTable FillDataidDashBoard(Object ctr, String Filtro){
            public DataTable FillDataidDashBoard(String Filtro){
                TTDataLayerCS.BD db = new TTDataLayerCS.BD();
                SqlCommand com = new SqlCommand();
                com.CommandText = "sp_selTTDashBoards_RelacionGrupoUsuarios_Relacion_TTDashBoards";
                com.CommandType = CommandType.StoredProcedure;
                //ctr.Items.Clear();
                DataTable dt = db.Consulta(com).Tables[0];
...
//            public void FillDataidGrupoUsuario(Object ctr){
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTDashBoards RelacionGrupoUsuarios", printFont, Brushes.Black, 80, yPos, new StringFormat());
        ...
        if (this.varidDashBoard != null)
        {
            ...
            ev.Graphics.DrawString("Folio del Dash: " + myRelationWhitTTDashBoards.idDashBorad , printFont, Brushes.Black, 10, yPos, new StringFormat());
            yPos += printFont.Height;
        }
        else {
            ev.Graphics.DrawString("Folio del Dash: ----", printFont, Brushes.Black, 10, yPos, new StringFormat());
            yPos += printFont.Height;
        }
        ...
        if (this.varidGrupoUsuario != null)
        {
            ...
            myRelationWhitTTGrupo_de_Usuario.GetByKey(this.varidGrupoUsuario, true);
            ev.Graphics.DrawString("Folio de Grupo de usuario: " + myRelationWhitTTGrupo_de_Usuario.Descripcion , printFont, Brushes.Black, 10, yPos, new StringFormat());
            yPos += printFont.Height;
        }
        else {
            ev.Graphics.DrawString("Folio de Grupo de usuario: ----", printFont, Brushes.Black, 10, yPos, new StringFormat());
            yPos += printFont.Height;
        }
