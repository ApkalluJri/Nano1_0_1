...
namespace TTDominio_TipoCS
{
    public class TTDominio_TipoFilters
    {
...
public class objectBussinessTTDominio_Tipo{
    ...
    private TTDominio_TipoFilters[] filters; 
    ...
    public TTDominio_TipoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTDominio_TipoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTDominio_TipoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTDominio_Tipo_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTDominio_Tipo";
            ...
            if (this.filters !=null)
                foreach (TTDominio_TipoCS.TTDominio_TipoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTDominio_Tipo", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTDominio_Tipo";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTDominio_TipoCS.TTDominio_TipoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTDominio_Tipo", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTDominio_Tipo WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTDominio_Tipo_Folio": sortExpression = "TTDominio_Tipo.Folio"; break;  case "TTDominio_Tipo_Descripcion": sortExpression = "TTDominio_Tipo.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTDominio_Tipo.Folio, TTDominio_Tipo.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTDominio_Tipo.Folio As TTDominio_Tipo_Folio,        TTDominio_Tipo.Descripcion As TTDominio_Tipo_Descripcion ";             string fieldsForExport = " TTDominio_Tipo.Folio As [Folio],        TTDominio_Tipo.Descripcion As [Descripcion] ";             string from = " from  TTDominio_Tipo WITH(NoLock)  " + swhere; 
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTDominio_Tipo");
        int? sKeyFolio = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTDominio_Tipo";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTDominio_Tipo");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTDominio_Tipo";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTDominio_Tipo";
com.Parameters.AddWithValue("@Folio",KeyFolio);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Folio = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTDominio_Tipo_Folio"]);
            Descripcion = ds.Tables[0].Rows[0]["TTDominio_Tipo_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTDominio_Tipo";
            else
                com.CommandText="sp_GetTTDominio_Tipo";
com.Parameters.AddWithValue("@Folio",KeyFolio);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTDominio_Tipo.Folio As TTDominio_Tipo_Folio,        TTDominio_Tipo.Descripcion As TTDominio_Tipo_Descripcion   from  TTDominio_Tipo           Where TTDominio_Tipo.Folio = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTDominio_Tipo.Folio As TTDominio_Tipo_Folio,        TTDominio_Tipo.Descripcion As TTDominio_Tipo_Descripcion   from  TTDominio_Tipo           Where TTDominio_Tipo.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyFolio)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTDominio_Tipo_Folio"]) == KeyFolio)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@Folio",KeyFolio);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTDominio Tipo", printFont, Brushes.Black, 80, yPos, new StringFormat());
