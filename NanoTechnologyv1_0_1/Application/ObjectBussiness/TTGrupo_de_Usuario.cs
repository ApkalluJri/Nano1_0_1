...
namespace TTGrupo_de_UsuarioCS
{
    public class TTGrupo_de_UsuarioFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric  varIdGrupoUsuario =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric IdGrupoUsuario{
...
public class objectBussinessTTGrupo_de_Usuario{
    ...
    private TTGrupo_de_UsuarioFilters[] filters; 
    ...
    public TTGrupo_de_UsuarioFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTGrupo_de_UsuarioFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTGrupo_de_UsuarioFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTGrupo_de_Usuario_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTGrupo_de_Usuario";
            ...
            if (this.filters !=null)
                foreach (TTGrupo_de_UsuarioCS.TTGrupo_de_UsuarioFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTGrupo_de_Usuario", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTGrupo_de_Usuario";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTGrupo_de_UsuarioCS.TTGrupo_de_UsuarioFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTGrupo_de_Usuario", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTGrupo_de_Usuario WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTGrupo_de_Usuario_IdGrupoUsuario": sortExpression = "TTGrupo_de_Usuario.IdGrupoUsuario"; break;  case "TTGrupo_de_Usuario_Descripcion": sortExpression = "TTGrupo_de_Usuario.Descripcion"; break;  case "TTGrupo_de_Usuario_Activo": sortExpression = "TTGrupo_de_Usuario.Activo"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTGrupo_de_Usuario.IdGrupoUsuario, TTGrupo_de_Usuario.Descripcion, TTGrupo_de_Usuario.Activo" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTGrupo_de_Usuario.IdGrupoUsuario As TTGrupo_de_Usuario_IdGrupoUsuario,        TTGrupo_de_Usuario.Descripcion As TTGrupo_de_Usuario_Descripcion,        TTGrupo_de_Usuario.Activo As TTGrupo_de_Usuario_Activo ";             string fieldsForExport = " TTGrupo_de_Usuario.IdGrupoUsuario As [IdGrupoUsuario],        TTGrupo_de_Usuario.Descripcion As [Descripcion],        TTGrupo_de_Usuario.Activo As [Activo] ";             string from = " from  TTGrupo_de_Usuario WITH(NoLock)  " + swhere; 
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTGrupo_de_Usuario");
        int? sKeyIdGrupoUsuario = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTGrupo_de_Usuario";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTGrupo_de_Usuario");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTGrupo_de_Usuario";
            com.Parameters.AddWithValue("@IdGrupoUsuario",Conversion.FormatNull(varIdGrupoUsuario));
            if (varDescripcion!=null)
                com.Parameters.AddWithValue("@Descripcion", Convierte(varDescripcion,ConvierteAMayusculas));
            else
...
//            varIdGrupoUsuario = sKeyIdGrupoUsuario;
    ...
    public bool Delete(int? KeyIdGrupoUsuario, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
//        if (Key == ""){
...
//        }else{
            Boolean result;
            DataReference.Folio =  KeyIdGrupoUsuario.ToString();
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            db.BeginTransaction("TTGrupo_de_Usuario");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTGrupo_de_Usuario";
com.Parameters.AddWithValue("@IdGrupoUsuario",KeyIdGrupoUsuario);
                com.CommandType =CommandType.StoredProcedure;
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            IdGrupoUsuario = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTGrupo_de_Usuario_IdGrupoUsuario"]);
            Descripcion = ds.Tables[0].Rows[0]["TTGrupo_de_Usuario_Descripcion"].ToString();
            if (ds.Tables[0].Rows[0]["TTGrupo_de_Usuario_Activo"] != DBNull.Value)
                Activo = Convert.ToBoolean(ds.Tables[0].Rows[0]["TTGrupo_de_Usuario_Activo"]);
    ...
    public DataSet GetByKey(int? KeyIdGrupoUsuario, Boolean ConRelaciones){
        DataSet ds;
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTGrupo_de_Usuario";
            else
                com.CommandText="sp_GetTTGrupo_de_Usuario";
com.Parameters.AddWithValue("@IdGrupoUsuario",KeyIdGrupoUsuario);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTGrupo_de_Usuario.IdGrupoUsuario As TTGrupo_de_Usuario_IdGrupoUsuario,        TTGrupo_de_Usuario.Descripcion As TTGrupo_de_Usuario_Descripcion,        TTGrupo_de_Usuario.Activo As TTGrupo_de_Usuario_Activo   from  TTGrupo_de_Usuario           Where TTGrupo_de_Usuario.IdGrupoUsuario = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTGrupo_de_Usuario.IdGrupoUsuario As TTGrupo_de_Usuario_IdGrupoUsuario,        TTGrupo_de_Usuario.Descripcion As TTGrupo_de_Usuario_Descripcion,        TTGrupo_de_Usuario.Activo As TTGrupo_de_Usuario_Activo   from  TTGrupo_de_Usuario           Where TTGrupo_de_Usuario.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTGrupo_de_Usuario.IdGrupoUsuario As TTGrupo_de_Usuario_IdGrupoUsuario,        TTGrupo_de_Usuario.Descripcion As TTGrupo_de_Usuario_Descripcion,        TTGrupo_de_Usuario.Activo As TTGrupo_de_Usuario_Activo   from  TTGrupo_de_Usuario           Where TTGrupo_de_Usuario.Activo = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyIdGrupoUsuario)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTGrupo_de_Usuario_IdGrupoUsuario"]) == KeyIdGrupoUsuario)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@IdGrupoUsuario",KeyIdGrupoUsuario);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTGrupo de Usuario", printFont, Brushes.Black, 80, yPos, new StringFormat());
        yPos += printFont.Height+5;
        printFont = new Font("Arial", 10, FontStyle.Regular);
        ev.Graphics.DrawString("Clave: " + this.varIdGrupoUsuario, printFont, Brushes.Black, 10, yPos, new StringFormat());
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            ...
            if (sDTid == "13084")
            {
                this.Filters[indexFilter].IdGrupoUsuario = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "13085")
            {
