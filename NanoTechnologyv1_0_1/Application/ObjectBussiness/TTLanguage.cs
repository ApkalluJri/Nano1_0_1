...
namespace TTLanguageCS
{
    public class TTLanguageFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric  varidLanguage =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric idLanguage{
            get { return varidLanguage; }
            set { varidLanguage = value; }
        }
        private TTClassSpecials.FiltersTypes.String varIdioma = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Idioma
        {
            get { return varIdioma; }
            set { varIdioma = value; }
        }
        private TTClassSpecials.FiltersTypes.Numeric  varBandera =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric Bandera{
            get { return varBandera; }
            set { varBandera = value; }
        }
        private TTClassSpecials.FiltersTypes.String varAbreviatura = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Abreviatura
        {
            get { return varAbreviatura; }
            set { varAbreviatura = value; }
        }

    }
public class objectBussinessTTLanguage{
    ...
    private TTLanguageFilters[] filters; 
	...
	private int? varidLanguage;
	private String varIdioma;
	private int? varBandera;
	private String varAbreviatura;
    ...
    public TTLanguageFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTLanguageFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTLanguageFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTLanguage_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTLanguage";
            ...
            if (this.filters !=null)
                foreach (TTLanguageCS.TTLanguageFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTLanguage", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTLanguage";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTLanguageCS.TTLanguageFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTLanguage", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTLanguage WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTLanguage_idLanguage": sortExpression = "TTLanguage.idLanguage"; break;  case "TTLanguage_Idioma": sortExpression = "TTLanguage.Idioma"; break;  case "TTLanguage_Bandera": sortExpression = "TTLanguage.Bandera"; break;  case "TTLanguage_Abreviatura": sortExpression = "TTLanguage.Abreviatura"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTLanguage.idLanguage, TTLanguage.Idioma, TTLanguage.Bandera, TTLanguage.Abreviatura" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTLanguage.idLanguage As TTLanguage_idLanguage,        TTLanguage.Idioma As TTLanguage_Idioma,        TTLanguage.Bandera As TTLanguage_Bandera,        TTLanguage.Abreviatura As TTLanguage_Abreviatura ";             string fieldsForExport = " TTLanguage.idLanguage As [idLanguage],        TTLanguage.Idioma As [Idioma],        TTLanguage.Bandera As [Bandera],        TTLanguage.Abreviatura As [Abreviatura] ";             string from = " from  TTLanguage WITH(NoLock)  " + swhere; 
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTLanguage");
        int? sKeyidLanguage = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTLanguage";
            if (varIdioma!=null)
                com.Parameters.AddWithValue("@Idioma", Convierte(varIdioma,ConvierteAMayusculas));
            else
                com.Parameters.AddWithValue("@Idioma", DBNull.Value);
            com.Parameters.AddWithValue("@Bandera",Conversion.FormatNull(varBandera));
            if (varAbreviatura!=null)
                com.Parameters.AddWithValue("@Abreviatura", Convierte(varAbreviatura,ConvierteAMayusculas));
            else
                com.Parameters.AddWithValue("@Abreviatura", DBNull.Value);

            com.CommandType =CommandType.StoredProcedure;
            sKeyidLanguage = Function.FormatNumberNull( db.EjecutaInsert(com, UserInformation, DataReference));
            varidLanguage = sKeyidLanguage;
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTLanguage");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTLanguage";
            com.Parameters.AddWithValue("@idLanguage",Conversion.FormatNull(varidLanguage));
            if (varIdioma!=null)
                com.Parameters.AddWithValue("@Idioma", Convierte(varIdioma,ConvierteAMayusculas));
            else
                com.Parameters.AddWithValue("@Idioma", DBNull.Value);
            ...
            com.CommandType =CommandType.StoredProcedure;
            sKeyidLanguage = Function.FormatNumberNull( db.EjecutaUpdate(com, UserInformation, DataReference));
//            varidLanguage = sKeyidLanguage;
    ...
    public bool Delete(int? KeyidLanguage, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
//        if (Key == ""){
...
//        }else{
            Boolean result;
            DataReference.Folio =  KeyidLanguage.ToString();
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            db.BeginTransaction("TTLanguage");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTLanguage";
com.Parameters.AddWithValue("@idLanguage",KeyidLanguage);
                com.CommandType =CommandType.StoredProcedure;
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            idLanguage = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTLanguage_idLanguage"]);
            Idioma = ds.Tables[0].Rows[0]["TTLanguage_Idioma"].ToString();
            Bandera = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTLanguage_Bandera"]);
            Abreviatura = ds.Tables[0].Rows[0]["TTLanguage_Abreviatura"].ToString();
    ...
    public DataSet GetByKey(int? KeyidLanguage, Boolean ConRelaciones){
        DataSet ds;
        if (KeyidLanguage == null){
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTLanguage";
            else
                com.CommandText="sp_GetTTLanguage";
com.Parameters.AddWithValue("@idLanguage",KeyidLanguage);
    ...
    public DataSet GetByKeyidLanguage(int? Key){
        DataSet ds;
        if (Key == null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTLanguage.idLanguage As TTLanguage_idLanguage,        TTLanguage.Idioma As TTLanguage_Idioma,        TTLanguage.Bandera As TTLanguage_Bandera,        TTLanguage.Abreviatura As TTLanguage_Abreviatura   from  TTLanguage           Where TTLanguage.idLanguage = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyIdioma(String Key){
        DataSet ds;
        if (Key == null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTLanguage.idLanguage As TTLanguage_idLanguage,        TTLanguage.Idioma As TTLanguage_Idioma,        TTLanguage.Bandera As TTLanguage_Bandera,        TTLanguage.Abreviatura As TTLanguage_Abreviatura   from  TTLanguage           Where TTLanguage.Idioma = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyBandera(int? Key){
        DataSet ds;
        if (Key == null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTLanguage.idLanguage As TTLanguage_idLanguage,        TTLanguage.Idioma As TTLanguage_Idioma,        TTLanguage.Bandera As TTLanguage_Bandera,        TTLanguage.Abreviatura As TTLanguage_Abreviatura   from  TTLanguage           Where TTLanguage.Bandera = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyAbreviatura(String Key){
        DataSet ds;
        if (Key == null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTLanguage.idLanguage As TTLanguage_idLanguage,        TTLanguage.Idioma As TTLanguage_Idioma,        TTLanguage.Bandera As TTLanguage_Bandera,        TTLanguage.Abreviatura As TTLanguage_Abreviatura   from  TTLanguage           Where TTLanguage.Abreviatura = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyidLanguage)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTLanguage_idLanguage"]) == KeyidLanguage)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@idLanguage",KeyidLanguage);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTLanguage", printFont, Brushes.Black, 80, yPos, new StringFormat());
        yPos += printFont.Height+5;
        printFont = new Font("Arial", 10, FontStyle.Regular);
        ev.Graphics.DrawString("Folio: " + this.varidLanguage, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;

        ev.Graphics.DrawString("Idioma: " + this.varIdioma, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;

        ev.Graphics.DrawString("Abreviatura: " + this.varAbreviatura, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            ...
            if (sDTid == "30060")
            {
                this.Filters[indexFilter].idLanguage = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "30061")
            {
                this.Filters[indexFilter].Idioma = (TTClassSpecials.FiltersTypes.String)filter;
            }
            if (sDTid == "30062")
            {
                this.Filters[indexFilter].Bandera = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "30063")
            {
                this.Filters[indexFilter].Abreviatura = (TTClassSpecials.FiltersTypes.String)filter;
            }
