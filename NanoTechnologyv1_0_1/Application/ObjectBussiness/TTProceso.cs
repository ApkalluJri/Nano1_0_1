...
namespace TTProcesoCS
{
    public class TTProcesoFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric  varIdProceso =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric IdProceso{
        ...
        private TTClassSpecials.FiltersTypes.String varPantalla = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Pantalla
        {
            get { return varPantalla; }
            set { varPantalla = value; }
        }

    }
public class objectBussinessTTProceso{
    ...
    private TTProcesoFilters[] filters; 
    ...
    public TTProcesoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTProcesoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTProcesoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTProceso_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTProceso";
            ...
            if (this.filters !=null)
                foreach (TTProcesoCS.TTProcesoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTProceso", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTProceso";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTProcesoCS.TTProcesoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTProceso", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        TTDataLayerCS.BD db =new TTDataLayerCS.BD();
        db.BeginTransaction("TTProceso");
        int? sKeyIdProceso = -1;
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTProceso";
            ...
            if (varPantalla!=null)
                com.Parameters.AddWithValue("@Pantalla", varPantalla);
            else
                com.Parameters.AddWithValue("@Pantalla", DBNull.Value);

            com.CommandType =CommandType.StoredProcedure;
            sKeyIdProceso = Function.FormatNumberNull(db.EjecutaInsert(com, UserInformation, DataReference));
        ...
        {
            db.RollBackTransaction("TTProceso");
            throw ex; 
        }
        //return sKey;
    }
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTProceso";
            com.Parameters.AddWithValue("@IdProceso",Conversion.FormatNull(varIdProceso));
            if (varNombre!=null)
                com.Parameters.AddWithValue("@Nombre", varNombre);
            else
            ...
            com.CommandType =CommandType.StoredProcedure;
            sKeyIdProceso = Function.FormatNumberNull( db.EjecutaUpdate(com, UserInformation, DataReference));
//            varIdProceso = sKeyIdProceso;
    ...
    public bool Delete(int? KeyIdProceso, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
//        if (Key == ""){
...
//        }else{
            Boolean result;
            DataReference.Folio =  KeyIdProceso.ToString();
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            db.BeginTransaction("TTProceso");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTProceso";
com.Parameters.AddWithValue("@IdProceso",KeyIdProceso);
                com.CommandType =CommandType.StoredProcedure;
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            IdProceso = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTProceso_IdProceso"]);
            Nombre = ds.Tables[0].Rows[0]["TTProceso_Nombre"].ToString();
            Pantalla = ds.Tables[0].Rows[0]["TTProceso_Pantalla"].ToString();
    ...
    public DataSet GetByKey(int? KeyIdProceso, Boolean ConRelaciones){
        DataSet ds;
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTProceso";
            else
                com.CommandText="sp_GetTTProceso";
com.Parameters.AddWithValue("@IdProceso",KeyIdProceso);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTProceso.IdProceso As TTProceso_IdProceso,        TTProceso.Nombre As TTProceso_Nombre,        TTProceso.Pantalla As TTProceso_Pantalla   from  TTProceso           Where TTProceso.IdProceso = '" + Key + "'";
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTProceso.IdProceso As TTProceso_IdProceso,        TTProceso.Nombre As TTProceso_Nombre,        TTProceso.Pantalla As TTProceso_Pantalla   from  TTProceso           Where TTProceso.Nombre = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyPantalla(String Key){
        DataSet ds;
        if (Key == null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTProceso.IdProceso As TTProceso_IdProceso,        TTProceso.Nombre As TTProceso_Nombre,        TTProceso.Pantalla As TTProceso_Pantalla   from  TTProceso           Where TTProceso.Pantalla = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyIdProceso)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTProceso_IdProceso"]) == KeyIdProceso)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@IdProceso",KeyIdProceso);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTProceso", printFont, Brushes.Black, 80, yPos, new StringFormat());
        yPos += printFont.Height+5;
        printFont = new Font("Arial", 10, FontStyle.Regular);
        ev.Graphics.DrawString("Folio: " + this.varIdProceso, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;

        ev.Graphics.DrawString("Nombre: " + this.varNombre, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;

        ev.Graphics.DrawString("Pantalla: " + this.varPantalla, printFont, Brushes.Black, 10, yPos, new StringFormat());
        yPos += printFont.Height;
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "13076")
            {
                this.Filters[indexFilter].IdProceso = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "13077")
            {
            ...
            if (sDTid == "13078")
            {
                this.Filters[indexFilter].Pantalla = (TTClassSpecials.FiltersTypes.String)filter;
            }
