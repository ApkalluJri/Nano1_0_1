...
namespace TTTipo_de_ControlCS
{
    public class TTTipo_de_ControlFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.Numeric  varIdTipoControl =new TTClassSpecials.FiltersTypes.Numeric();
        public TTClassSpecials.FiltersTypes.Numeric IdTipoControl{
            get { return varIdTipoControl; }
            set { varIdTipoControl = value; }
        }
...
public class objectBussinessTTTipo_de_Control{
    ...
    private TTTipo_de_ControlFilters[] filters; 
    ...
    public TTTipo_de_ControlFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTTipo_de_ControlFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTTipo_de_ControlFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTTipo_de_Control_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTTipo_de_Control";
            ...
            if (this.filters !=null)
                foreach (TTTipo_de_ControlCS.TTTipo_de_ControlFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTTipo_de_Control", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTTipo_de_Control";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTTipo_de_ControlCS.TTTipo_de_ControlFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTTipo_de_Control", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        TTDataLayerCS.BD db =new TTDataLayerCS.BD();
        db.BeginTransaction("TTTipo_de_Control");
        int? sKeyIdTipoControl = -1;
        try
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTTipo_de_Control";
            ...
            com.CommandType =CommandType.StoredProcedure;
            sKeyIdTipoControl = Function.FormatNumberNull( db.EjecutaInsert(com, UserInformation, DataReference));
            varIdTipoControl = sKeyIdTipoControl;
        ...
        {
            db.RollBackTransaction("TTTipo_de_Control");
            throw ex; 
        }
        //return sKey;
    }
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        {
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTTipo_de_Control";
            com.Parameters.AddWithValue("@IdTipoControl",Conversion.FormatNull(varIdTipoControl));
            if (varDescripcion!=null)
                com.Parameters.AddWithValue("@Descripcion", varDescripcion);
            else
                com.Parameters.AddWithValue("@Descripcion", DBNull.Value);
            ...
            com.CommandType =CommandType.StoredProcedure;
            sKeyIdTipoControl = Function.FormatNumberNull( db.EjecutaUpdate(com, UserInformation, DataReference));
//            varIdTipoControl = sKeyIdTipoControl;
    ...
    public bool Delete(int? KeyIdTipoControl, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
//        if (Key == ""){
...
//        }else{
            Boolean result;
            DataReference.Folio =  KeyIdTipoControl.ToString();
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            db.BeginTransaction("TTTipo_de_Control");
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTTipo_de_Control";
com.Parameters.AddWithValue("@IdTipoControl",KeyIdTipoControl);
                com.CommandType =CommandType.StoredProcedure;
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTTipo_de_Control";
            else
                com.CommandText="sp_GetTTTipo_de_Control";
com.Parameters.AddWithValue("@IdTipoControl",KeyIdTipoControl);
            ...
            {
            IdTipoControl = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTTipo_de_Control_IdTipoControl"]);
            Descripcion = ds.Tables[0].Rows[0]["TTTipo_de_Control_Descripcion"].ToString().TrimEnd(' ');
    ...
    public Int32 CurrentPosicion(int? KeyIdTipoControl)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTTipo_de_Control_IdTipoControl"]) == KeyIdTipoControl)
                return i;
        }
        return -1;
    }
...
com.Parameters.AddWithValue("@IdTipoControl",KeyIdTipoControl);
    ...
    private void pd_PrintPage(Object sender, System.Drawing.Printing.PrintPageEventArgs ev)
    {
        ...
        ev.Graphics.DrawString("TTTipo de Control", printFont, Brushes.Black, 80, yPos, new StringFormat());
        yPos += printFont.Height+5;
        printFont = new Font("Arial", 10, FontStyle.Regular);
        ev.Graphics.DrawString("Folio: " + this.varIdTipoControl, printFont, Brushes.Black, 10, yPos, new StringFormat());
        ...
        public void AddFilterXDT(string sDTid, Object filter, int indexFilter)
        {
            if (sDTid == "15022")
            {
                this.Filters[indexFilter].IdTipoControl = (TTClassSpecials.FiltersTypes.Numeric)filter;
            }
            if (sDTid == "15023")
            {
