...
namespace TTWorkFlow_Estatus_de_WorkFlowCS
{
    public class TTWorkFlow_Estatus_de_WorkFlowFilters
    {
...
public class objectBussinessTTWorkFlow_Estatus_de_WorkFlow{
    ...
    private TTWorkFlow_Estatus_de_WorkFlowFilters[] filters; 
    ...
    public TTWorkFlow_Estatus_de_WorkFlowFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_Estatus_de_WorkFlowFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_Estatus_de_WorkFlowFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Estatus_de_WorkFlow_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Estatus_de_WorkFlow";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Estatus_de_WorkFlowCS.TTWorkFlow_Estatus_de_WorkFlowFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Estatus_de_WorkFlow", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Estatus_de_WorkFlow";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Estatus_de_WorkFlowCS.TTWorkFlow_Estatus_de_WorkFlowFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Estatus_de_WorkFlow", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Estatus_de_WorkFlow WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Estatus_de_WorkFlow_Clave": sortExpression = "TTWorkFlow_Estatus_de_WorkFlow.Clave"; break;  case "TTWorkFlow_Estatus_de_WorkFlow_Descripcion": sortExpression = "TTWorkFlow_Estatus_de_WorkFlow.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Estatus_de_WorkFlow.Clave, TTWorkFlow_Estatus_de_WorkFlow.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Estatus_de_WorkFlow.Clave As TTWorkFlow_Estatus_de_WorkFlow_Clave,        TTWorkFlow_Estatus_de_WorkFlow.Descripcion As TTWorkFlow_Estatus_de_WorkFlow_Descripcion ";             string fieldsForExport = " TTWorkFlow_Estatus_de_WorkFlow.Clave As [Clave],        TTWorkFlow_Estatus_de_WorkFlow.Descripcion As [Descripcion] ";             string from = " from  TTWorkFlow_Estatus_de_WorkFlow WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Estatus_de_WorkFlow.Clave As TTWorkFlow_Estatus_de_WorkFlow_Clave,        TTWorkFlow_Estatus_de_WorkFlow.Descripcion As TTWorkFlow_Estatus_de_WorkFlow_Descripcion ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Estatus_de_WorkFlow.Clave, TTWorkFlow_Estatus_de_WorkFlow.Descripcion" : Order);         string from = " from  TTWorkFlow_Estatus_de_WorkFlow WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Estatus_de_WorkFlow");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Estatus_de_WorkFlow";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Estatus_de_WorkFlow");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Estatus_de_WorkFlow";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Estatus_de_WorkFlow";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Estatus_de_WorkFlow_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["TTWorkFlow_Estatus_de_WorkFlow_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Estatus_de_WorkFlow";
            else
                com.CommandText="sp_GetTTWorkFlow_Estatus_de_WorkFlow";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Estatus_de_WorkFlow.Clave As TTWorkFlow_Estatus_de_WorkFlow_Clave,        TTWorkFlow_Estatus_de_WorkFlow.Descripcion As TTWorkFlow_Estatus_de_WorkFlow_Descripcion   from  TTWorkFlow_Estatus_de_WorkFlow           Where TTWorkFlow_Estatus_de_WorkFlow.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Estatus_de_WorkFlow.Clave As TTWorkFlow_Estatus_de_WorkFlow_Clave,        TTWorkFlow_Estatus_de_WorkFlow.Descripcion As TTWorkFlow_Estatus_de_WorkFlow_Descripcion   from  TTWorkFlow_Estatus_de_WorkFlow           Where TTWorkFlow_Estatus_de_WorkFlow.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Estatus_de_WorkFlow_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
