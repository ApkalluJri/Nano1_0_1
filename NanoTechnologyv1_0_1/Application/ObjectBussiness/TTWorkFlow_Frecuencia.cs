...
namespace TTWorkFlow_FrecuenciaCS
{
    public class TTWorkFlow_FrecuenciaFilters
    {
...
public class objectBussinessTTWorkFlow_Frecuencia{
    ...
    private TTWorkFlow_FrecuenciaFilters[] filters; 
    ...
    public TTWorkFlow_FrecuenciaFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_FrecuenciaFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_FrecuenciaFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Frecuencia_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Frecuencia";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_FrecuenciaCS.TTWorkFlow_FrecuenciaFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Frecuencia", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Frecuencia";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_FrecuenciaCS.TTWorkFlow_FrecuenciaFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Frecuencia", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Frecuencia WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Frecuencia_Clave": sortExpression = "TTWorkFlow_Frecuencia.Clave"; break;  case "TTWorkFlow_Frecuencia_Nombre": sortExpression = "TTWorkFlow_Frecuencia.Nombre"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Frecuencia.Clave, TTWorkFlow_Frecuencia.Nombre" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Frecuencia.Clave As TTWorkFlow_Frecuencia_Clave,        TTWorkFlow_Frecuencia.Nombre As TTWorkFlow_Frecuencia_Nombre ";             string fieldsForExport = " TTWorkFlow_Frecuencia.Clave As [Clave],        TTWorkFlow_Frecuencia.Nombre As [Nombre] ";             string from = " from  TTWorkFlow_Frecuencia WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Frecuencia.Clave As TTWorkFlow_Frecuencia_Clave,        TTWorkFlow_Frecuencia.Nombre As TTWorkFlow_Frecuencia_Nombre ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Frecuencia.Clave, TTWorkFlow_Frecuencia.Nombre" : Order);         string from = " from  TTWorkFlow_Frecuencia WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Frecuencia");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Frecuencia";
            if (varNombre!=null)
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Frecuencia");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Frecuencia";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Frecuencia";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Frecuencia_Clave"]);
            Nombre = ds.Tables[0].Rows[0]["TTWorkFlow_Frecuencia_Nombre"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Frecuencia";
            else
                com.CommandText="sp_GetTTWorkFlow_Frecuencia";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Frecuencia.Clave As TTWorkFlow_Frecuencia_Clave,        TTWorkFlow_Frecuencia.Nombre As TTWorkFlow_Frecuencia_Nombre   from  TTWorkFlow_Frecuencia           Where TTWorkFlow_Frecuencia.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Frecuencia.Clave As TTWorkFlow_Frecuencia_Clave,        TTWorkFlow_Frecuencia.Nombre As TTWorkFlow_Frecuencia_Nombre   from  TTWorkFlow_Frecuencia           Where TTWorkFlow_Frecuencia.Nombre = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Frecuencia_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
