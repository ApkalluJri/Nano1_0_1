...
namespace TTWorkFlow_RespuestaCS
{
    public class TTWorkFlow_RespuestaFilters
    {
...
public class objectBussinessTTWorkFlow_Respuesta{
    ...
    private TTWorkFlow_RespuestaFilters[] filters; 
    ...
    public TTWorkFlow_RespuestaFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_RespuestaFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_RespuestaFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Respuesta_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Respuesta";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_RespuestaCS.TTWorkFlow_RespuestaFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Respuesta", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Respuesta";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_RespuestaCS.TTWorkFlow_RespuestaFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Respuesta", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Respuesta WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Respuesta_Clave": sortExpression = "TTWorkFlow_Respuesta.Clave"; break;  case "TTWorkFlow_Respuesta_Descripcion": sortExpression = "TTWorkFlow_Respuesta.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Respuesta.Clave, TTWorkFlow_Respuesta.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Respuesta.Clave As TTWorkFlow_Respuesta_Clave,        TTWorkFlow_Respuesta.Descripcion As TTWorkFlow_Respuesta_Descripcion ";             string fieldsForExport = " TTWorkFlow_Respuesta.Clave As [Clave],        TTWorkFlow_Respuesta.Descripcion As [Descripcion] ";             string from = " from  TTWorkFlow_Respuesta WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Respuesta.Clave As TTWorkFlow_Respuesta_Clave,        TTWorkFlow_Respuesta.Descripcion As TTWorkFlow_Respuesta_Descripcion ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Respuesta.Clave, TTWorkFlow_Respuesta.Descripcion" : Order);         string from = " from  TTWorkFlow_Respuesta WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Respuesta");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Respuesta";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Respuesta");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Respuesta";
            com.Parameters.AddWithValue("@Clave",Conversion.FormatNull(varClave));
            if (varDescripcion!=null)
                com.Parameters.AddWithValue("@Descripcion", Convierte(varDescripcion,ConvierteAMayusculas));
            else
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Respuesta";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Respuesta_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["TTWorkFlow_Respuesta_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Respuesta";
            else
                com.CommandText="sp_GetTTWorkFlow_Respuesta";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Respuesta.Clave As TTWorkFlow_Respuesta_Clave,        TTWorkFlow_Respuesta.Descripcion As TTWorkFlow_Respuesta_Descripcion   from  TTWorkFlow_Respuesta           Where TTWorkFlow_Respuesta.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Respuesta.Clave As TTWorkFlow_Respuesta_Clave,        TTWorkFlow_Respuesta.Descripcion As TTWorkFlow_Respuesta_Descripcion   from  TTWorkFlow_Respuesta           Where TTWorkFlow_Respuesta.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Respuesta_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
