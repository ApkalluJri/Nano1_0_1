...
namespace TTWorkFlow_Tipo_Control_FlujoCS
{
    public class TTWorkFlow_Tipo_Control_FlujoFilters
    {
...
public class objectBussinessTTWorkFlow_Tipo_Control_Flujo{
    ...
    private TTWorkFlow_Tipo_Control_FlujoFilters[] filters; 
    ...
    public TTWorkFlow_Tipo_Control_FlujoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_Tipo_Control_FlujoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_Tipo_Control_FlujoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_Control_Flujo_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_Control_Flujo";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_Control_FlujoCS.TTWorkFlow_Tipo_Control_FlujoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Tipo_Control_Flujo", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Tipo_Control_Flujo";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_Control_FlujoCS.TTWorkFlow_Tipo_Control_FlujoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Tipo_Control_Flujo", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Tipo_Control_Flujo WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Tipo_Control_Flujo_Clave": sortExpression = "TTWorkFlow_Tipo_Control_Flujo.Clave"; break;  case "TTWorkFlow_Tipo_Control_Flujo_Descripcion": sortExpression = "TTWorkFlow_Tipo_Control_Flujo.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Tipo_Control_Flujo.Clave, TTWorkFlow_Tipo_Control_Flujo.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Tipo_Control_Flujo.Clave As TTWorkFlow_Tipo_Control_Flujo_Clave,        TTWorkFlow_Tipo_Control_Flujo.Descripcion As TTWorkFlow_Tipo_Control_Flujo_Descripcion ";             string fieldsForExport = " TTWorkFlow_Tipo_Control_Flujo.Clave As [Clave],        TTWorkFlow_Tipo_Control_Flujo.Descripcion As [Descripcion] ";             string from = " from  TTWorkFlow_Tipo_Control_Flujo WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Tipo_Control_Flujo.Clave As TTWorkFlow_Tipo_Control_Flujo_Clave,        TTWorkFlow_Tipo_Control_Flujo.Descripcion As TTWorkFlow_Tipo_Control_Flujo_Descripcion ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Tipo_Control_Flujo.Clave, TTWorkFlow_Tipo_Control_Flujo.Descripcion" : Order);         string from = " from  TTWorkFlow_Tipo_Control_Flujo WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Tipo_Control_Flujo");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Tipo_Control_Flujo";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Tipo_Control_Flujo");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Tipo_Control_Flujo";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Tipo_Control_Flujo";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_Control_Flujo_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_Control_Flujo_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Tipo_Control_Flujo";
            else
                com.CommandText="sp_GetTTWorkFlow_Tipo_Control_Flujo";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_Control_Flujo.Clave As TTWorkFlow_Tipo_Control_Flujo_Clave,        TTWorkFlow_Tipo_Control_Flujo.Descripcion As TTWorkFlow_Tipo_Control_Flujo_Descripcion   from  TTWorkFlow_Tipo_Control_Flujo           Where TTWorkFlow_Tipo_Control_Flujo.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_Control_Flujo.Clave As TTWorkFlow_Tipo_Control_Flujo_Clave,        TTWorkFlow_Tipo_Control_Flujo.Descripcion As TTWorkFlow_Tipo_Control_Flujo_Descripcion   from  TTWorkFlow_Tipo_Control_Flujo           Where TTWorkFlow_Tipo_Control_Flujo.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Tipo_Control_Flujo_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
