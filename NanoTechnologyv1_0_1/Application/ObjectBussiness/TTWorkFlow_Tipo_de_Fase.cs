...
namespace TTWorkFlow_Tipo_de_FaseCS
{
    public class TTWorkFlow_Tipo_de_FaseFilters
    {
...
public class objectBussinessTTWorkFlow_Tipo_de_Fase{
    ...
    private TTWorkFlow_Tipo_de_FaseFilters[] filters; 
    ...
    public TTWorkFlow_Tipo_de_FaseFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_Tipo_de_FaseFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_Tipo_de_FaseFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_de_Fase_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_de_Fase";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_de_FaseCS.TTWorkFlow_Tipo_de_FaseFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Tipo_de_Fase", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Tipo_de_Fase";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_de_FaseCS.TTWorkFlow_Tipo_de_FaseFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Tipo_de_Fase", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Tipo_de_Fase WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Tipo_de_Fase_Clave": sortExpression = "TTWorkFlow_Tipo_de_Fase.Clave"; break;  case "TTWorkFlow_Tipo_de_Fase_Descripcion": sortExpression = "TTWorkFlow_Tipo_de_Fase.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Tipo_de_Fase.Clave, TTWorkFlow_Tipo_de_Fase.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Tipo_de_Fase.Clave As TTWorkFlow_Tipo_de_Fase_Clave,        TTWorkFlow_Tipo_de_Fase.Descripcion As TTWorkFlow_Tipo_de_Fase_Descripcion ";             string fieldsForExport = " TTWorkFlow_Tipo_de_Fase.Clave As [Clave],        TTWorkFlow_Tipo_de_Fase.Descripcion As [Descripcion] ";             string from = " from  TTWorkFlow_Tipo_de_Fase WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Tipo_de_Fase.Clave As TTWorkFlow_Tipo_de_Fase_Clave,        TTWorkFlow_Tipo_de_Fase.Descripcion As TTWorkFlow_Tipo_de_Fase_Descripcion ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Tipo_de_Fase.Clave, TTWorkFlow_Tipo_de_Fase.Descripcion" : Order);         string from = " from  TTWorkFlow_Tipo_de_Fase WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Tipo_de_Fase");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Tipo_de_Fase";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Tipo_de_Fase");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Tipo_de_Fase";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Tipo_de_Fase";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_de_Fase_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_de_Fase_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Tipo_de_Fase";
            else
                com.CommandText="sp_GetTTWorkFlow_Tipo_de_Fase";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_de_Fase.Clave As TTWorkFlow_Tipo_de_Fase_Clave,        TTWorkFlow_Tipo_de_Fase.Descripcion As TTWorkFlow_Tipo_de_Fase_Descripcion   from  TTWorkFlow_Tipo_de_Fase           Where TTWorkFlow_Tipo_de_Fase.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_de_Fase.Clave As TTWorkFlow_Tipo_de_Fase_Clave,        TTWorkFlow_Tipo_de_Fase.Descripcion As TTWorkFlow_Tipo_de_Fase_Descripcion   from  TTWorkFlow_Tipo_de_Fase           Where TTWorkFlow_Tipo_de_Fase.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Tipo_de_Fase_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
