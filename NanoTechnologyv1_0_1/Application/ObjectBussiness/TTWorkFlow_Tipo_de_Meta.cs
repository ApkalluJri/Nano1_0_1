...
namespace TTWorkFlow_Tipo_de_MetaCS
{
    public class TTWorkFlow_Tipo_de_MetaFilters
    {
...
public class objectBussinessTTWorkFlow_Tipo_de_Meta{
    ...
    private TTWorkFlow_Tipo_de_MetaFilters[] filters; 
    ...
    public TTWorkFlow_Tipo_de_MetaFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_Tipo_de_MetaFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_Tipo_de_MetaFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_de_Meta_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Tipo_de_Meta";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_de_MetaCS.TTWorkFlow_Tipo_de_MetaFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Tipo_de_Meta", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Tipo_de_Meta";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Tipo_de_MetaCS.TTWorkFlow_Tipo_de_MetaFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Tipo_de_Meta", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Tipo_de_Meta WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Tipo_de_Meta_Clave": sortExpression = "TTWorkFlow_Tipo_de_Meta.Clave"; break;  case "TTWorkFlow_Tipo_de_Meta_Nombre": sortExpression = "TTWorkFlow_Tipo_de_Meta.Nombre"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Tipo_de_Meta.Clave, TTWorkFlow_Tipo_de_Meta.Nombre" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Tipo_de_Meta.Clave As TTWorkFlow_Tipo_de_Meta_Clave,        TTWorkFlow_Tipo_de_Meta.Nombre As TTWorkFlow_Tipo_de_Meta_Nombre ";             string fieldsForExport = " TTWorkFlow_Tipo_de_Meta.Clave As [Clave],        TTWorkFlow_Tipo_de_Meta.Nombre As [Nombre] ";             string from = " from  TTWorkFlow_Tipo_de_Meta WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Tipo_de_Meta.Clave As TTWorkFlow_Tipo_de_Meta_Clave,        TTWorkFlow_Tipo_de_Meta.Nombre As TTWorkFlow_Tipo_de_Meta_Nombre ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Tipo_de_Meta.Clave, TTWorkFlow_Tipo_de_Meta.Nombre" : Order);         string from = " from  TTWorkFlow_Tipo_de_Meta WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Tipo_de_Meta");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Tipo_de_Meta";
            if (varNombre!=null)
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Tipo_de_Meta");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Tipo_de_Meta";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Tipo_de_Meta";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_de_Meta_Clave"]);
            Nombre = ds.Tables[0].Rows[0]["TTWorkFlow_Tipo_de_Meta_Nombre"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Tipo_de_Meta";
            else
                com.CommandText="sp_GetTTWorkFlow_Tipo_de_Meta";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_de_Meta.Clave As TTWorkFlow_Tipo_de_Meta_Clave,        TTWorkFlow_Tipo_de_Meta.Nombre As TTWorkFlow_Tipo_de_Meta_Nombre   from  TTWorkFlow_Tipo_de_Meta           Where TTWorkFlow_Tipo_de_Meta.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Tipo_de_Meta.Clave As TTWorkFlow_Tipo_de_Meta_Clave,        TTWorkFlow_Tipo_de_Meta.Nombre As TTWorkFlow_Tipo_de_Meta_Nombre   from  TTWorkFlow_Tipo_de_Meta           Where TTWorkFlow_Tipo_de_Meta.Nombre = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Tipo_de_Meta_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
