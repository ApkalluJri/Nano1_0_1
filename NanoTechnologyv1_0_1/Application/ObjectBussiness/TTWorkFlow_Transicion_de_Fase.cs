...
namespace TTWorkFlow_Transicion_de_FaseCS
{
    public class TTWorkFlow_Transicion_de_FaseFilters
    {
...
public class objectBussinessTTWorkFlow_Transicion_de_Fase{
    ...
    private TTWorkFlow_Transicion_de_FaseFilters[] filters; 
    ...
    public TTWorkFlow_Transicion_de_FaseFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public TTWorkFlow_Transicion_de_FaseFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new TTWorkFlow_Transicion_de_FaseFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Transicion_de_Fase_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_TTWorkFlow_Transicion_de_Fase";
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Transicion_de_FaseCS.TTWorkFlow_Transicion_de_FaseFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("TTWorkFlow_Transicion_de_Fase", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTTWorkFlow_Transicion_de_Fase";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (TTWorkFlow_Transicion_de_FaseCS.TTWorkFlow_Transicion_de_FaseFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("TTWorkFlow_Transicion_de_Fase", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  TTWorkFlow_Transicion_de_Fase WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "TTWorkFlow_Transicion_de_Fase_Clave": sortExpression = "TTWorkFlow_Transicion_de_Fase.Clave"; break;  case "TTWorkFlow_Transicion_de_Fase_Nombre": sortExpression = "TTWorkFlow_Transicion_de_Fase.Nombre"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "TTWorkFlow_Transicion_de_Fase.Clave, TTWorkFlow_Transicion_de_Fase.Nombre" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " TTWorkFlow_Transicion_de_Fase.Clave As TTWorkFlow_Transicion_de_Fase_Clave,        TTWorkFlow_Transicion_de_Fase.Nombre As TTWorkFlow_Transicion_de_Fase_Nombre ";             string fieldsForExport = " TTWorkFlow_Transicion_de_Fase.Clave As [Clave],        TTWorkFlow_Transicion_de_Fase.Nombre As [Nombre] ";             string from = " from  TTWorkFlow_Transicion_de_Fase WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " TTWorkFlow_Transicion_de_Fase.Clave As TTWorkFlow_Transicion_de_Fase_Clave,        TTWorkFlow_Transicion_de_Fase.Nombre As TTWorkFlow_Transicion_de_Fase_Nombre ";         Order = (Order == string.Empty || Order == null ? "TTWorkFlow_Transicion_de_Fase.Clave, TTWorkFlow_Transicion_de_Fase.Nombre" : Order);         string from = " from  TTWorkFlow_Transicion_de_Fase WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("TTWorkFlow_Transicion_de_Fase");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTTWorkFlow_Transicion_de_Fase";
            if (varNombre!=null)
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("TTWorkFlow_Transicion_de_Fase");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTTWorkFlow_Transicion_de_Fase";
...
//        }else{
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTTWorkFlow_Transicion_de_Fase";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["TTWorkFlow_Transicion_de_Fase_Clave"]);
            Nombre = ds.Tables[0].Rows[0]["TTWorkFlow_Transicion_de_Fase_Nombre"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_TTWorkFlow_Transicion_de_Fase";
            else
                com.CommandText="sp_GetTTWorkFlow_Transicion_de_Fase";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Transicion_de_Fase.Clave As TTWorkFlow_Transicion_de_Fase_Clave,        TTWorkFlow_Transicion_de_Fase.Nombre As TTWorkFlow_Transicion_de_Fase_Nombre   from  TTWorkFlow_Transicion_de_Fase           Where TTWorkFlow_Transicion_de_Fase.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         TTWorkFlow_Transicion_de_Fase.Clave As TTWorkFlow_Transicion_de_Fase_Clave,        TTWorkFlow_Transicion_de_Fase.Nombre As TTWorkFlow_Transicion_de_Fase_Nombre   from  TTWorkFlow_Transicion_de_Fase           Where TTWorkFlow_Transicion_de_Fase.Nombre = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["TTWorkFlow_Transicion_de_Fase_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
