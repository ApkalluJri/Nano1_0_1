...
namespace Tipo_de_DispositivoCS
{
    public class Tipo_de_DispositivoFilters
    {
        ...
        private TTClassSpecials.FiltersTypes.String varTipo = new TTClassSpecials.FiltersTypes.String();
        public TTClassSpecials.FiltersTypes.String Tipo
        {
            get { return varTipo; }
            set { varTipo = value; }
        }
...
public class objectBussinessTipo_de_Dispositivo : IDisposable
{
    ...
    private Tipo_de_DispositivoFilters[] filters; 
    ...
    public Tipo_de_DispositivoFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Tipo_de_DispositivoFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Tipo_de_DispositivoFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Tipo_de_Dispositivo_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Tipo_de_Dispositivo";
            ...
            if (this.filters !=null)
                foreach (Tipo_de_DispositivoCS.Tipo_de_DispositivoFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Tipo_de_Dispositivo", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTipo_de_Dispositivo";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Tipo_de_DispositivoCS.Tipo_de_DispositivoFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Tipo_de_Dispositivo", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Tipo_de_Dispositivo WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Tipo_de_Dispositivo_Clave": sortExpression = "Tipo_de_Dispositivo.Clave"; break;  case "Tipo_de_Dispositivo_Tipo": sortExpression = "Tipo_de_Dispositivo.Tipo"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Tipo_de_Dispositivo.Clave, Tipo_de_Dispositivo.Tipo" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Tipo_de_Dispositivo.Clave As Tipo_de_Dispositivo_Clave,        Tipo_de_Dispositivo.Tipo As Tipo_de_Dispositivo_Tipo ";             string fieldsForExport = " Tipo_de_Dispositivo.Clave As [Clave],        Tipo_de_Dispositivo.Tipo As [Tipo] ";             string from = " from  Tipo_de_Dispositivo WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Tipo_de_Dispositivo.Clave As Tipo_de_Dispositivo_Clave,        Tipo_de_Dispositivo.Tipo As Tipo_de_Dispositivo_Tipo ";         Order = (Order == string.Empty || Order == null ? "Tipo_de_Dispositivo.Clave, Tipo_de_Dispositivo.Tipo" : Order);         string from = " from  Tipo_de_Dispositivo WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Tipo_de_Dispositivo");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTipo_de_Dispositivo";
            if (varTipo!=null)
            {
                if (varTipo != "")
                    com.Parameters.AddWithValue("@Tipo", Convierte(varTipo, ConvierteAMayusculas));
                else
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Tipo_de_Dispositivo");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTipo_de_Dispositivo";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTipo_de_Dispositivo";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Tipo_de_Dispositivo_Clave"]);
            Tipo = ds.Tables[0].Rows[0]["Tipo_de_Dispositivo_Tipo"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Tipo_de_Dispositivo";
            else
                com.CommandText="sp_GetTipo_de_Dispositivo";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Tipo_de_Dispositivo.Clave As Tipo_de_Dispositivo_Clave,        Tipo_de_Dispositivo.Tipo As Tipo_de_Dispositivo_Tipo   from  Tipo_de_Dispositivo           Where Tipo_de_Dispositivo.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    }
    public DataSet GetByKeyTipo(String Key){
        DataSet ds;
        if (Key==null){
//            //MessageBox.Show("Para poder obtener los registros debe proporcionar la llave","Obtener Empleado",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return null;
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Tipo_de_Dispositivo.Clave As Tipo_de_Dispositivo_Clave,        Tipo_de_Dispositivo.Tipo As Tipo_de_Dispositivo_Tipo   from  Tipo_de_Dispositivo           Where Tipo_de_Dispositivo.Tipo = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Tipo_de_Dispositivo_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
