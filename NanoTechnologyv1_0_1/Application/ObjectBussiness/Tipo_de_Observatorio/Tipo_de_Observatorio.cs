...
namespace Tipo_de_ObservatorioCS
{
    public class Tipo_de_ObservatorioFilters
    {
...
public class objectBussinessTipo_de_Observatorio : IDisposable
{
    ...
    private Tipo_de_ObservatorioFilters[] filters; 
    ...
    public Tipo_de_ObservatorioFilters[] Filters
    {
        get { return filters; }
        set { filters = value; }
    }
    public Tipo_de_ObservatorioFilters Filter
    {
        ///Cuando es llamada desde las relaciones de algun catalago
        set
        {
            filters = new Tipo_de_ObservatorioFilters[1];
            filters[0] = value;
        }
    }
    ...
    public Int32 SelCount()
    {
        ...
        if (swhere != "")
        {
            ...
            com.CommandText = "sp_SelAllComplete_Tipo_de_Observatorio_WithFilter";
        }else 
            com.CommandText = "sp_SelAllComplete_Tipo_de_Observatorio";
            ...
            if (this.filters !=null)
                foreach (Tipo_de_ObservatorioCS.Tipo_de_ObservatorioFilters fil in this.filters)
                {
                    String sWhereT = "";
                    sWhereT = Function.CreateQuerySelect("Tipo_de_Observatorio", fil);
                    if (sWhereT != "")
    ...
    public DataSet SelAll(Boolean ConRelaciones)
    {
        ...
        if (ConRelaciones ==true)
            ...
            com.CommandText="sp_SelAllTipo_de_Observatorio";
            ds = db.Consulta(com);
            ...
            if (this.filters !=null)
                foreach (Tipo_de_ObservatorioCS.Tipo_de_ObservatorioFilters fil in this.filters)
                {
                    ...
                    if (sWhereT != "")
                        swhere = swhere + " And "+sWhereT;
                    String sOrderByT = "";
                    sOrderByT = Function.CreateOrderBySelect("Tipo_de_Observatorio", fil);
                    if (sOrderByT != "")
                        sOrderBy = sOrderByT;
                }
        if (swhere != "")
    ...
    public int SelCount(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        string sPagingCountTemplate = @"SELECT COUNT(*) {0}";
                  string from = " from  Tipo_de_Observatorio WITH(NoLock)  " + swhere; 
    ...
    public DataSet SelAll(string sortDirection, string sortExpression, int maximumRows, int startRowIndex)
    {
        ...
        if (swhere != string.Empty)
            swhere = (!swhere.ToLower().Trim().StartsWith("where") ? " WHERE " + swhere : swhere);
                    ...
                    switch (sortExpression)             {                 case "Tipo_de_Observatorio_Clave": sortExpression = "Tipo_de_Observatorio.Clave"; break;  case "Tipo_de_Observatorio_Descripcion": sortExpression = "Tipo_de_Observatorio.Descripcion"; break;                               }              sortExpression = (sortExpression == string.Empty || sortExpression == null ? "Tipo_de_Observatorio.Clave, Tipo_de_Observatorio.Descripcion" : sortExpression);             if (sortDirection != string.Empty)                 sortDirection = (sortDirection.ToLower() == "ascending" ? "Asc" : "Desc");             string fieldsWithAlias = " Tipo_de_Observatorio.Clave As Tipo_de_Observatorio_Clave,        Tipo_de_Observatorio.Descripcion As Tipo_de_Observatorio_Descripcion ";             string fieldsForExport = " Tipo_de_Observatorio.Clave As [Clave],        Tipo_de_Observatorio.Descripcion As [Descripcion] ";             string from = " from  Tipo_de_Observatorio WITH(NoLock)  " + swhere; 
    ...
    {
        	swhere = where; 	string fieldsWithAlias = " Tipo_de_Observatorio.Clave As Tipo_de_Observatorio_Clave,        Tipo_de_Observatorio.Descripcion As Tipo_de_Observatorio_Descripcion ";         Order = (Order == string.Empty || Order == null ? "Tipo_de_Observatorio.Clave, Tipo_de_Observatorio.Descripcion" : Order);         string from = " from  Tipo_de_Observatorio WITH(NoLock)  " + swhere;
    ...
    public void Insert(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        db.BeginTransaction("Tipo_de_Observatorio");
        int? sKeyClave = -1;
        try
        {

            SqlCommand com = new SqlCommand();
            com.CommandText="sp_InsTipo_de_Observatorio";
        ...
        catch (Exception ex)
        {
            try
            {
                db.RollBackTransaction("Tipo_de_Observatorio");
            }
            catch{}
            throw ex; 
        }
    ...
    public void Update(TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
        ...
        try
        {
            ...
            SqlCommand com = new SqlCommand();
            com.CommandText="sp_UpdTipo_de_Observatorio";
...
//            varClave = sKeyClave;
    ...
    public bool Delete(int? KeyClave, TTSecurity.GlobalData UserInformation, TTDataLayerCS.DataLayerFieldsBitacora DataReference){
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandText="sp_DelTipo_de_Observatorio";
com.Parameters.AddWithValue("@Clave",KeyClave);
    ...
    private DataSet GetByKey(DataSet ds)
    {
            ...
            {
            Clave = Conversion.CambiaToShort(ds.Tables[0].Rows[0]["Tipo_de_Observatorio_Clave"]);
            Descripcion = ds.Tables[0].Rows[0]["Tipo_de_Observatorio_Descripcion"].ToString();
...
//        {
            ...
            SqlCommand com = new SqlCommand();
            if (ConRelaciones==true)
                com.CommandText="sp_GetComplete_Tipo_de_Observatorio";
            else
                com.CommandText="sp_GetTipo_de_Observatorio";
com.Parameters.AddWithValue("@Clave",KeyClave);
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Tipo_de_Observatorio.Clave As Tipo_de_Observatorio_Clave,        Tipo_de_Observatorio.Descripcion As Tipo_de_Observatorio_Descripcion   from  Tipo_de_Observatorio           Where Tipo_de_Observatorio.Clave = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
...
//        {
            TTDataLayerCS.BD db =new TTDataLayerCS.BD();
            SqlCommand com = new SqlCommand();
            com.CommandText="Select         Tipo_de_Observatorio.Clave As Tipo_de_Observatorio_Clave,        Tipo_de_Observatorio.Descripcion As Tipo_de_Observatorio_Descripcion   from  Tipo_de_Observatorio           Where Tipo_de_Observatorio.Descripcion = '" + Key + "'";
            com.CommandType=CommandType.Text;
            ds = db.Consulta(com);
            return GetByKey(ds);
        //}
    ...
    public Int32 CurrentPosicion(int? KeyClave)
    {
        ...
        {
            if (Function.FormatNumberNull(dt.Rows[i]["Tipo_de_Observatorio_Clave"]) == KeyClave)
                return i;
        }
        return -1;
    }
