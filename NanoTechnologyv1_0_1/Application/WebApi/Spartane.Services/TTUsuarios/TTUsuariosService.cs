...
namespace Spartane.Services.TTUsuarios
{
    ...
    public partial class TTUsuariosService : ITTUsuariosService
    {
        ...
        private List<Spartane.Core.Classes.TTUsuarios.TTUsuarios> _TTUsuarios;
        ...
        {
            return _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.TTUsuarios.TTUsuarios>("sp_WASelAllTTUsuarios");
        }

        public IList<Core.Classes.TTUsuarios.TTUsuarios> SelAllComplete(bool ConRelaciones)
        {
            var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.Sp_WASelallTTUsuarios_Complete>("sp_WASelAllComplete_TTUsuarios");
            return data.Select(m => new Core.Classes.TTUsuarios.TTUsuarios
            {
                ...
                ,Activo = m.Activo
                ,idGrupoUsuarios = m.idGrupoUsuarios
        ...
        public int ListaSelAllCount(string Where)
        {
            ...
            var rowCountData = _dbContext.ExecuteStoredProcedureList<Sp_WAListSelCount_TTUsuarios>("sp_WAListSelCount_TTUsuarios", padWhere);
            int rowCount = 0;
        ...
        public IList<Spartane.Core.Classes.TTUsuarios.TTUsuarios> SelAll(bool ConRelaciones, string Where, string Order)
        {
            try
            {
                ...
                var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.SpWAListSelAllTTUsuarios>("sp_WAListSelAll_TTUsuarios", padreWhere, padreOrderBy);

                return data.Select(m => new Spartane.Core.Classes.TTUsuarios.TTUsuarios
                {
                    IdUsuario = m.TTUsuarios_idUsuario,
                    ...
                    idGrupoUsuarios = m.TTUsuarios_idGrupoUsuarios,
        ...
        public Spartane.Core.Classes.TTUsuarios.TTUsuariosPagingModel ListaSelAll(int startRowIndex, int maximumRows, string Where, string Order)
        {
            ...
            var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.SpWAListSelAllTTUsuarios>("sp_WAListSelAll_TTUsuarios", padWhere, padOrder, padstartRowIndex, padmaximumRows);
        ...
        public Spartane.Core.Classes.TTUsuarios.TTUsuarios GetByKey(int? Key, bool ConRelaciones)
        {
            ...
            return _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.TTUsuarios.TTUsuarios>("sp_WAGetTTUsuarios", padreKey).SingleOrDefault();
        }
        ...
        public bool Delete(int? Key)
        {
            ...
            try
            {
                ...
                var padreResult = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.sp_WADelTTUsuarios>("sp_WADelTTUsuarios", padreKey).FirstOrDefault();
                if (padreResult != null)
        ...
        public int Insert(Spartane.Core.Classes.TTUsuarios.TTUsuarios entity)
        {
            ...
            try
            {
                ...
                if (entity.idGrupoUsuarios == null)
                    padreidGrupoUsuarios.Value = DBNull.Value;
                else
                ...
                var empEntity =
                    _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.sp_WAInsTTUsuarios>("sp_WAInsTTUsuarios" , padreNombre 
...
, padreidGrupoUsuarios 
                ...
                rta = Convert.ToInt32(empEntity.idUsuario);
        ...
        public int Update(Spartane.Core.Classes.TTUsuarios.TTUsuarios entity)
        {
            ...
            try
            {
                ...
                var empEntity =
                    _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.sp_WAUpdTTUsuarios>("sp_WAUpdTTUsuarios" , padreidUsuario  , padreNombre  , padreClave_de_Acceso  , padreContrasena  , padreActivo  , padreidGrupoUsuarios  ).FirstOrDefault();
