...
public partial class FormsSystem_TTBusinessRules_TTBusinessRules_Catalogo : TTBasePage.TTBasePage //System.Web.UI.Page
{
    ...
    protected void grvAcciones_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        else if (e.Item is Telerik.Web.UI.GridEditableItem && e.Item.IsInEditMode)
        {
            ...
            switch ((TTenumBusinessRules_ActionType)Tipo_Accion)
            {
                case TTenumBusinessRules_ActionType.SetValueToCellFromQuery:
                    ...
                    string DependienteTabla = ddlParametro1.SelectedValue.Substring(0, ddlParametro1.SelectedValue.IndexOf("."));

                    sqlQuery = new StringBuilder();
                    sqlQuery.Append("SELECT * FROM TTMetadata WHERE Identificador = 0 AND DNTID = ");
                    sqlQuery.Append(DependienteTabla);
                    sqlQuery.Append(" ORDER BY Orden ");

                    folders = Funcion.RegresaDataSet(sqlQuery.ToString());

                    dt = folders.Tables[0];

                    ddlParametro2.Items.Clear();

                    foreach (DataRow dr in dt.Rows)
                        ddlParametro2.Items.Add(new RadComboBoxItem(dr["Nombre"].ToString(), dr["DNTID"].ToString() + "." + dr["DTID"].ToString()));
        ...
        ref TTBusinessRules_RelacionAccionesTrueCS.objectBussinessTTBusinessRules_RelacionAccionesTrue objAcciones)
    {
        ...
        {
            case TTenumBusinessRules_ActionType.ExecuteWebService:
                objAcciones.Parametro1 = textBox1.Text;
                objAcciones.Parametro2 = textBox2.Text;
                objAcciones.Parametro3 = textBox3.Text;
		break;
            case TTenumBusinessRules_ActionType.SetValueFromWebService:
            case TTenumBusinessRules_ActionType.FillMultiRowFromWebService:
            case TTenumBusinessRules_ActionType.FillComboFromWebservice:
		...
		break;
            ...
            case TTenumBusinessRules_ActionType.SetValueToCellFromQuery:
                ...
                break;
            #endregion
            /*TODO: IDCODMANUAL: RESPONSABLE: Salvador García Serrano FECHA: 11/Agosto/2014*/
    ...
    protected void ddlParametro1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        RadComboBox ddlParametro1 = null;
        RadComboBox ddlParametro2 = null;
        ...
        if (comboBox1.NamingContainer is GridDataInsertItem)
        {
            ...
            ddlParametro1 = (RadComboBox)x.FindControl("ddlParametro1");
            ddlParametro2 = (RadComboBox)x.FindControl("ddlParametro2");
        }
        ...
        object tipoDeAccion = int.Parse(ddlTipoDeAccion.SelectedValue);
        ...
        ref RadComboBox comboBox5, ref RadTextBox textBox5, ref Label label5)
    {
        ...
        switch ((TTenumBusinessRules_ActionType)value)
        {
            case TTenumBusinessRules_ActionType.ExecuteWebService:
                ...
                textBox1.Visible = true; textBox2.Visible = true; textBox3.Visible = true; textBox4.Visible = false; textBox5.Visible = false;
		...
		break;
            ...
            case TTenumBusinessRules_ActionType.SetValueToCellFromQuery:
                comboBox1.Visible = true; comboBox2.Visible = true; comboBox3.Visible = false; comboBox4.Visible = false; comboBox5.Visible = false;
                textBox1.Visible = false; textBox2.Visible = false; textBox3.Visible = true; textBox4.Visible = true; textBox5.Visible = false;
                label1.Visible = true; label2.Visible = true; label3.Visible = true; label4.Visible = true; label5.Visible = false;
                break;
            #endregion
            /*TODO: IDCODMANUAL: RESPONSABLE: Salvador García Serrano FECHA: 11/Agosto/2014*/
            ...
            case TTenumBusinessRules_ActionType.ApplyStyleToMultiRow:
                comboBox1.Visible = true; comboBox2.Visible = true; comboBox3.Visible = false; comboBox4.Visible = false; comboBox5.Visible = false;
                textBox1.Visible = false; textBox2.Visible = false; textBox3.Visible = true; textBox4.Visible = false; textBox5.Visible = false;
                label1.Visible = true; label2.Visible = true; label3.Visible = true; label4.Visible = false; label5.Visible = false;
                break;
            #endregion
            /*TODO: IDCODMANUAL: RESPONSABLE: Salvador García Serrano FECHA: 06/Octubre/2014*/
            ...
            case TTenumBusinessRules_ActionType.CycleFromQueryBegin:
                comboBox1.Visible = false; comboBox2.Visible = false; comboBox3.Visible = false; comboBox4.Visible = false; comboBox5.Visible = false;
                textBox1.Visible = true; textBox2.Visible = true; textBox3.Visible = false; textBox4.Visible = false; textBox5.Visible = false;
                label1.Visible = true; label2.Visible = true; label3.Visible = false; label4.Visible = false; label5.Visible = false;
                break;
            case TTenumBusinessRules_ActionType.CycleFromQueryEnd:
                comboBox1.Visible = false; comboBox2.Visible = false; comboBox3.Visible = false; comboBox4.Visible = false; comboBox5.Visible = false;
        ...
        switch ((TTenumBusinessRules_ActionType)value)
        {
            ...
            case TTenumBusinessRules_ActionType.SetValueToCellFromQuery:
               ...
               sqlQuery = new StringBuilder();
               sqlQuery.Append("SELECT DTID, DNTID, Nombre, DependienteTabla FROM TTMetadata WHERE DependienteClave = DependienteDescripcion AND ProcesoId = (SELECT ProcesoId FROM TTMetadata WHERE DependienteTabla = (SELECT DISTINCT DNTID FROM TTMetadata WHERE ProcesoId = ");
               sqlQuery.Append(ddlProceso.SelectedValue);
               sqlQuery.Append(" )) ORDER BY Orden ");
               ...
               foreach (DataRow dr in dt.Rows)
                   comboBox1.Items.Add(new RadComboBoxItem(dr["Nombre"].ToString(), dr["DependienteTabla"].ToString() + "." + dr["DNTID"].ToString() + "." + dr["DTID"].ToString()));
               
               comboBox1.AutoPostBack = true;

               string DependienteTabla = comboBox1.Items[0].Value.Substring(0, comboBox1.Items[0].Value.IndexOf("."));
            ...
            case TTenumBusinessRules_ActionType.ShowColumnOnList:
               ...
               sqlQuery = new StringBuilder();
               sqlQuery.Append("SELECT TTmetadata.DTID, TTDNT.Nombre_Tabla+'.'+TTmetadata.Nombre AS Nombre, TTmetadata.DNTID ");
               sqlQuery.Append("FROM TTMetadata ");
               sqlQuery.Append("INNER JOIN TTDNT ON TTDNT.DNTID = TTmetadata.DNTID ");
               sqlQuery.Append("WHERE TTMetadata.ProcesoId = ");
               sqlQuery.Append(ddlProceso.SelectedValue);
                

               dt = Funcion.RegresaDataSet(sqlQuery.ToString()).Tables[0];
            ...
            case TTenumBusinessRules_ActionType.ApplyStyleToMultiRow:
               ...
               //foreach (DataRow dr in dt.Rows)
               comboBox1.Items.Add(new RadComboBoxItem("Row", "1"));
               comboBox1.Items.Add(new RadComboBoxItem("Column", "2"));
               comboBox1.Items.Add(new RadComboBoxItem("Cell", "3"));
            ...
            case TTenumBusinessRules_ActionType.SetTextModeToPassword:
               ...
               sqlQuery = new StringBuilder();
               sqlQuery.Append("SELECT DTID, DNTID, Nombre FROM TTMetadata WHERE Tipo_de_Control = 1 AND ProcesoId = ");
               sqlQuery.Append(ddlProceso.SelectedValue);
               sqlQuery.Append(" ORDER BY Orden ");
        ...
        switch ((TTenumBusinessRules_ActionType)value)
        {
            case TTenumBusinessRules_ActionType.ExecuteWebService:
                label1.Text = "URL";
                label2.Text = "Method";
                label3.Text = "Parameteres Mapping";
		break;
            case TTenumBusinessRules_ActionType.SetValueFromWebService:
                label1.Text = "Field";
                label2.Text = "URL";
                label3.Text = "Method";
                label4.Text = "Parameteres Mapping";
		break;
            case TTenumBusinessRules_ActionType.FillMultiRowFromWebService:
                label1.Text = "MultiRow";
                label2.Text = "URL";
                label3.Text = "Method";
                label4.Text = "Parameteres Mapping";
		break;
