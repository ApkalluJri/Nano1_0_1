<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="FormsSystem_TTBusinessRules_TTBusinessRules_Lista"
    Theme="SpanishLanguage" Title="Lista de Reglas de Negocio" CodeFile="TTBusinessRules_Lista.aspx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTBusinessRules_idBusinessRule" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTBusinessRulesCS.objectBussinessTTBusinessRules"
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
          <div id="horizontal_menu_div">
           ...
           <div id="btn_buscar" onclick="btn_buscarClick();" runat="server" style="visibility:hidden"><p class="btns">Buscar</p>
            </div>
