...
namespace FormsSystem.TTBusinessRules
{
public partial class FormsSystem_TTConfiguracion : System.Web.UI.Page, ICallbackEventHandler 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblTitulo.Text = "Configuración de " + Funcion.RegresaDato("select nombre from ttproceso where idproceso=" + idProceso.ToString());
            lblTitulo.DataBind();
    ...
    private void AgregaTitulos(HtmlTable tabla)
    {
        ...
        tr = new HtmlTableRow();
        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Campo"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Obligatorio"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Visible"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Solo Lectura"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Filtro Rápido"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Valor por Defecto"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);

        td = new HtmlTableCell();
        lbl = new Label(); lbl.Text = "Texto de Ayuda"; lbl.Font.Bold = true;
        td.Controls.Add(lbl);
        tr.Cells.Add(td);
        tabla.Rows.Add(tr);
    }
