<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="FormsSystem_TTFormatos_TTFormatProperty" CodeFile="TTFormatProperty.aspx.cs" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function updateFromOpener(work) {
            getRadWindow().close(work);
        }
...
<body>
    ...
    <div>
        ...
        <asp:HiddenField ID="hvValores" runat="server" />
