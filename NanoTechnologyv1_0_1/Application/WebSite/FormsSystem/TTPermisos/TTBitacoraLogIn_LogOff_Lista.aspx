<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTBitacoraLogIn_LogOff_Lista"
    Theme="SpanishLanguage" Title="Lista de TTBitacoraLogIn_LogOff" CodeFile="TTBitacoraLogIn_LogOff_Lista.aspx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTBitacoraLogIn_LogOff_Folio" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTBitacoraLogIn_LogOffCS.objectBussinessTTBitacoraLogIn_LogOff"
