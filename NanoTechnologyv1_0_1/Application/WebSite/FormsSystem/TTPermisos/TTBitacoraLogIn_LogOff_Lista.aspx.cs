...
Descripción:      Pantalla Lista TTBitacoraLogIn_LogOff
**************************************************************************************************/
using System;
using System.Data;
...
public partial class TTBitacoraLogIn_LogOff_Lista : TTBasePage.TTBasePage
{
    ...
    private TTBitacoraLogIn_LogOffCS.objectBussinessTTBitacoraLogIn_LogOff objTTBitacoraLogIn_LogOff = new TTBitacoraLogIn_LogOffCS.objectBussinessTTBitacoraLogIn_LogOff();
    private WSTTBitacoraLogIn_LogOff.GlobalData userData;
    private String sDNTNombre = "TTBitacoraLogIn_LogOff";
    private Int32 idProceso = 6400;
    ...
    { 
        ...
        colFolio.DataField = "TTBitacoraLogIn_LogOff_Folio";
        colFolio.SortExpression = "TTBitacoraLogIn_LogOff_Folio";
        ...
        colIdUsuario.DataField = "TTBitacoraLogIn_LogOff_IdUsuario";
        colIdUsuario.DataFormatString = "";
        colIdUsuario.SortExpression = "TTBitacoraLogIn_LogOff_IdUsuario";
        ...
        BoundField colFechaHora_Entrada = new BoundField();
        colFechaHora_Entrada.HeaderText = "Fecha de Entrada";
        colFechaHora_Entrada.DataField = "TTBitacoraLogIn_LogOff_FechaHora_Entrada";
        colFechaHora_Entrada.DataFormatString = "";
        colFechaHora_Entrada.SortExpression = "TTBitacoraLogIn_LogOff_FechaHora_Entrada";
        colFechaHora_Entrada.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdMov.Columns.Add(colFechaHora_Entrada);
        BoundField colFechaHora_Salida = new BoundField();
        colFechaHora_Salida.HeaderText = "Fecha de Salida";
        colFechaHora_Salida.DataField = "TTBitacoraLogIn_LogOff_FechaHora_Salida";
        colFechaHora_Salida.DataFormatString = "";
        colFechaHora_Salida.SortExpression = "TTBitacoraLogIn_LogOff_FechaHora_Salida";
        colFechaHora_Salida.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdMov.Columns.Add(colFechaHora_Salida);
        BoundField colComputerName = new BoundField();
        colComputerName.HeaderText = "ComputerName";
        colComputerName.DataField = "TTBitacoraLogIn_LogOff_ComputerName";
        colComputerName.DataFormatString = "";
        colComputerName.SortExpression = "TTBitacoraLogIn_LogOff_ComputerName";
        ...
        colServerName.DataField = "TTBitacoraLogIn_LogOff_ServerName";
        colServerName.DataFormatString = "";
        colServerName.SortExpression = "TTBitacoraLogIn_LogOff_ServerName";
        ...
        colDatabaseName.DataField = "TTBitacoraLogIn_LogOff_DatabaseName";
        colDatabaseName.DataFormatString = "";
        colDatabaseName.SortExpression = "TTBitacoraLogIn_LogOff_DatabaseName";
        ...
        colSystemName.DataField = "TTBitacoraLogIn_LogOff_SystemName";
        colSystemName.DataFormatString = "";
        colSystemName.SortExpression = "TTBitacoraLogIn_LogOff_SystemName";
        ...
        colSystemVersion.HeaderText = "Version";
        colSystemVersion.HtmlEncode = false;
        colSystemVersion.DataField = "TTBitacoraLogIn_LogOff_SystemVersion";
        colSystemVersion.SortExpression = "TTBitacoraLogIn_LogOff_SystemVersion";
        ...
        colWindowsVersion.DataField = "TTBitacoraLogIn_LogOff_WindowsVersion";
        colWindowsVersion.DataFormatString = "";
        colWindowsVersion.SortExpression = "TTBitacoraLogIn_LogOff_WindowsVersion";
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        ...
        Session["Folio"]=data.Values["TTBitacoraLogIn_LogOff_Folio"];
    ...
    protected void BtnSelect_Click(object sender, EventArgs e)
    {
        ...
        DataKey data = grdMov.DataKeys[row.RowIndex];
        Session["ClaveLista"]=data.Values["TTBitacoraLogIn_LogOff_Folio"];
    ...
    protected void IbtnBorrarSeleccion_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grdMov.Rows)
        {
            ...
            if (cb != null && cb.Checked)
            {
                ...
                try
                {
                    myTTBitacoraLogIn_LogOff.Delete(userData, MyFunctions.FormatNumberNull(Session["Folio"].ToString()));
                }
                catch (Exception ex) 
                {
    ...
    protected void GrdMov_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName=="Consult")
        {
            ...
            Response.Redirect("TTBitacoraLogIn_LogOff_Catalogo.aspx");     
        }
        ...
        { 
            int rowIndex = Convert.ToInt32(e.CommandArgument);
            DataKey data = grdMov.DataKeys[rowIndex];
            Session["Llave"]=data.Values["TTBitacoraLogIn_LogOff_Folio"];
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("TTBitacoraLogIn_LogOff_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("TTBitacoraLogIn_LogOff_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de TTBitacoraLogIn_LogOff&process="+idProceso.ToString()+"&brOperation=Export";
        rwExport.VisibleOnPageLoad = true;
        ...
        ExportWithConsoleApp(sQ, sPath, SID, TTBasePage.FileExportFormat.xls) ;

        if (File.Exists(sPath + "\\" + SID + "." + TTBasePage.FileExportFormat.xls))
        {
            //---------------------------------------------------------------------------------------------------------------
            ApplyBusinessRules(TTenumBusinessRules_Operacion.Export, TTenumBusinessRules_ProcessEvent.OpenWindows, idProceso);
            //---------------------------------------------------------------------------------------------------------------
            SID = sPath + "\\" + SID;
            DownloadFile(SID + "." + TTBasePage.FileExportFormat.xls, sDNTNombre.Replace(" ", "_") + "." + TTBasePage.FileExportFormat.xls);
        }              
        //---------------------------------------------------------------------------------------------------------------
    ...
    protected void cmdPrint_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de TTBitacoraLogIn_LogOff&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print";
        rwExport.VisibleOnPageLoad = true;
    ...
    public void Bind()
    {
        ...
        if (Session["Filter"] != null)
        {
            ...
            {
                objTTBitacoraLogIn_LogOff.MyFilters = new ControlsLibrary.objectBussinessTTFiltro[1];
                objTTBitacoraLogIn_LogOff.MyFilters[0] = myFilter;
            }
            else
                Session["Filter"] = null;
        }
        if (Session["Where"] != null && Session["NombreDNT"] != null)
            if (Session["NombreDNT"].ToString() == sDNTNombre)
                objTTBitacoraLogIn_LogOff.sWhere = Session["Where"].ToString();                 
    }
    ...
    protected void ODSGrdMov_ObjectCreating(object sender, ObjectDataSourceEventArgs e)
    {
        ...
        e.ObjectInstance = objTTBitacoraLogIn_LogOff;
    }
    ...
    protected void ODSGrdMov_OnSelected(object sender, ObjectDataSourceStatusEventArgs e)
    {
        ...
        //{
        //}
        ViewState["FullQueryExport"] = objTTBitacoraLogIn_LogOff.FullQueryForExport;
    }
