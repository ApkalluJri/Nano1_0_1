<%@ Page Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTBitacoraSQL_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de TTBitacoraSQL" CodeFile="TTBitacoraSQL_Catalogo.aspx.cs" %>
        ...
        <ContentTemplate>
            <cc1:TabContainer ID="TabControls" runat="server" ScrollBars="None">
                ...
                <table id="tbDatos_Generales" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">                    
                    ...
                    <tr id="trIdUsuario">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                            ...
                            Category="IdUsuario" PromptText="[Seleccionar un valor...]" ServicePath="http://localhost/WebServices/TTBitacoraSQLWS.asmx"
                    ...
                    <tr id="trTipoSQL">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblTipoSQL" runat="server" Text="TipoSQL: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblTipoSQL" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtTipoSQL"  Columns="50"  runat="server" Font-Names="Arial"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVTipoSQL" runat="server" ControlToValidate="TxtTipoSQL" Display="Dynamic" ErrorMessage="El campo TipoSQL debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVTipoSQL" runat="server" ControlToValidate="TxtTipoSQL" Display="Dynamic" ErrorMessage="El campo TipoSQL es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trFechaHora">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblFechaHora" runat="server" Text="FechaHora: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblFechaHora" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                    ...
                    <tr id="trSystemVersion">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblSystemVersion" runat="server" Text="Version del sistema: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              &nbsp;<asp:CompareValidator ID="CVSystemVersion" runat="server" ControlToValidate="txtSystemVersion" Display="Dynamic" Type="Double" ErrorMessage="El campo Version del sistema debe ser de tipo Númerico Decimal" Style="vertical-align: super"></asp:CompareValidator >
                              &nbsp;<asp:RequiredFieldValidator ID="RFVSystemVersion" runat="server" ControlToValidate="txtSystemVersion" Display="Dynamic" ErrorMessage="El campo Version del sistema es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trCommandSQL">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblCommandSQL" runat="server" Text="CommandSQL: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblCommandSQL" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtCommandSQL" TextMode="MultiLine" Rows="10" Columns="80" runat="server" Font-Names="Arial"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVCommandSQL" runat="server" ControlToValidate="TxtCommandSQL" Display="Dynamic" ErrorMessage="El campo CommandSQL debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVCommandSQL" runat="server" ControlToValidate="TxtCommandSQL" Display="Dynamic" ErrorMessage="El campo CommandSQL es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trFolioSQL">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblFolioSQL" runat="server" Text="FolioSQL: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblFolioSQL" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtFolioSQL" TextMode="MultiLine" Rows="2" Columns="80"  runat="server" Font-Names="Arial"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVFolioSQL" runat="server" ControlToValidate="TxtFolioSQL" Display="Dynamic" ErrorMessage="El campo FolioSQL debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVFolioSQL" runat="server" ControlToValidate="TxtFolioSQL" Display="Dynamic" ErrorMessage="El campo FolioSQL es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trProcesoID">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblProcesoID" runat="server" Text="ProcesoID: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblProcesoID" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                            <asp:DropDownList ID="ddlProcesoID" runat="server" Width="213px"  OnSelectedIndexChanged="ddlProcesoID_SelectedIndexChanged"  AutoPostBack="true" EnableViewState="true"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcProcesoID" runat="server" IdProceso="6391" />
                            &nbsp;<asp:RequiredFieldValidator ID="RFVProcesoID" runat="server" ControlToValidate="ddlProcesoID" Display="Dynamic" ErrorMessage="El campo ProcesoID es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>                            
                            
                            <%--<cc1:CascadingDropDown ID="cddProcesoID" runat="server" TargetControlID="ddlProcesoID"
                            Category="ProcesoID" PromptText="[Seleccionar un valor...]" ServicePath="http://localhost/WebServices/TTBitacoraSQLWS.asmx"
                            ServiceMethod="FillDataProcesoIDCDD" UseContextKey="true" />--%>
