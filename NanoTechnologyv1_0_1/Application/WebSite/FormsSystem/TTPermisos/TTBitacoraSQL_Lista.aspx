<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTBitacoraSQL_Lista"
    Theme="SpanishLanguage" Title="Lista de TTBitacoraSQL" CodeFile="TTBitacoraSQL_Lista.aspx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTBitacoraSQL_Folio" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTBitacoraSQLCS.objectBussinessTTBitacoraSQL"
