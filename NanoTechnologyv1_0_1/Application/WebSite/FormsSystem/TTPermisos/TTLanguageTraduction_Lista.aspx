<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTLanguageTraduction_Lista"
    Theme="SpanishLanguage" Title="Lista de TTLanguageTraduction" CodeFile="TTLanguageTraduction_Lista.aspx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTLanguageTraduction_idTraduction" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTLanguageTraductionCS.objectBussinessTTLanguageTraduction"
