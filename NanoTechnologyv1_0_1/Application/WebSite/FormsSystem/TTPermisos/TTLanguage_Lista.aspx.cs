...
Descripción:      Pantalla Lista TTLanguage
**************************************************************************************************/
using System;
using System.Data;
...
public partial class TTLanguage_Lista : TTBasePage.TTBasePage
{
    ...
    private TTLanguageCS.objectBussinessTTLanguage objTTLanguage = new TTLanguageCS.objectBussinessTTLanguage();
    private WSTTLanguage.GlobalData userData;
    private String sDNTNombre = "TTLanguage";
    private Int32 idProceso = 6834;
    ...
    { 
        ...
        grdMov.Columns.Add(im4);
                ...
                BoundField colidLanguage = new BoundField();
        colidLanguage.HeaderText = "Folio";
        colidLanguage.HtmlEncode = false;
        colidLanguage.DataField = "TTLanguage_idLanguage";
        colidLanguage.SortExpression = "TTLanguage_idLanguage";
        colidLanguage.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
        grdMov.Columns.Add(colidLanguage);        BoundField colIdioma = new BoundField();
        colIdioma.HeaderText = "Idioma";
        colIdioma.DataField = "TTLanguage_Idioma";
        colIdioma.DataFormatString = "";
        colIdioma.SortExpression = "TTLanguage_Idioma";
        colIdioma.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdMov.Columns.Add(colIdioma);
        BoundField colBandera = new BoundField();
        colBandera.HeaderText = "Bandera";
        colBandera.HtmlEncode = false;
        colBandera.DataField = "TTLanguage_Bandera";
        colBandera.SortExpression = "TTLanguage_Bandera";
        colBandera.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
        grdMov.Columns.Add(colBandera);        BoundField colAbreviatura = new BoundField();
        colAbreviatura.HeaderText = "Abreviatura";
        colAbreviatura.DataField = "TTLanguage_Abreviatura";
        colAbreviatura.DataFormatString = "";
        colAbreviatura.SortExpression = "TTLanguage_Abreviatura";
        colAbreviatura.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdMov.Columns.Add(colAbreviatura);
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        ...
        Session["idLanguage"]=data.Values["TTLanguage_idLanguage"];
    ...
    protected void BtnSelect_Click(object sender, EventArgs e)
    {
        ...
        DataKey data = grdMov.DataKeys[row.RowIndex];
        Session["ClaveLista"]=data.Values["TTLanguage_idLanguage"];
    ...
    protected void IbtnBorrarSeleccion_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grdMov.Rows)
        {
            ...
            if (cb != null && cb.Checked)
            {
                ...
                try
                {
                    myTTLanguage.Delete(userData, MyFunctions.FormatNumberNull(Session["idLanguage"].ToString()));
                }
                catch (Exception ex) 
                {
    ...
    protected void GrdMov_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName=="Consult")
        {
            ...
            Response.Redirect("TTLanguage_Catalogo.aspx");     
        }
        ...
        { 
            int rowIndex = Convert.ToInt32(e.CommandArgument);
            DataKey data = grdMov.DataKeys[rowIndex];
            Session["Llave"]=data.Values["TTLanguage_idLanguage"];
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("TTLanguage_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("TTLanguage_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de TTLanguage&process="+idProceso.ToString()+"&brOperation=Export";
        rwExport.VisibleOnPageLoad = true;
    ...
    protected void cmdPrint_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de TTLanguage&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print";
        rwExport.VisibleOnPageLoad = true;
    ...
    public void Bind()
    {
        ...
        if (Session["Filter"] != null)
        {
            ...
            {
                objTTLanguage.MyFilters = new ControlsLibrary.objectBussinessTTFiltro[1];
                objTTLanguage.MyFilters[0] = myFilter;
            }
            else
                Session["Filter"] = null;
        }
        if (Session["Where"] != null && Session["NombreDNT"] != null)
            if (Session["NombreDNT"].ToString() == sDNTNombre)
                objTTLanguage.sWhere = Session["Where"].ToString();                 
    }
    ...
    protected void ODSGrdMov_ObjectCreating(object sender, ObjectDataSourceEventArgs e)
    {
        ...
        e.ObjectInstance = objTTLanguage;
    }
    ...
    protected void ODSGrdMov_OnSelected(object sender, ObjectDataSourceStatusEventArgs e)
    {
        ...
        //{
        //}
        ViewState["FullQueryExport"] = objTTLanguage.FullQueryForExport;
    }
