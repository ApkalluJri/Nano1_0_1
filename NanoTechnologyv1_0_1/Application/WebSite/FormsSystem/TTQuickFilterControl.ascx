<%@ Control Language="C#" AutoEventWireup="true" Inherits="FormsSystem_TTQuickFilterControl" CodeFile="TTQuickFilterControl.ascx.cs" %>
...
<table id="tbl1" runat="server" style="font-family: Tahoma; font-size: small;"> 
    <tr>
        ...
        <td colspan="1" rowspan="1">
            ...
            <asp:TextBox ID="txtText" runat="server" Visible="False"></asp:TextBox><br />
            ...
            <br />
            <telerik:RadComboBox ID="lstDep" runat="server" Visible="true" OnItemsRequested="RadComboBox_OnItemsRequested">
            </telerik:RadComboBox>
