<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="FormsSystem_TTReportes_TTReportes_Lista"
    Theme="SpanishLanguage" Title="Lista de TTReportes" CodeFile="TTReportes_Lista.aspx.cs" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    DataKeyNames="TTReportes_idReporte,TTReportes_ProcesoId,TTReportes_FiltroId, TTReportes_TipoPresentacion, TTReportes_SubtipoPresentacion, TTReportes_IdGrupoReporte"
                    DataSourceID="ODSGrvMov" OnPageIndexChanging="grdMov_PageIndexChanging" OnRowCommand="GrdMov_RowCommand"
                    OnSorting="grdMov_Sorting" PagerSettings-Visible="false" OnRowCreated="grdMov_OnRowCreated">
                    <Columns>
                        ...
                        <asp:ButtonField ButtonType="Image" ImageUrl="~/images/look.png" CommandName="Consult" />
                        <asp:ButtonField ButtonType="Image" ImageUrl="~/images/edit.png" CommandName="Edit" />
                        <asp:ButtonField ButtonType="Image" ImageUrl="~/images/print.png" CommandName="Print" />
                        <asp:BoundField DataField="TTReportes_idReporte" HeaderText="Folio" SortExpression="TTReportes_idReporte" />
                        <asp:BoundField DataField="TTReportes_Nombre" HeaderText="Reporte" SortExpression="TTReportes_Nombre" />
                        <asp:BoundField DataField="TTProceso_Nombre" HeaderText="Proceso" SortExpression="TTProceso_Nombre" />
                        <asp:BoundField DataField="TTReportes_TipoPresentacion_Descripcion" HeaderText="Tipo de Presentaci�n"
                            SortExpression="TTReportes_TipoPresentacion_Descripcion" />
                        <asp:BoundField DataField="TTReportes_SubTipoPresentacion_Descripcion" HeaderText="Subtipo de Presentaci�n"
                            SortExpression="TTReportes_SubTipoPresentacion_Descripcion" />
                        <asp:BoundField DataField="TTReportes_IdGrupoReporte_Descripcion" HeaderText="Grupo de Reportes"
                            SortExpression="TTReportes_IdGrupoReporte_Descripcion" />
                    </Columns>
                ...
                <asp:ObjectDataSource ID="ODSGrvMov" runat="server" SelectMethod="SelAll" TypeName="TTReportes.objectBussinessTTReportes"
                    OnSelected="ODSGrdMov_OnSelected">
                    <SelectParameters>
