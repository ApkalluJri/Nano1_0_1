...
public partial class FormsSystem_TTReportes_TTReportes_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    private String sDNTNombre = "TTReportes";
    private Int32 idProceso = 6799;
    private TTReportes.objectBussinessTTReportes myReportes = new TTReportes.objectBussinessTTReportes(); 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitulo.Text = "Lista de TTReportes";
        lblTitulo.DataBind();
    }
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        ...
        Session["Clave"] = data.Values["TTReportes_idReporte"];
    ...
    protected void IbtnBorrarSeleccion_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in grdMov.Rows)
        {
            ...
            if (cb != null && cb.Checked)
            {
                ...
                myReportes.Delete(int.Parse(Session["Clave"].ToString()), MyUserData, new TTDataLayerCS.DataLayerFieldsBitacora("", idProceso));
            }
        }
    ...
    protected void GrdMov_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Consult")
        {
            ...
            object dataValue = data.Values["TTReportes_idReporte"];

            Session["Tipo_Transaccion"] = "Consult";
            Response.Redirect("TTReportes_Catalogo.aspx?IdReporte="+dataValue.ToString());
        }
        ...
        if (e.CommandName == "Print")
        {
            int rowIndex = Convert.ToInt32(e.CommandArgument);
            DataKey data = grdMov.DataKeys[rowIndex];
            Session["Llave"] = data.Values["TTReportes_idReporte"];
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("TTReportes_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "~/FormsSystem/TTExporta.aspx?Titulo=Lista de TTReportes&process=" + idProceso.ToString() + "&brOperation=Export";
        rwExport.VisibleOnPageLoad = true;
