<%@ Control Language="C#" AutoEventWireup="true" Inherits="TTSearchAdvancedControl" CodeFile="TTSearchAdvancedControl.ascx.cs" %>
...
<table  id="tbl1" runat="server" style="font-family: Tahoma; font-size: small;">
    ...
    <tr>
        ...
        <td colspan="1" rowspan="1">
            ...
            </asp:DropDownList><asp:TextBox ID="txtFromHour" runat="server" Visible="False"></asp:TextBox><asp:TextBox
                ID="txtToHour" runat="server" Visible="False"></asp:TextBox>
            <asp:TextBox ID="txtToDate" runat="server" Visible="False"></asp:TextBox>
            <telerik:RadDatePicker ID="radFromDate" Runat="server" Visible="false" 
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
            ...
            <br />
            <asp:Button ID="cmdDetails" runat="server" Text="Detalles" Visible="False" 
                OnClientClick="OpenDetailsWindow();" />
            <asp:Button ID="cmdClearDetails" runat="server" Text="Limpiar" Visible="False" OnClick="cmdClearDetails_Click" />&nbsp;
            <asp:ListBox ID="lstDep" runat="server" Visible="False" Height="164px" SelectionMode="Multiple"></asp:ListBox></td>
        <td>
        </td>
    </tr>
    <tr>
