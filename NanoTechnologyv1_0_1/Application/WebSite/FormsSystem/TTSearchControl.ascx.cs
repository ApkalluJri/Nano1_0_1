...
public partial class FormsSystem_TTSearchControl : System.Web.UI.UserControl
{
    ...
    private ControlsLibrary.objectBussinessTTFiltro[] FilterDetails;
    ...
    private void CreateHtmlControls(int TotalControls) 
    {
        ...
        vtxtFromNumericSearch = new TextBox[TotalControls];
        vtxtToNumericSearch = new TextBox[TotalControls];
        vtxtFromDecimalSearch = new TextBox[TotalControls];
        vtxtToDecimalSearch = new TextBox[TotalControls];
        vtxtFromMoneySearch = new TextBox[TotalControls];
        vtxtToMoneySearch = new TextBox[TotalControls];
        vtxtFromHourSearch = new TextBox[TotalControls];
        vtxtToHourSearch = new TextBox[TotalControls];
        vcbTextSearch = new DropDownList[TotalControls];
        vtxtTextSearch = new TextBox[TotalControls];
        ...
        vlstListSearch = new ListBox[TotalControls];
