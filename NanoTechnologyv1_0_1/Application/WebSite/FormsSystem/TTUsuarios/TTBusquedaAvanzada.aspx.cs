...
namespace FormsSystem.TTUsuarios
{
public partial class FormsSystem_TTBusquedaAvanzada : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            string sTitle = string.Format(MyTraductor.getMessage(53, this.Title), MyTraductor.getTextProcess(MyFunctions.FormatNumberNull(sProcessNumber).Value, MyFunctions.GenerateName(sProcessName)));
            this.Title = sTitle;
