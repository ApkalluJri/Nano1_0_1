<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTGrupo_de_Usuario_Lista"
    Theme="SpanishLanguage" Title="Lista de TTGrupo de Usuario" CodeFile="TTGrupo_de_Usuario_Lista.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTGrupo_de_Usuario_IdGrupoUsuario" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTGrupo_de_UsuarioCS.objectBussinessTTGrupo_de_Usuario"
    ...
    <div id="div" runat="server" align="center" class="confirm" style="display: none">
        <img align="absmiddle" src="../../Images/warning.jpg" />
        <asp:Label ID="lblDeleteMessage" runat="server" Text="�Est�s seguro que deseas borrar este registro?"></asp:Label>
        <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
          <div id="horizontal_menu_div">
           ...
           <div id="btn_filtrar" onclick="btn_filtrarClick();" runat="server">
                <p class="btns">
