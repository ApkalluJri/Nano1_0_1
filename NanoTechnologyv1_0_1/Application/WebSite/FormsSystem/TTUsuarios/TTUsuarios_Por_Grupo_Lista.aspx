<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/FormsSystem/MasterPageAdministracion.master"
    AutoEventWireup="true" Inherits="TTUsuarios_Por_Grupo_Lista"
    Theme="SpanishLanguage" Title="Lista de TTUsuarios_Por_Grupo" CodeFile="TTUsuarios_Por_Grupo_Lista.aspx.cs" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grdMov" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GrdMov_RowCommand" DataKeyNames="TTUsuarios_Por_Grupo_IdUsuario, TTUsuarios_Por_Grupo_IdGrupoUsuario" OnSorting="grdMov_Sorting"
                    ...
                    <asp:ObjectDataSource ID="ODSGrdMov" runat="server" SelectMethod="SelAll" OnObjectCreating="ODSGrdMov_ObjectCreating"
                        OnSelected="ODSGrdMov_OnSelected" TypeName="TTUsuarios_Por_GrupoCS.objectBussinessTTUsuarios_Por_Grupo"
