<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Estatus_de_Fase_Catalogo.aspx.cs" Inherits="WebForms.TTWorkFlow_Estatus_de_Fase_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Estatus de Fase" %>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Estatus_de_Fase_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + '}',
                dataType: 'json',
                url: 'TTWorkFlow_Estatus_de_Fase_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
