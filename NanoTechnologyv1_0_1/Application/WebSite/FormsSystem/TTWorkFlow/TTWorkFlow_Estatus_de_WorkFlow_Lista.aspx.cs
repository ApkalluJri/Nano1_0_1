...
Descripción:      Pantalla Lista TTWorkFlow_Estatus_de_WorkFlow
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class TTWorkFlow_Estatus_de_WorkFlow_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    private WSTTWorkFlow_Estatus_de_WorkFlow.objectBussinessTTWorkFlow_Estatus_de_WorkFlow myTTWorkFlow_Estatus_de_WorkFlow = new WSTTWorkFlow_Estatus_de_WorkFlow.objectBussinessTTWorkFlow_Estatus_de_WorkFlow();
    private TTWorkFlow_Estatus_de_WorkFlowCS.objectBussinessTTWorkFlow_Estatus_de_WorkFlow objTTWorkFlow_Estatus_de_WorkFlow = new TTWorkFlow_Estatus_de_WorkFlowCS.objectBussinessTTWorkFlow_Estatus_de_WorkFlow();
    private WSTTWorkFlow_Estatus_de_WorkFlow.GlobalData userData;
    const String sDNTNombre = "TTWorkFlow_Estatus_de_WorkFlow";
    const String sDNTDescripcion = "Estatus de Workflow";
    const Int32 idProceso = 15800;
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSTTWorkFlow_Estatus_de_WorkFlow.GlobalData();
        ...
        userData.Language = (WSTTWorkFlow_Estatus_de_WorkFlow.GlobalDataLanguages)MyUserData.Language;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(35832, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "TTWorkFlow_Estatus_de_WorkFlow_Clave";
        colClave.SortExpression = "TTWorkFlow_Estatus_de_WorkFlow.Clave";
	colClave.UniqueName = "TTWorkFlow_Estatus_de_WorkFlow.Clave";
        ...
        colDescripcion.HeaderText = MyTraductor.getTextDTID(35833, "Descripción");
        colDescripcion.DataField = "TTWorkFlow_Estatus_de_WorkFlow_Descripcion";
        colDescripcion.DataFormatString = "";
        colDescripcion.SortExpression = "TTWorkFlow_Estatus_de_WorkFlow.Descripcion";
        colDescripcion.UniqueName = "TTWorkFlow_Estatus_de_WorkFlow.Descripcion";
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("TTWorkFlow_Estatus_de_WorkFlow_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("TTWorkFlow_Estatus_de_WorkFlow_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Estatus de Workflow&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myTTWorkFlow_Estatus_de_WorkFlow.GetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
    ...
    public static Dictionary<string, object> GetDataAndCount(int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression,bool saveState)
    {
        ...
        try
        {
            ...
            DataSet dat = myTTWorkFlow_Estatus_de_WorkFlow.SelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

            data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
            data.Add("Count", myTTWorkFlow_Estatus_de_WorkFlow.SelCount(swhere));
    ...
    public static JsonResult Delete_Row(string Folio,int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression)
    {
        try
        {
            ...
            myTTWorkFlow_Estatus_de_WorkFlow.Delete(MyFunctions.FormatNumberNull(Folio),HttpContext.Current.Session["UserGlobalInformation"] as TTSecurity.GlobalData, dr);
    ...
    public static JsonResult Consult(string Folio)
    {
        try
        {
            ...
            return new JsonResult("TTWorkFlow_Estatus_de_WorkFlow_Catalogo.aspx", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
    ...
    public static JsonResult New(bool MenuVisible)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("TTWorkFlow_Estatus_de_WorkFlow_Catalogo.aspx?MenuVisible=false", true, null);
            else
                return new JsonResult("TTWorkFlow_Estatus_de_WorkFlow_Catalogo.aspx", true, null);
        }
        catch (Exception ex)
    ...
    public static JsonResult PrintAll(string[] Columns)
    {
        try
        {
            ...
            string swhere = new GridGenericFilterer(filterExpression).GetWhere();
            DataTable dat = myTTWorkFlow_Estatus_de_WorkFlow.SelAll( swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
            ...
            //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
            //---------------------------------------------------------------------------------------------------------------           
            return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de TTWorkFlow_Estatus_de_WorkFlow&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
    ...
    public static JsonResult Select(string Id)
    {
        try
        {
            ...
            return new JsonResult("TTWorkFlow_Estatus_de_WorkFlow_Lista.aspx", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
