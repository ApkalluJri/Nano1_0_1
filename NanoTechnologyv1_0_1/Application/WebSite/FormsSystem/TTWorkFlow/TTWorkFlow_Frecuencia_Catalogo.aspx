<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Frecuencia_Catalogo.aspx.cs" Inherits="WebForms.TTWorkFlow_Frecuencia_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Frecuencia de Meta" %>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Frecuencia_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + '}',
                dataType: 'json',
                url: 'TTWorkFlow_Frecuencia_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
