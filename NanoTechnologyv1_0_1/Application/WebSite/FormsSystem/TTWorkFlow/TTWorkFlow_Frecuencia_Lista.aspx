<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Frecuencia_Lista.aspx.cs" Inherits="WebForms.TTWorkFlow_Frecuencia_Lista"
    Theme="SpanishLanguage" Title="Lista de Frecuencia de Meta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="grid_div" style="overflow:scroll">                       
            ...
            <MasterTableView DataKeyNames="TTWorkFlow_Frecuencia_Clave" ClientDataKeyNames="TTWorkFlow_Frecuencia_Clave" CurrentResetPageIndexAction="ReportError"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" > 
                ...
                <DataBinding Location="TTWorkFlow_Frecuencia_Lista.aspx" SelectMethod="GetDataAndCount" EnableCaching="false" >
                </DataBinding>
            </ClientSettings>
            </telerik:RadGrid>                                                    
  </div>
...
function RadGrid_Command(sender, args) {
            ...
            if (command == "Delete") {
                Idelement = args.get_tableView().get_dataItems()[args.get_commandArgument()].getDataKeyValue('TTWorkFlow_Frecuencia_Clave');
                ...
                jQuery.ajax({
                    ...
                    data: '{ Id: "' + sender._clientKeyValues[args.get_commandArgument()].TTWorkFlow_Frecuencia_Clave + '"}',
                    dataType: 'json',
                    url: 'TTWorkFlow_Frecuencia_lista.aspx/Select',
                    success: successCommandRedirect
                });
            }
            else if (command == "Consult") {
                SendFolio(args, 'TTWorkFlow_Frecuencia_lista.aspx/Consult', successCommandRedirect);
            }
            else if (command == "Edit") {
                SendFolio(args, 'TTWorkFlow_Frecuencia_lista.aspx/Edit', successCommandRedirect);
            }
            else if (command == "Print") {
                SendFolio(args, 'TTWorkFlow_Frecuencia_lista.aspx/Print', successCommandPrint);
            }
            ...
            if (sender.value == "") {
                ...
                if (encontro) {
                    ...
                    jQuery.ajax({
                        ...
                        data: sdata,
                        dataType: 'json',
                        url: 'TTWorkFlow_Frecuencia_lista.aspx/GetDataAndCount',
        ...
        function confirmDeleteCallBackFn(arg) {
            ...
            if (id != 0 && arg) {
                ...
                jQuery.ajax({
                    ...
                    data: sdata,
                    dataType: 'json',
                    url: 'TTWorkFlow_Frecuencia_lista.aspx/Delete_Row',
        ...
        function successCommandRedirect(result) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Frecuencia_lista.aspx/New',
                success: successCommandRedirect
            });
        }
        function btn_todosClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_Frecuencia_lista.aspx/GetAllDataAndCount',
                success: successCommandClear
            });
        }
        ...
        function btn_imprimirClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_Frecuencia_lista.aspx/PrintAll',
