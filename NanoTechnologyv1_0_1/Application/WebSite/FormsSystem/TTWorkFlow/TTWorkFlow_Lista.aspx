<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Lista.aspx.cs" Inherits="WebForms.TTWorkFlow_Lista"
    Theme="SpanishLanguage" Title="Lista de WorkFlow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="grid_div" style="overflow:scroll">                       
            ...
            <MasterTableView DataKeyNames="TTWorkFlow_Folio" ClientDataKeyNames="TTWorkFlow_Folio" CurrentResetPageIndexAction="ReportError"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" > 
                ...
                <DataBinding Location="TTWorkFlow_Lista.aspx" SelectMethod="GetDataAndCount" EnableCaching="false" >
                </DataBinding>
            </ClientSettings>
            </telerik:RadGrid>                                                    
  </div>
...
function RadGrid_Command(sender, args) {
            ...
            if (command == "Delete") {
                Idelement = args.get_tableView().get_dataItems()[args.get_commandArgument()].getDataKeyValue('TTWorkFlow_Folio');
                ...
                jQuery.ajax({
                    ...
                    data: '{ Id: "' + sender._clientKeyValues[args.get_commandArgument()].TTWorkFlow_Folio + '"}',
                    dataType: 'json',
                    url: 'TTWorkFlow_lista.aspx/Select',
                    success: successCommandRedirect
                });
            }
            else if (command == "Consult") {
                SendFolio(args, 'TTWorkFlow_lista.aspx/Consult', successCommandRedirect);
            }
            else if (command == "Edit") {
                SendFolio(args, 'TTWorkFlow_lista.aspx/Edit', successCommandRedirect);
            }
            else if (command == "Print") {
                SendFolio(args, 'TTWorkFlow_lista.aspx/Print', successCommandPrint);
            }
            ...
            if (sender.value == "") {
                ...
                if (encontro) {
                    ...
                    jQuery.ajax({
                        ...
                        data: sdata,
                        dataType: 'json',
                        url: 'TTWorkFlow_lista.aspx/GetDataAndCount',
        ...
        function confirmDeleteCallBackFn(arg) {
            ...
            if (id != 0 && arg) {
                ...
                jQuery.ajax({
                    ...
                    data: sdata,
                    dataType: 'json',
                    url: 'TTWorkFlow_lista.aspx/Delete_Row',
        ...
        function btn_todosClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_lista.aspx/GetAllDataAndCount',
                success: successCommandClear
            });
        }
        ...
        function btn_imprimirClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_lista.aspx/PrintAll',
