...
Descripción:      Pantalla Lista TTWorkFlow
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class TTWorkFlow_Lista : TTBasePage.TTBasePage
{
    ...
    private TTWorkFlowCS.objectBussinessTTWorkFlow objTTWorkFlow = new TTWorkFlowCS.objectBussinessTTWorkFlow();
    private WSTTWorkFlow.GlobalData userData;
    const String sDNTNombre = "TTWorkFlow";
    const String sDNTDescripcion = "WorkFlow";
    const Int32 idProceso = 15799;
    ...
    { 
        ...
        colFolio.HeaderText = MyTraductor.getTextDTID(35827, "Folio");
        colFolio.HtmlEncode = false;
        colFolio.DataField = "TTWorkFlow_Folio";
        colFolio.SortExpression = "TTWorkFlow.Folio";
	colFolio.UniqueName = "TTWorkFlow.Folio";
        colFolio.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
        grdRadMov.MasterTableView.Columns.Add(colFolio);        GridBoundColumn colNombre = new GridBoundColumn();
        colNombre.HeaderText = MyTraductor.getTextDTID(35828, "Nombre");
        colNombre.DataField = "TTWorkFlow_Nombre";
        colNombre.DataFormatString = "";
        colNombre.SortExpression = "TTWorkFlow.Nombre";
        colNombre.UniqueName = "TTWorkFlow.Nombre";
        colNombre.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdRadMov.Columns.Add(colNombre);        GridBoundColumn colDescripcion = new GridBoundColumn();
        colDescripcion.HeaderText = MyTraductor.getTextDTID(35829, "Descripción");
        colDescripcion.DataField = "TTWorkFlow_Descripcion";
        colDescripcion.DataFormatString = "";
        colDescripcion.SortExpression = "TTWorkFlow.Descripcion";
        colDescripcion.UniqueName = "TTWorkFlow.Descripcion";
        colDescripcion.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdRadMov.Columns.Add(colDescripcion);        GridBoundColumn colObjetivo = new GridBoundColumn();
        colObjetivo.HeaderText = MyTraductor.getTextDTID(35830, "Objetivo");
        colObjetivo.DataField = "TTWorkFlow_Objetivo";
        colObjetivo.DataFormatString = "";
        colObjetivo.SortExpression = "TTWorkFlow.Objetivo";
        colObjetivo.UniqueName = "TTWorkFlow.Objetivo";
        colObjetivo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdRadMov.Columns.Add(colObjetivo);        GridBoundColumn colEstatus = new GridBoundColumn();
        colEstatus.HeaderText = MyTraductor.getTextDTID(35834, "Estatus");
        colEstatus.DataField = "TTWorkFlow_Estatus";
        colEstatus.DataFormatString = "";
        colEstatus.SortExpression = "TTWorkFlow.Estatus";
        colEstatus.UniqueName = "TTWorkFlow.Estatus";
        colEstatus.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        grdRadMov.Columns.Add(colEstatus);        //grdMov.Columns[9+1].HeaderStyle.CssClass = "Hide";
	...
	colEstatus_Desc.DataField = "Estatus_Descripcion";
        colEstatus_Desc.HeaderText = MyTraductor.getTextDTID(35834, "Estatus");
        colEstatus_Desc.SortExpression = "Estatus.Descripcion";
	colEstatus_Desc.UniqueName = "Estatus.Descripcion";
        colEstatus_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("TTWorkFlow_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("TTWorkFlow_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de WorkFlow&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myTTWorkFlow.GetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
    ...
    public static Dictionary<string, object> GetDataAndCount(int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression,bool saveState)
    {
        ...
        try
        {
            ...
            DataSet dat = myTTWorkFlow.SelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

            data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
            data.Add("Count", myTTWorkFlow.SelCount(swhere));
    ...
    public static JsonResult Delete_Row(string Folio,int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression)
    {
        try
        {
            ...
            myTTWorkFlow.Delete(MyFunctions.FormatNumberNull(Folio),HttpContext.Current.Session["UserGlobalInformation"] as TTSecurity.GlobalData, dr);
    ...
    public static JsonResult PrintAll(string[] Columns)
    {
        try
        {
            ...
            string swhere = new GridGenericFilterer(filterExpression).GetWhere();
            DataTable dat = myTTWorkFlow.SelAll( swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
            ...
            //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
            //---------------------------------------------------------------------------------------------------------------           
            return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de TTWorkFlow&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
