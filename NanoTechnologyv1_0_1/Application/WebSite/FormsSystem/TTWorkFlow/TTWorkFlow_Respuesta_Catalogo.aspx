<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Respuesta_Catalogo.aspx.cs" Inherits="WebForms.TTWorkFlow_Respuesta_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de TTWorkFlow Respuesta" %>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Respuesta_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + '}',
                dataType: 'json',
                url: 'TTWorkFlow_Respuesta_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
