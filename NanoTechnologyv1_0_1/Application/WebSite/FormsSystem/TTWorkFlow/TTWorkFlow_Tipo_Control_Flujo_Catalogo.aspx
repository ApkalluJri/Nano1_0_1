<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Tipo_Control_Flujo_Catalogo.aspx.cs" Inherits="WebForms.TTWorkFlow_Tipo_Control_Flujo_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Tipo de Control de Flujo" %>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Tipo_Control_Flujo_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + '}',
                dataType: 'json',
                url: 'TTWorkFlow_Tipo_Control_Flujo_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
