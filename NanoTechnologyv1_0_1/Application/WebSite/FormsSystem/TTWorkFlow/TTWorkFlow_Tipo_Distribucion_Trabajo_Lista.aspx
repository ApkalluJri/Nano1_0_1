<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Tipo_Distribucion_Trabajo_Lista.aspx.cs" Inherits="WebForms.TTWorkFlow_Tipo_Distribucion_Trabajo_Lista"
    Theme="SpanishLanguage" Title="Lista de Tipo de Distribuci�n de Trabajo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="grid_div" style="overflow:scroll">                       
            ...
            <MasterTableView DataKeyNames="TTWorkFlow_Tipo_Distribucion_Trabajo_Clave" ClientDataKeyNames="TTWorkFlow_Tipo_Distribucion_Trabajo_Clave" CurrentResetPageIndexAction="ReportError"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" > 
                ...
                <DataBinding Location="TTWorkFlow_Tipo_Distribucion_Trabajo_Lista.aspx" SelectMethod="GetDataAndCount" EnableCaching="false" >
                </DataBinding>
            </ClientSettings>
            </telerik:RadGrid>                                                    
  </div>
...
function RadGrid_Command(sender, args) {
            ...
            if (command == "Delete") {
                Idelement = args.get_tableView().get_dataItems()[args.get_commandArgument()].getDataKeyValue('TTWorkFlow_Tipo_Distribucion_Trabajo_Clave');
                ...
                jQuery.ajax({
                    ...
                    data: '{ Id: "' + sender._clientKeyValues[args.get_commandArgument()].TTWorkFlow_Tipo_Distribucion_Trabajo_Clave + '"}',
                    dataType: 'json',
                    url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/Select',
                    success: successCommandRedirect
                });
            }
            else if (command == "Consult") {
                SendFolio(args, 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/Consult', successCommandRedirect);
            }
            else if (command == "Edit") {
                SendFolio(args, 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/Edit', successCommandRedirect);
            }
            else if (command == "Print") {
                SendFolio(args, 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/Print', successCommandPrint);
            }
            ...
            if (sender.value == "") {
                ...
                if (encontro) {
                    ...
                    jQuery.ajax({
                        ...
                        data: sdata,
                        dataType: 'json',
                        url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/GetDataAndCount',
        ...
        function confirmDeleteCallBackFn(arg) {
            ...
            if (id != 0 && arg) {
                ...
                jQuery.ajax({
                    ...
                    data: sdata,
                    dataType: 'json',
                    url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/Delete_Row',
        ...
        function successCommandRedirect(result) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/New',
                success: successCommandRedirect
            });
        }
        function btn_todosClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/GetAllDataAndCount',
                success: successCommandClear
            });
        }
        ...
        function btn_imprimirClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'TTWorkFlow_Tipo_Distribucion_Trabajo_lista.aspx/PrintAll',
