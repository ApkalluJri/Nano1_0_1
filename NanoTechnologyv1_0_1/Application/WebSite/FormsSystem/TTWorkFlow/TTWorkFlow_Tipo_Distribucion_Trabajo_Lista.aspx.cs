...
Descripción:      Pantalla Lista TTWorkFlow_Tipo_Distribucion_Trabajo
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class TTWorkFlow_Tipo_Distribucion_Trabajo_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    private WSTTWorkFlow_Tipo_Distribucion_Trabajo.objectBussinessTTWorkFlow_Tipo_Distribucion_Trabajo myTTWorkFlow_Tipo_Distribucion_Trabajo = new WSTTWorkFlow_Tipo_Distribucion_Trabajo.objectBussinessTTWorkFlow_Tipo_Distribucion_Trabajo();
    private TTWorkFlow_Tipo_Distribucion_TrabajoCS.objectBussinessTTWorkFlow_Tipo_Distribucion_Trabajo objTTWorkFlow_Tipo_Distribucion_Trabajo = new TTWorkFlow_Tipo_Distribucion_TrabajoCS.objectBussinessTTWorkFlow_Tipo_Distribucion_Trabajo();
    private WSTTWorkFlow_Tipo_Distribucion_Trabajo.GlobalData userData;
    const String sDNTNombre = "TTWorkFlow_Tipo_Distribucion_Trabajo";
    const String sDNTDescripcion = "Tipo de Distribución de Trabajo";
    const Int32 idProceso = 15803;
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSTTWorkFlow_Tipo_Distribucion_Trabajo.GlobalData();
        ...
        userData.Language = (WSTTWorkFlow_Tipo_Distribucion_Trabajo.GlobalDataLanguages)MyUserData.Language;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(35842, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "TTWorkFlow_Tipo_Distribucion_Trabajo_Clave";
        colClave.SortExpression = "TTWorkFlow_Tipo_Distribucion_Trabajo.Clave";
	colClave.UniqueName = "TTWorkFlow_Tipo_Distribucion_Trabajo.Clave";
        ...
        colDescripcion.HeaderText = MyTraductor.getTextDTID(35843, "Descripción");
        colDescripcion.DataField = "TTWorkFlow_Tipo_Distribucion_Trabajo_Descripcion";
        colDescripcion.DataFormatString = "";
        colDescripcion.SortExpression = "TTWorkFlow_Tipo_Distribucion_Trabajo.Descripcion";
        colDescripcion.UniqueName = "TTWorkFlow_Tipo_Distribucion_Trabajo.Descripcion";
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("TTWorkFlow_Tipo_Distribucion_Trabajo_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("TTWorkFlow_Tipo_Distribucion_Trabajo_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Tipo de Distribución de Trabajo&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myTTWorkFlow_Tipo_Distribucion_Trabajo.GetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
    ...
    public static Dictionary<string, object> GetDataAndCount(int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression,bool saveState)
    {
        ...
        try
        {
            ...
            DataSet dat = myTTWorkFlow_Tipo_Distribucion_Trabajo.SelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

            data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
            data.Add("Count", myTTWorkFlow_Tipo_Distribucion_Trabajo.SelCount(swhere));
    ...
    public static JsonResult Delete_Row(string Folio,int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression)
    {
        try
        {
            ...
            myTTWorkFlow_Tipo_Distribucion_Trabajo.Delete(MyFunctions.FormatNumberNull(Folio),HttpContext.Current.Session["UserGlobalInformation"] as TTSecurity.GlobalData, dr);
    ...
    public static JsonResult Consult(string Folio)
    {
        try
        {
            ...
            return new JsonResult("TTWorkFlow_Tipo_Distribucion_Trabajo_Catalogo.aspx", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
    ...
    public static JsonResult New(bool MenuVisible)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("TTWorkFlow_Tipo_Distribucion_Trabajo_Catalogo.aspx?MenuVisible=false", true, null);
            else
                return new JsonResult("TTWorkFlow_Tipo_Distribucion_Trabajo_Catalogo.aspx", true, null);
        }
        catch (Exception ex)
    ...
    public static JsonResult PrintAll(string[] Columns)
    {
        try
        {
            ...
            string swhere = new GridGenericFilterer(filterExpression).GetWhere();
            DataTable dat = myTTWorkFlow_Tipo_Distribucion_Trabajo.SelAll( swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
            ...
            //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
            //---------------------------------------------------------------------------------------------------------------           
            return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de TTWorkFlow_Tipo_Distribucion_Trabajo&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
    ...
    public static JsonResult Select(string Id)
    {
        try
        {
            ...
            return new JsonResult("TTWorkFlow_Tipo_Distribucion_Trabajo_Lista.aspx", true, null);
        }
        catch (Exception ex)
        {
            return new JsonResult(null, false, ex.Message.ToString());
