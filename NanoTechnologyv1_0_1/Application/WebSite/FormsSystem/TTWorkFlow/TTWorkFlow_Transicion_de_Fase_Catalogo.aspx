<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="True" CodeFile="TTWorkFlow_Transicion_de_Fase_Catalogo.aspx.cs" Inherits="WebForms.TTWorkFlow_Transicion_de_Fase_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Transición de Fase" %>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtNombre"  Columns="50"  runat="server" Font-Names="Arial"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'TTWorkFlow_Transicion_de_Fase_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + '}',
                dataType: 'json',
                url: 'TTWorkFlow_Transicion_de_Fase_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
