...
public delegate void DelegateFillDataControlMultiEdit();
public delegate DataSet DelegateDataSetMultiEdit();
public delegate DataSet DelegateDataSetWithIntKeyMultiEdit(int key);
public delegate DataSet DelegateDataSetWithStringKeyMultiEdit(string key);

public partial class FormsSystem_TTbuttonCatalogoMultiEdit : System.Web.UI.UserControl
{
    ...
    private DelegateFillDataControlMultiEdit fillDataControlFunction;
    public DelegateFillDataControlMultiEdit FillDataControlFunction
    {
        get { return fillDataControlFunction; }
        set { fillDataControlFunction = value; }
    }

    private DelegateDataSetMultiEdit getControlDataSetFunction;
    public DelegateDataSetMultiEdit GetControlDataSetFunction
    {
        get { return getControlDataSetFunction; }
        set { getControlDataSetFunction = value; }
    }

    private DelegateDataSetWithIntKeyMultiEdit getControlDataSetFunctionWithInt;
    public DelegateDataSetWithIntKeyMultiEdit GetControlDataSetFunctionWithInt
    {
        get { return getControlDataSetFunctionWithInt; }
        set { getControlDataSetFunctionWithInt = value; }
    }

    private DelegateDataSetWithStringKeyMultiEdit getControlDataSetFunctionWithString;
    public DelegateDataSetWithStringKeyMultiEdit GetControlDataSetFunctionWithString
    {
    ...
    [Category("Controls"), TypeConverter(typeof(WebControlConverterMultiEdit))]
...
public class WebControlConverterMultiEdit : StringConverter
{
