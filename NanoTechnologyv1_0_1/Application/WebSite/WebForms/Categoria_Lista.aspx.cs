...
Descripción:      Pantalla Lista Categoria
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Categoria_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Categoria";
    const String sDNTDescripcion = "Categoría";
    const Int32 idProceso = 29983;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=29983 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSCategoria.objectBussinessCategoria myCategoria = new WSCategoria.objectBussinessCategoria();
                    WSCategoria.GlobalData userData = new WSCategoria.GlobalData();
                    ...
                    Session["Clave"] = Funcion.RegresaDato("insert into Categoria(Descripcion) values(null); select @@identity");
                ...
                Response.Redirect("Categoria_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Categoria_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Categoria_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSCategoria.GlobalData userData;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(141053, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "Categoria_Clave";
        colClave.SortExpression = "Categoria.Clave";
        colClave.UniqueName = "Categoria.Clave";
        ...
        colDescripcion.HeaderText = MyTraductor.getTextDTID(141054, "Descripción");
        colDescripcion.DataField = "Categoria_Descripcion";
        colDescripcion.DataFormatString = "";
        colDescripcion.SortExpression = "Categoria.Descripcion";
        colDescripcion.UniqueName = "Categoria.Descripcion";
        ...
        colIcono.HeaderText = MyTraductor.getTextDTID(141055, "Ícono");
        colIcono.DataField = "Categoria_Icono";
        colIcono.DataFormatString = "";
        colIcono.SortExpression = "Categoria.Icono";
        colIcono.UniqueName = "Categoria.Icono";
        ...
        colIcono.Visible = false;
	        ...
	        //colIcono_Desc.CommandName = "Categoria_Icono";
        ...
        GridBoundColumn colColor_Franja = new GridBoundColumn();
        colColor_Franja.HeaderText = MyTraductor.getTextDTID(141056, "Color Franja");
        colColor_Franja.DataField = "Categoria_Color_Franja";
        colColor_Franja.DataFormatString = "";
        colColor_Franja.SortExpression = "Categoria.Color_Franja";
        colColor_Franja.UniqueName = "Categoria.Color_Franja";
        colColor_Franja.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colColor_Franja.DataType = typeof(string);
        grdRadMov.Columns.Add(colColor_Franja);
        //grdMov.Columns[9+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[9+1].ItemStyle.CssClass = "Hide";
        colColor_Franja.HeaderStyle.CssClass = "Hide";
        colColor_Franja.ItemStyle.CssClass = "Hide";
        colColor_Franja.Visible = false;
        GridBoundColumn colColor_Franja_Desc = new GridBoundColumn();
        colColor_Franja_Desc.DataField = "Color_Franja_Descripcion";
        colColor_Franja_Desc.HeaderText = MyTraductor.getTextDTID(141056, "Color Franja");
        colColor_Franja_Desc.SortExpression = "Color_Franja.Descripcion";
        colColor_Franja_Desc.UniqueName = "Color_Franja.Descripcion";
        colColor_Franja_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colColor_Franja_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colColor_Franja_Desc);
        GridBoundColumn colImagen = new GridBoundColumn();
        colImagen.HeaderText = MyTraductor.getTextDTID(141913, "Imagen");
        colImagen.DataField = "Categoria_Imagen";
        colImagen.DataFormatString = "";
        colImagen.SortExpression = "Categoria.Imagen";
        colImagen.UniqueName = "Categoria.Imagen";
        ...
        colImagen.Visible = false;
	        ...
	        //colImagen_Desc.CommandName = "Categoria_Imagen";
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Categoria_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Categoria_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Categoría&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myCategoria.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myCategoria.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myCategoria.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myCategoria.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Categoria_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Clave"] = Funcion.RegresaDato("insert into Categoria(Descripcion) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Categoria_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Categoria_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myCategoria.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Categoria&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Categoria_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Categoria_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
