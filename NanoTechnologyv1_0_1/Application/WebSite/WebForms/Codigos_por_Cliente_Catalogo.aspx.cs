...
Descripción:      Pantalla Catalogo Codigos_por_Cliente
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Codigos_por_Cliente_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSCodigos_por_Cliente.objectBussinessCodigos_por_Cliente myCodigos_por_Cliente = new WSCodigos_por_Cliente.objectBussinessCodigos_por_Cliente();
    private WSCodigos_por_Cliente.GlobalData userData;
    public int iProcess = 30071;
    private String sDNTNombre = "Codigos_por_Cliente";
    private String sDNTDescripcion = "Códigos por Cliente";
    ...
    public List<ComboInfo> ComboInformation { get; set; }
        private List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente> myMultiDetalle_de_CodigosArray = new List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>();
...
#region CallBackAsincrono
    public void RaiseCallbackEvent(String eventargument)
    {
        ...
        {   
            ...
            updateKey = string.Empty;
                    ...
                    if (multiRenlgonName == "Detalle_de_Codigos")
        {
            WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDataDetalle_de_Codigos = myMultiDetalle_de_CodigosArray.Find(p => p.Clave == key);
             if (myDataDetalle_de_Codigos == null)
            {
                key = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count);
                myDataDetalle_de_Codigos = myMultiDetalle_de_CodigosArray.Find(p => p.Clave == key);
            }
            if (myDataDetalle_de_Codigos.Clave == null)
            {
                myDataDetalle_de_Codigos.Clave = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count);
                key = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count);
            }
            if (commandName == "Delete")
            {
                myDataDetalle_de_Codigos = myMultiDetalle_de_CodigosArray.Find(p => p.Clave == key);
                    if (myDataDetalle_de_Codigos != null)
                        myMultiDetalle_de_CodigosArray.Remove(myDataDetalle_de_Codigos);
            }
            if (commandName == "Edit")
            {
                Session["LlavePopup"] = key;
                Session["idProcesoPopup"] = "30072";
            ...
            if (commandName == "Modify")
            {
                ...
                {                    
                        ...
                        case "Observatorio":
                            {
                                myDataDetalle_de_Codigos.Observatorio = MyFunctions.FormatNumberNull(ValueData);
                                break;
                            }
                        case "Codigo":
                            {
                                myDataDetalle_de_Codigos.Codigo = ValueData;
                                break;
                            }
                        case "Estatus":
                            {
                                myDataDetalle_de_Codigos.Estatus = MyFunctions.FormatNumberNull(ValueData);
                                break;
                            }
                        case "Expiracion":
                            {
                                myDataDetalle_de_Codigos.Expiracion = MyFunctions.FormatDateNull(ValueData);
                                break;
                            }
                        case "Accesos":
                            {
                                myDataDetalle_de_Codigos.Accesos = MyFunctions.FormatNumberNull(ValueData);
                                break;
                            }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            txtFecha_de_Registro.DateInput.DisplayDateFormat = System.Configuration.ConfigurationSettings.AppSettings["FormatoFechaMostrar"].ToString();
                    ...
                    Session["myMultiDetalle_de_Codigos"] = null;
            myMultiDetalle_de_CodigosArray = new List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>();
            ...
            SetLanguage();
            SetSeguridadPorProcesoDetalle_de_Codigos();
        ...
        if (Session["myMultiDetalle_de_Codigos"] != null)
                    myMultiDetalle_de_CodigosArray = (List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>)Session["myMultiDetalle_de_Codigos"];
                ...
                switch (idProcesoPopup)
                {
                    case "30072":
                        if (Session["TipoAccionPopup"].ToString()=="1")
                            TTbcEditDetalle_de_Codigos.Catalogo_Click(Llave);
                        else
                            TTbcConsultDetalle_de_Codigos.Catalogo_Click(Llave);
                        break;
    ...
    protected void SetSeguridadPorProcesoDetalle_de_Codigos()
    {
        bool SinPermisoNuevo = true;
        grdMultiDetalle_de_Codigos.Columns[1].Visible = false; //icono editar
        grdMultiDetalle_de_Codigos.Columns[0].Visible = false; //icono borrrar
        ...
        com.Parameters.AddWithValue("@IdProceso", 30072);
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            switch (dr["IdOperacion"].ToString())
            {
                case "1": //NUEVO
                    ...
                    break;
                case "2": //MODIFICAR
                    grdMultiDetalle_de_Codigos.Columns[1].Visible = true; //icono editar
                    break;
                case "3": //BORRAR
                    grdMultiDetalle_de_Codigos.Columns[0].Visible = true; //icono borrrar
                    break;
            }
        }
        if (SinPermisoNuevo)
        {
            cmdNewDetalle_de_Codigos.Visible = false;
            TTbcNewDetalle_de_Codigos.Visible = false;
        }
        db.Dispose();
        com.Dispose();
        ds.Dispose();
    ...
    private void SetLanguage()
    {
        try
        {
            ...
            //Multirenglon grdMultiDetalle_de_Codigos
            

            grdMultiDetalle_de_Codigos.Columns[1+2].HeaderText = MyTraductor.getTextDTID(141723, grdMultiDetalle_de_Codigos.Columns[1+2].HeaderText); //Observatorio
            lblShowMultiDetalle_de_Codigos.Text = MensajeMostrar;
            grdMultiDetalle_de_Codigos.Columns[2+2].HeaderText = MyTraductor.getTextDTID(141724, grdMultiDetalle_de_Codigos.Columns[2+2].HeaderText); //Codigo
            lblShowMultiDetalle_de_Codigos.Text = MensajeMostrar;
            grdMultiDetalle_de_Codigos.Columns[3+2].HeaderText = MyTraductor.getTextDTID(141725, grdMultiDetalle_de_Codigos.Columns[3+2].HeaderText); //Estatus
            lblShowMultiDetalle_de_Codigos.Text = MensajeMostrar;
            grdMultiDetalle_de_Codigos.Columns[4+2].HeaderText = MyTraductor.getTextDTID(143361, grdMultiDetalle_de_Codigos.Columns[4+2].HeaderText); //Expiracion
            lblShowMultiDetalle_de_Codigos.Text = MensajeMostrar;
            grdMultiDetalle_de_Codigos.Columns[5+2].HeaderText = MyTraductor.getTextDTID(143362, grdMultiDetalle_de_Codigos.Columns[5+2].HeaderText); //Accesos
            lblShowMultiDetalle_de_Codigos.Text = MensajeMostrar;
    ...
    protected void DisableControls()    
    {
        ...
        grdMultiDetalle_de_Codigos.Enabled = false; 
        cmdNewDetalle_de_Codigos.Enabled = false;
    ...
    public static void EnviaDato(string commandName,string multiRenlgonName, string controlId, string Skey, string ValueData, string columName)
    {
        ...
        string updateKey;
	        List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente> myMultiDetalle_de_CodigosArray = new List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>();


	        if (HttpContext.Current.Session["myMultiDetalle_de_Codigos"] != null)
                    myMultiDetalle_de_CodigosArray = (List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>)HttpContext.Current.Session["myMultiDetalle_de_Codigos"];
	        ...
	        if (multiRenlgonName == "Detalle_de_Codigos")
        {
            if (commandName == "Add")
            {
                WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDataDetalle_de_Codigos = new WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente();
                myDataDetalle_de_Codigos.Clave = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count + 1);
                myMultiDetalle_de_CodigosArray.Add(myDataDetalle_de_Codigos);
            }


            if (commandName == "Delete")
            {
                WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDataDetalle_de_Codigos;

                //if (myMultiDetalle_de_CodigosArray.Count == 1)
                //{
                    //myDataDetalle_de_Codigos = myMultiDetalle_de_CodigosArray[rowIndex];
                    //myMultiDetalle_de_CodigosArray.Remove(myDataDetalle_de_Codigos);

                    //myDataDetalle_de_Codigos = new WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente();
                    //myDataDetalle_de_Codigos.Clave = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count + 1);
                    //myMultiDetalle_de_CodigosArray.Add(myDataDetalle_de_Codigos);
                //}
                //else
            ...
            if (commandName == "Edit")
            {
                ...
                HttpContext.Current.Session["idProcesoPopup"] = "30072";
	        ...
	        HttpContext.Current.Session["myMultiDetalle_de_Codigos"] = myMultiDetalle_de_CodigosArray;
    ...
    {
        WSCodigos_por_Cliente.objectBussinessCodigos_por_Cliente1 myDataCodigos_por_Cliente = myCodigos_por_Cliente.GetByKey(MyFunctions.FormatNumberNull(Session["Folio"].ToString()), true);
        myMultiDetalle_de_CodigosArray.Clear();
        foreach (WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente itm in myDataCodigos_por_Cliente.Detalle_de_Codigos)
            myMultiDetalle_de_CodigosArray.Add(itm);
        
        if (Session["RNmyMultiDetalle_de_Codigos"] == null)
        {
            Session["myMultiDetalle_de_Codigos"] = myMultiDetalle_de_CodigosArray;
            grdMultiDetalle_de_Codigos.DataSource = myMultiDetalle_de_CodigosArray;
            grdMultiDetalle_de_Codigos.DataBind();
        }
        else
        {
            autoPopulateDetalle_de_Codigos(Session["RNmyMultiDetalle_de_Codigos"] as object[]);
        }
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        TTbcUsuario_que_Registra.GetControlDataSetFunctionWithString = myCodigos_por_Cliente.FillDataUsuario_que_Registra;
        TTbcUsuario_que_Registra.ParentWebControl = null;
        //------------------------------------------------------------------------------------
        TTbcNewDetalle_de_Codigos.WebControl = grdMultiDetalle_de_Codigos;
        TTbcNewDetalle_de_Codigos.FillDataControlFunction = RefreshMultirenglones;
        TTbcNewDetalle_de_Codigos.ParentWebControl = null;

        TTbcEditDetalle_de_Codigos.WebControl = grdMultiDetalle_de_Codigos;
        TTbcEditDetalle_de_Codigos.FillDataControlFunction = RefreshMultirenglones;
        TTbcEditDetalle_de_Codigos.ParentWebControl = null;

        TTbcConsultDetalle_de_Codigos.WebControl = grdMultiDetalle_de_Codigos;
        TTbcConsultDetalle_de_Codigos.FillDataControlFunction = RefreshMultirenglones;
        TTbcConsultDetalle_de_Codigos.ParentWebControl = null;
        
        //-------------------------------------------------------------------------------------------------------------
        grdPagerDetalle_de_Codigos.DataGrid = grdMultiDetalle_de_Codigos;
    ...
    {
                MyFunctions.FillDataControl(ddlUsuario_que_Registra, myCodigos_por_Cliente.FillDataUsuario_que_Registra(""));

    }
    private void New()
    {
                    //myMultiDetalle_de_CodigosArray.Add(new WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente());

    }
    private void Modification()
    {
        WSCodigos_por_Cliente.objectBussinessCodigos_por_Cliente1 myDataCodigos_por_Cliente = myCodigos_por_Cliente.GetByKey(MyFunctions.FormatNumberNull(Session["Folio"].ToString()),true);
                if (myDataCodigos_por_Cliente.Folio.HasValue)
            txtFolio.Text = myDataCodigos_por_Cliente.Folio.ToString();
        if (myDataCodigos_por_Cliente.Usuario_que_Registra.HasValue)
           ddlUsuario_que_Registra.SelectedValue = myDataCodigos_por_Cliente.Usuario_que_Registra.Value.ToString().TrimEnd(' ');
        //ddlUsuario_que_Registra_SelectedIndexChanged(ddlUsuario_que_Registra, new EventArgs());
        if (myDataCodigos_por_Cliente.Fecha_de_Registro.HasValue)
            txtFecha_de_Registro.SelectedDate = myDataCodigos_por_Cliente.Fecha_de_Registro.Value;
        txtHora_de_Registro.SelectedDate = Funcion.FormatDateFromTextTime(myDataCodigos_por_Cliente.Hora_de_Registro);        txtCliente.Text = myDataCodigos_por_Cliente.Cliente;
        txtContacto.Text = myDataCodigos_por_Cliente.Contacto;
        txtCorreo.Text = myDataCodigos_por_Cliente.Correo;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 141690;
        ...
        lblFolio.Text = MyTraductor.getTextDTID(141690, lblFolio.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trFolio.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141693;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblUsuario_que_Registra.Text = MyTraductor.getTextDTID(141693, lblUsuario_que_Registra.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trUsuario_que_Registra.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141694;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblFecha_de_Registro.Text = MyTraductor.getTextDTID(141694, lblFecha_de_Registro.Text);
        ...
        dv.RowFilter = "TTMetadata_DTID = " + 141696;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblHora_de_Registro.Text = MyTraductor.getTextDTID(141696, lblHora_de_Registro.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trHora_de_Registro.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143407;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblCliente.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblCliente.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblCliente.Text = MyTraductor.getTextDTID(143407, lblCliente.Text);
        txtCliente.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtCliente.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());        
        txtCliente.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
	txtCliente.Attributes.Add("MaxLength", dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtCliente.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtCliente.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblCliente.Style["display"] = "auto";
        else
            imgOblCliente.Style["display"] = "none";
        RFVCliente.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trCliente.Style["display"] = "auto";
        else
            trCliente.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143408;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblContacto.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblContacto.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblContacto.Text = MyTraductor.getTextDTID(143408, lblContacto.Text);
        txtContacto.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtContacto.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtContacto.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtContacto.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtContacto.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblContacto.Style["display"] = "auto";
        else
            imgOblContacto.Style["display"] = "none";
        RFVContacto.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trContacto.Style["display"] = "auto";
        else
            trContacto.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143409;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblCorreo.Text = MyTraductor.getTextDTID(143409, lblCorreo.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trCorreo.Style["display"] = "none";        
        dv.RowFilter = "TTMetadata_DTID = " + 141726;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            panMultiDetalle_de_Codigos.GroupingText = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            panMultiDetalle_de_Codigos.GroupingText = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        panMultiDetalle_de_Codigos.GroupingText = MyTraductor.getTextDTID(141726, panMultiDetalle_de_Codigos.GroupingText);
        grdMultiDetalle_de_Codigos.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        cmdNewDetalle_de_Codigos.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        panMultiDetalle_de_Codigos.Visible = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString());
        if (TTbcNewDetalle_de_Codigos.Visible)
            cmdNewDetalle_de_Codigos.Visible = false;
        ...
        myFiltro[0].ProcesoId = new WSTTMetadata.Dependientes();
        myFiltro[0].ProcesoId.List = new string[1];
        myFiltro[0].ProcesoId.List[0] = "30072";
        ds_controles = new DataSet();
        ds_controles = myMetadata.SelAllwithFilters(true, myFiltro);
        dvMulti = new DataView(ds_controles.Tables[0]);
        Session["MultiMetadataDetalle_de_Codigos"] = dvMulti;
    ...
    public Boolean Insert_row()
    {
        ...
        string MultiRenglonesObligatorios="";
                Int32?[] Detalle_de_Codigos_Clave = new Int32?[myMultiDetalle_de_CodigosArray.Count];
        Int32?[] Detalle_de_Codigos_Cliente = new Int32?[myMultiDetalle_de_CodigosArray.Count];
        Int32?[] Detalle_de_Codigos_Observatorio = new Int32?[myMultiDetalle_de_CodigosArray.Count];
        String[] Detalle_de_Codigos_Codigo = new String[myMultiDetalle_de_CodigosArray.Count];
        Int32?[] Detalle_de_Codigos_Estatus = new Int32?[myMultiDetalle_de_CodigosArray.Count];
        DateTime?[] Detalle_de_Codigos_Expiracion = new DateTime?[myMultiDetalle_de_CodigosArray.Count];
        Int32?[] Detalle_de_Codigos_Accesos = new Int32?[myMultiDetalle_de_CodigosArray.Count];

        dv = (DataView)Session["MultiMetadataDetalle_de_Codigos"];
        for (int i = 0; i < myMultiDetalle_de_CodigosArray.Count; i++)
        {
            WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myMultiDetalle_de_Codigos = (WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente)myMultiDetalle_de_CodigosArray[i];
            Detalle_de_Codigos_Clave[i] = MyFunctions.FormatNumberNull(myMultiDetalle_de_Codigos.Clave);
            Detalle_de_Codigos_Cliente[i] = MyFunctions.FormatNumberNull(myMultiDetalle_de_Codigos.Cliente);
            Detalle_de_Codigos_Observatorio[i] = MyFunctions.FormatNumberNull(myMultiDetalle_de_Codigos.Observatorio);
            dv.RowFilter = "TTMetadata_DTID = " + 141723;
            if (Detalle_de_Codigos_Observatorio[i] == null && Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString())  && trDetalle_de_Codigos.Attributes["style"] != "display: none;")
                MultiRenglonesObligatorios = MultiRenglonesObligatorios + "- Campo Observatorio del renglón " + (i + 1).ToString() + " de la tabla Detalle de Códigos <br />";

            if (myMultiDetalle_de_Codigos.Codigo == null)
            {
                Detalle_de_Codigos_Codigo[i] = "";
            }
            else
            {
                Detalle_de_Codigos_Codigo[i] = myMultiDetalle_de_Codigos.Codigo;
            }
            dv.RowFilter = "TTMetadata_DTID = " + 141724;
            if (Detalle_de_Codigos_Codigo[i] == "" && Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString())  && trDetalle_de_Codigos.Attributes["style"] != "display: none;")
                MultiRenglonesObligatorios = MultiRenglonesObligatorios + "- Campo Código del renglón " + (i + 1).ToString() + " de la tabla Detalle de Códigos <br />";

            Detalle_de_Codigos_Estatus[i] = MyFunctions.FormatNumberNull(myMultiDetalle_de_Codigos.Estatus);
            dv.RowFilter = "TTMetadata_DTID = " + 141725;
            if (Detalle_de_Codigos_Estatus[i] == null && Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString())  && trDetalle_de_Codigos.Attributes["style"] != "display: none;")
                MultiRenglonesObligatorios = MultiRenglonesObligatorios + "- Campo Estatus del renglón " + (i + 1).ToString() + " de la tabla Detalle de Códigos <br />";

            Detalle_de_Codigos_Expiracion[i] = MyFunctions.FormatDateNull(myMultiDetalle_de_Codigos.Expiracion);
            dv.RowFilter = "TTMetadata_DTID = " + 143361;
            if (Detalle_de_Codigos_Expiracion[i] == null && Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString())  && trDetalle_de_Codigos.Attributes["style"] != "display: none;")
                MultiRenglonesObligatorios = MultiRenglonesObligatorios + "- Campo Expiración del renglón " + (i + 1).ToString() + " de la tabla Detalle de Códigos <br />";

            Detalle_de_Codigos_Accesos[i] = MyFunctions.FormatNumberNull(myMultiDetalle_de_Codigos.Accesos);
            dv.RowFilter = "TTMetadata_DTID = " + 143362;
            if (Detalle_de_Codigos_Accesos[i] == null && Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString())  && trDetalle_de_Codigos.Attributes["style"] != "display: none;")
                MultiRenglonesObligatorios = MultiRenglonesObligatorios + "- Campo Número de Accesos del renglón " + (i + 1).ToString() + " de la tabla Detalle de Códigos <br />";
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myCodigos_por_Cliente.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlUsuario_que_Registra.SelectedValue), txtFecha_de_Registro.SelectedDate.HasValue == false ? null : (DateTime?)Convert.ToDateTime(txtFecha_de_Registro.SelectedDate, new System.Globalization.CultureInfo(System.Configuration.ConfigurationSettings.AppSettings["CultureUS"].ToString(), true)), ( txtHora_de_Registro.SelectedDate != null ? txtHora_de_Registro.SelectedDate.Value.ToString("HH:mm:ss") :  null ), txtCliente.Text, txtContacto.Text, txtCorreo.Text, Detalle_de_Codigos_Observatorio, Detalle_de_Codigos_Codigo, Detalle_de_Codigos_Estatus, Detalle_de_Codigos_Expiracion, Detalle_de_Codigos_Accesos);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        string MultiRenglonesObligatorios="";
                for(int i = 0; i < myMultiDetalle_de_CodigosArray.Count; i++)
            if (myMultiDetalle_de_CodigosArray[i].Clave == null)
                myMultiDetalle_de_CodigosArray.Remove(myMultiDetalle_de_CodigosArray[i]);
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myCodigos_por_Cliente.Update(userData,  MyFunctions.FormatNumberNull(txtFolio.Text), MyFunctions.FormatNumberNull(ddlUsuario_que_Registra.SelectedValue), txtFecha_de_Registro.SelectedDate.HasValue == false ? null : (DateTime?)Convert.ToDateTime(txtFecha_de_Registro.SelectedDate, new System.Globalization.CultureInfo(System.Configuration.ConfigurationSettings.AppSettings["CultureUS"].ToString(), true)), ( txtHora_de_Registro.SelectedDate != null ? txtHora_de_Registro.SelectedDate.Value.ToString("HH:mm:ss") :  null ), txtCliente.Text, txtContacto.Text, txtCorreo.Text, Detalle_de_Codigos_Clave, Detalle_de_Codigos_Cliente, Detalle_de_Codigos_Observatorio, Detalle_de_Codigos_Codigo, Detalle_de_Codigos_Estatus, Detalle_de_Codigos_Expiracion, Detalle_de_Codigos_Accesos);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Codigos_por_Cliente_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Codigos_por_Cliente_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Codigos_por_Cliente_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Codigos_por_Cliente_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Codigos_por_Cliente_Lista.aspx?Fase=" + Fase, true, null);
                else
    ...
    protected void grdMultiDetalle_de_Codigos_PageIndexChanging(Object sender, GridViewPageEventArgs e)
    {
        Session["PageLoad"] = "1";
        grdMultiDetalle_de_Codigos.PageIndex = e.NewPageIndex;
        grdMultiDetalle_de_Codigos.DataBind();
    }

    protected void cmbShowDetalle_de_Codigos_SelectedIndexChanged(object sender, EventArgs e)
    {
        Session["PageLoad"] = "1";
        grdMultiDetalle_de_Codigos.PageSize = MyFunctions.FormatNumberNull((sender as DropDownList).SelectedValue).Value;
        grdMultiDetalle_de_Codigos.DataBind();
    }

    protected void grdMultiDetalle_de_Codigos_OnRowCreated(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
    ...
    protected void grdMultiDetalle_de_Codigos_RowDataBound(object sender, GridViewRowEventArgs e)
    {
      if (e.Row.RowType == DataControlRowType.DataRow)
      {
          ...
          ApplyBusinessRulesMulti(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.OpenWindows, 30072, e.Row); 
      }
    }
    

    protected void autoPopulateDetalle_de_Codigos(object[] parameters)
    {
        Session["RNmyMultiDetalle_de_Codigos"] = null;
	    ...
	    iColumnaQuery = 0;
            ...
            WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDataDetalle = new WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente();
            myDataDetalle.Clave = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count + 1);iColumnaQuery++;
            if (HttpContext.Current.Session["Tipo_Transaccion"].ToString() == "New")
                myDataDetalle.Cliente = MyFunctions.FormatNumberNull(myDataDetalle.Cliente);
            else
                myDataDetalle.Cliente = int.Parse(HttpContext.Current.Session["Folio"].ToString());
            iColumnaQuery++;
            ...
            myMultiDetalle_de_CodigosArray.Add(myDataDetalle);
        }
        grdMultiDetalle_de_Codigos.DataSource = myMultiDetalle_de_CodigosArray;
        grdMultiDetalle_de_Codigos.DataBind();
        Session["myMultiDetalle_de_Codigos"] = myMultiDetalle_de_CodigosArray;
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static JsonResult autoPopulateDetalle_de_CodigosWM(string querySQL)
        {
            int iProcess = 30071;
            HttpContext.Current.Session["RNmyMultiDetalle_de_Codigos"] = null;
            List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente> myMultiDetalle_de_CodigosArray = new List<WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente>();
            TTFunctions.Functions MyFunctions = new TTFunctions.Functions();
            myMultiDetalle_de_CodigosArray.Clear();
    ...
    protected void cmdDetalle_de_CodigosAdd_Click(object sender, EventArgs e)
    {
        Session["PageLoad"] = "1";
        WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDataDetalle_de_Codigos = new WSCodigos_por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente();
        myDataDetalle_de_Codigos.Clave = MyFunctions.FormatNumberNull(iProcess.ToString() + myMultiDetalle_de_CodigosArray.Count + 1);
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ApplyBusinessRules(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, 30072);
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        myMultiDetalle_de_CodigosArray.Add(myDataDetalle_de_Codigos);
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ApplyBusinessRules(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.AfterSave, 30072);
        //---------------------------------------------------------------------------------------------------------------------------------------------------
        grdMultiDetalle_de_Codigos.PageIndex = grdMultiDetalle_de_Codigos.PageCount;
        grdMultiDetalle_de_Codigos.DataSource = myMultiDetalle_de_CodigosArray;
        grdMultiDetalle_de_Codigos.DataBind();
        Session["ShowPageDetalle_de_Codigos"] = "1";
    }

    protected void grdPagerDetalle_de_Codigos_PageNumberChanged(object sender, TTPagers.PageNumberChangedEventArgs e)
    {
        Session["PageLoad"] = "1";
    }
