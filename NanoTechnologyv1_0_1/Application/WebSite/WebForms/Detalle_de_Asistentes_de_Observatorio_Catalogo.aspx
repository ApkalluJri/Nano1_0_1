<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx.cs" Inherits="WebForms.Detalle_de_Asistentes_de_Observatorio_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Detalle de Asistentes de Observatorio" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(143621,30353,0)"></asp:TextBox>
                    ...
                    <tr id="trObservatorio">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlObservatorio" runat="server" EnableViewState="true" onchange="EjecutaRN(143623,30353,0)"></asp:DropDownList>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                          <asp:PlaceHolder ID="phNombre2" runat="server" >
                            <asp:Panel ID="pnlNombre2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtNombre"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(143626,30353,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblNombre" runat="server" IdProceso="30351" DTId="143626" />
                              <asp:RequiredFieldValidator ID="RFVNombre" runat="server" ErrorMessage="El campo Nombre es obligatorio" ControlToValidate="TxtNombre" Display="Dynamic" >*</asp:RequiredFieldValidator>&nbsp;
                              <asp:CompareValidator ID="CVNombre" runat="server" ControlToValidate="TxtNombre" Display="Dynamic" ErrorMessage="El campo Nombre debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none"></asp:CompareValidator>
                            </asp:Panel>
                          </asp:PlaceHolder>
                    ...
                    <tr id="trRol">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                          <asp:PlaceHolder ID="phRol2" runat="server" >
                            <asp:Panel ID="pnlRol2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtRol"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(143629,30353,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblRol" runat="server" IdProceso="30352" DTId="143629" />
                              <asp:RequiredFieldValidator ID="RFVRol" runat="server" ErrorMessage="El campo Rol es obligatorio" ControlToValidate="TxtRol" Display="Dynamic" >*</asp:RequiredFieldValidator>&nbsp;
                              <asp:CompareValidator ID="CVRol" runat="server" ControlToValidate="TxtRol" Display="Dynamic" ErrorMessage="El campo Rol debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none"></asp:CompareValidator>
                            </asp:Panel>
                          </asp:PlaceHolder>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx/' + metodo,
