...
Descripción:      Pantalla Catalogo Detalle_de_Asistentes_de_Observatorio
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Asistentes_de_Observatorio_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Asistentes_de_Observatorio.objectBussinessDetalle_de_Asistentes_de_Observatorio myDetalle_de_Asistentes_de_Observatorio = new WSDetalle_de_Asistentes_de_Observatorio.objectBussinessDetalle_de_Asistentes_de_Observatorio();
    private WSDetalle_de_Asistentes_de_Observatorio.GlobalData userData;
    public int iProcess = 30353;
    private String sDNTNombre = "Detalle_de_Asistentes_de_Observatorio";
    private String sDNTDescripcion = "Detalle de Asistentes de Observatorio";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        TTbcObservatorio.ImgButton.Visible = false;
                                  ...
                                  TTblNombre.ImgButton.Enabled = false;

                                  txtRol.Enabled=false;
                                  TTblRol.ImgButton.Enabled = false;
    ...
    {
        WSDetalle_de_Asistentes_de_Observatorio.objectBussinessDetalle_de_Asistentes_de_Observatorio1 myDataDetalle_de_Asistentes_de_Observatorio = myDetalle_de_Asistentes_de_Observatorio.GetByKey(MyFunctions.FormatNumberNull(Session["Observatorio"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSDetalle_de_Asistentes_de_Observatorio.GlobalData();
        ...
        userData.Language = (WSDetalle_de_Asistentes_de_Observatorio.GlobalDataLanguages)MyUserData.Language;
        ...
        TTbcObservatorio.GetControlDataSetFunctionWithString = myDetalle_de_Asistentes_de_Observatorio.FillDataObservatorio;
        TTbcObservatorio.ParentWebControl = null;

                TTblNombre.WebControl = txtNombre;
        TTblRol.WebControl = txtRol;
    ...
    {
                MyFunctions.FillDataControl(ddlObservatorio, myDetalle_de_Asistentes_de_Observatorio.FillDataObservatorio(""));
    ...
    {
        WSDetalle_de_Asistentes_de_Observatorio.objectBussinessDetalle_de_Asistentes_de_Observatorio1 myDataDetalle_de_Asistentes_de_Observatorio = myDetalle_de_Asistentes_de_Observatorio.GetByKey(MyFunctions.FormatNumberNull(Session["Observatorio"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataDetalle_de_Asistentes_de_Observatorio.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Asistentes_de_Observatorio.Clave.ToString();
        if (myDataDetalle_de_Asistentes_de_Observatorio.Observatorio.HasValue)
           ddlObservatorio.SelectedValue = myDataDetalle_de_Asistentes_de_Observatorio.Observatorio.Value.ToString().TrimEnd(' ');
        //ddlObservatorio_SelectedIndexChanged(ddlObservatorio, new EventArgs());
        if (myDataDetalle_de_Asistentes_de_Observatorio.Nombre.HasValue)
            txtNombre.Text = myDataDetalle_de_Asistentes_de_Observatorio.Nombre.Value.ToString();
        ShowDescriptionNombre();
        if (myDataDetalle_de_Asistentes_de_Observatorio.Rol.HasValue)
            txtRol.Text = myDataDetalle_de_Asistentes_de_Observatorio.Rol.Value.ToString();
        ShowDescriptionRol();
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 143621;
        ...
        lblClave.Text = MyTraductor.getTextDTID(143621, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143623;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblObservatorio.Text = MyTraductor.getTextDTID(143623, lblObservatorio.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trObservatorio.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143626;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblNombre.Text = MyTraductor.getTextDTID(143626, lblNombre.Text);
        txtNombre.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        //lblNombre_Desc.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trNombre.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143629;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblRol.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblRol.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblRol.Text = MyTraductor.getTextDTID(143629, lblRol.Text);
        txtRol.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        //lblRol_Desc.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtRol.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtRol.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtRol.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtRol.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Asistentes_de_Observatorio.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlObservatorio.SelectedValue), MyFunctions.FormatNumberNull(txtNombre.Text), MyFunctions.FormatNumberNull(txtRol.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Asistentes_de_Observatorio.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), MyFunctions.FormatNumberNull(ddlObservatorio.SelectedValue), MyFunctions.FormatNumberNull(txtNombre.Text), MyFunctions.FormatNumberNull(txtRol.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    protected bool IsValid3PointsRelations()
    {
        ...
        //        if (RFVNombre.Enabled)
            if (!TTblNombre.RelatedValueExists())
            {
                sError += "El campo Nombre es incorrecto o no existe.</br>";
                isValid = false;
            }
//        if (RFVRol.Enabled)
            if (!TTblRol.RelatedValueExists())
            {
                sError += "El campo Rol es incorrecto o no existe.</br>";
                isValid = false;
            }
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Asistentes_de_Observatorio_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Asistentes_de_Observatorio_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Asistentes_de_Observatorio_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Asistentes_de_Observatorio_Catalogo.aspx?Fase=" + Fase, true, null);
            else
    ...
    private void ShowDescriptionNombre()
    {
        TTblNombre.FindSearch(txtNombre.Text);
    }
    private void ShowDescriptionRol()
    {
        TTblRol.FindSearch(txtRol.Text);
    }
