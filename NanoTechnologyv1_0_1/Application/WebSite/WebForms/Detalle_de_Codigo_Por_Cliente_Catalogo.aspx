<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Detalle_de_Codigo_Por_Cliente_Catalogo.aspx.cs" Inherits="WebForms.Detalle_de_Codigo_Por_Cliente_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Detalle de Codigo Por Cliente" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(141721,30072,0)"></asp:TextBox>
                    ...
                    <tr id="trCliente">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlCliente" runat="server" EnableViewState="true" onchange="EjecutaRN(141722,30072,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcCliente" runat="server" IdProceso="30071"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVCliente" runat="server" ControlToValidate="ddlCliente" Display="Dynamic" ErrorMessage="El campo Cliente es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trObservatorio">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                          <asp:PlaceHolder ID="phObservatorio2" runat="server" >
                            <asp:Panel ID="pnlObservatorio2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtObservatorio"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(141723,30072,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblObservatorio" runat="server" IdProceso="29984" DTId="141723" />
                              <asp:RequiredFieldValidator ID="RFVObservatorio" runat="server" ErrorMessage="El campo Observatorio es obligatorio" ControlToValidate="TxtObservatorio" Display="Dynamic" >*</asp:RequiredFieldValidator>&nbsp;
                              <asp:CompareValidator ID="CVObservatorio" runat="server" ControlToValidate="TxtObservatorio" Display="Dynamic" ErrorMessage="El campo Observatorio debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none"></asp:CompareValidator>
                            </asp:Panel>
                          </asp:PlaceHolder>
                    ...
                    <tr id="trCodigo">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblCodigo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtCodigo"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(141724,30072,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVCodigo" runat="server" ControlToValidate="TxtCodigo" Display="Dynamic" ErrorMessage="El campo Código debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVCodigo" runat="server" ControlToValidate="TxtCodigo" Display="Dynamic" ErrorMessage="El campo Código es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trEstatus">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                          <asp:PlaceHolder ID="phEstatus2" runat="server" >
                            <asp:Panel ID="pnlEstatus2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtEstatus"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(141725,30072,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblEstatus" runat="server" IdProceso="30070" DTId="141725" />
                              <asp:RequiredFieldValidator ID="RFVEstatus" runat="server" ErrorMessage="El campo Estatus es obligatorio" ControlToValidate="TxtEstatus" Display="Dynamic" >*</asp:RequiredFieldValidator>&nbsp;
                              <asp:CompareValidator ID="CVEstatus" runat="server" ControlToValidate="TxtEstatus" Display="Dynamic" ErrorMessage="El campo Estatus debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none"></asp:CompareValidator>
                            </asp:Panel>
                          </asp:PlaceHolder>
                    ...
                    <tr id="trExpiracion">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblExpiracion" runat="server" Text="Expiración: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblExpiracion" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                            <telerik:RadDatePicker  MinDate="01/01/1900" ID="txtExpiracion" runat="server" onkeyup="rad_keyup(this,event);" onkeydown="rad_keydown(this,event);" DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                                    <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x">
                                                    </Calendar>
                                                    <DateInput  LabelCssClass="" Width="" ClientEvents-OnLoad="RadDate_Load" DTid="143361" idProceso="30072"
                            ...
                            &nbsp;<asp:RequiredFieldValidator ID="RFVExpiracion" runat="server" ControlToValidate="TxtExpiracion" Display="Dynamic" ErrorMessage="El campo Expiración es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trAccesos">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblAccesos" runat="server" Text="Número de Accesos: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblAccesos" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtAccesos" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(143362,30072,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVAccesos" runat="server" ControlToValidate="TxtAccesos" Display="Dynamic" ErrorMessage="El campo Número de Accesos debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVAccesos" runat="server" ErrorMessage="El campo Número de Accesos es obligatorio" ControlToValidate="TxtAccesos" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Codigo_Por_Cliente_Catalogo.aspx/' + metodo,
