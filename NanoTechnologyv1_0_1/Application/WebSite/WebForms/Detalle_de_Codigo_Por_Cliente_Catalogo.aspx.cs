...
Descripción:      Pantalla Catalogo Detalle_de_Codigo_Por_Cliente
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Codigo_Por_Cliente_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Codigo_Por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente myDetalle_de_Codigo_Por_Cliente = new WSDetalle_de_Codigo_Por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente();
    private WSDetalle_de_Codigo_Por_Cliente.GlobalData userData;
    public int iProcess = 30072;
    private String sDNTNombre = "Detalle_de_Codigo_Por_Cliente";
    private String sDNTDescripcion = "Detalle de Codigo Por Cliente";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        TTbcCliente.ImgButton.Visible = false;
    ...
    {
        WSDetalle_de_Codigo_Por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente1 myDataDetalle_de_Codigo_Por_Cliente = myDetalle_de_Codigo_Por_Cliente.GetByKey(MyFunctions.FormatNumberNull(Session["Cliente"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSDetalle_de_Codigo_Por_Cliente.GlobalData();
        ...
        userData.Language = (WSDetalle_de_Codigo_Por_Cliente.GlobalDataLanguages)MyUserData.Language;
        ...
        //-------------------------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------
        TTbcCliente.WebControl = ddlCliente;
        TTbcCliente.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcCliente.GetControlDataSetFunctionWithString = myDetalle_de_Codigo_Por_Cliente.FillDataCliente;
        TTbcCliente.ParentWebControl = null;
    ...
    {
                MyFunctions.FillDataControl(ddlCliente, myDetalle_de_Codigo_Por_Cliente.FillDataCliente(""));
    ...
    {
        WSDetalle_de_Codigo_Por_Cliente.objectBussinessDetalle_de_Codigo_Por_Cliente1 myDataDetalle_de_Codigo_Por_Cliente = myDetalle_de_Codigo_Por_Cliente.GetByKey(MyFunctions.FormatNumberNull(Session["Cliente"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataDetalle_de_Codigo_Por_Cliente.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Codigo_Por_Cliente.Clave.ToString();
        if (myDataDetalle_de_Codigo_Por_Cliente.Cliente.HasValue)
           ddlCliente.SelectedValue = myDataDetalle_de_Codigo_Por_Cliente.Cliente.Value.ToString().TrimEnd(' ');
        //ddlCliente_SelectedIndexChanged(ddlCliente, new EventArgs());
        if (myDataDetalle_de_Codigo_Por_Cliente.Observatorio.HasValue)
            txtObservatorio.Text = myDataDetalle_de_Codigo_Por_Cliente.Observatorio.Value.ToString();
        ShowDescriptionObservatorio();
        txtCodigo.Text = myDataDetalle_de_Codigo_Por_Cliente.Codigo;
        if (myDataDetalle_de_Codigo_Por_Cliente.Estatus.HasValue)
            txtEstatus.Text = myDataDetalle_de_Codigo_Por_Cliente.Estatus.Value.ToString();
        ShowDescriptionEstatus();
        if (myDataDetalle_de_Codigo_Por_Cliente.Expiracion.HasValue)
            txtExpiracion.SelectedDate = myDataDetalle_de_Codigo_Por_Cliente.Expiracion.Value;
        if (myDataDetalle_de_Codigo_Por_Cliente.Accesos.HasValue)
            txtAccesos.Text = myDataDetalle_de_Codigo_Por_Cliente.Accesos.ToString();
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 141721;
        ...
        lblClave.Text = MyTraductor.getTextDTID(141721, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141722;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblCliente.Text = MyTraductor.getTextDTID(141722, lblCliente.Text);
        ddlCliente.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ddlCliente.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        TTbcCliente.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                {
                    ddlCliente.SelectedValue = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                }
                else
                {
                    ddlCliente.SelectedValue = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                }
            }
            else
            {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trCliente.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141723;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblObservatorio.Text = MyTraductor.getTextDTID(141723, lblObservatorio.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trObservatorio.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141724;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblCodigo.Text = MyTraductor.getTextDTID(141724, lblCodigo.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trCodigo.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141725;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblEstatus.Text = MyTraductor.getTextDTID(141725, lblEstatus.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trEstatus.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143361;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblExpiracion.Text = MyTraductor.getTextDTID(143361, lblExpiracion.Text);
        ...
        lblAccesos.Text = MyTraductor.getTextDTID(143362, lblAccesos.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Codigo_Por_Cliente.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlCliente.SelectedValue), MyFunctions.FormatNumberNull(txtObservatorio.Text), txtCodigo.Text, MyFunctions.FormatNumberNull(txtEstatus.Text), txtExpiracion.SelectedDate.HasValue == false ? null : (DateTime?)Convert.ToDateTime(txtExpiracion.SelectedDate, new System.Globalization.CultureInfo(System.Configuration.ConfigurationSettings.AppSettings["CultureUS"].ToString(), true)), MyFunctions.FormatNumberNull(txtAccesos.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Codigo_Por_Cliente.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), MyFunctions.FormatNumberNull(ddlCliente.SelectedValue), MyFunctions.FormatNumberNull(txtObservatorio.Text), txtCodigo.Text, MyFunctions.FormatNumberNull(txtEstatus.Text), txtExpiracion.SelectedDate.HasValue == false ? null : (DateTime?)Convert.ToDateTime(txtExpiracion.SelectedDate, new System.Globalization.CultureInfo(System.Configuration.ConfigurationSettings.AppSettings["CultureUS"].ToString(), true)), MyFunctions.FormatNumberNull(txtAccesos.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Codigo_Por_Cliente_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Codigo_Por_Cliente_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Codigo_Por_Cliente_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Codigo_Por_Cliente_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Codigo_Por_Cliente_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Codigo_Por_Cliente_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Codigo_Por_Cliente_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Codigo_Por_Cliente_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Codigo_Por_Cliente_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Codigo_Por_Cliente_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Codigo_Por_Cliente_Catalogo.aspx?Fase=" + Fase, true, null);
            else
