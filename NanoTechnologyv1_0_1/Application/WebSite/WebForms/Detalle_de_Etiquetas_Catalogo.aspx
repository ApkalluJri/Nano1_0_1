<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Detalle_de_Etiquetas_Catalogo.aspx.cs" Inherits="WebForms.Detalle_de_Etiquetas_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Detalle de Etiquetas" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Detalle_de_Etiquetas_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Detalle_de_Etiquetas_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" ScrollBars="None" CssClass="rad_tab_strip_tabs_controls" > 
                ...
                <table id="tbDatos_Generales" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">                    
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(141075,29989,0)"></asp:TextBox>
                    ...
                    <tr id="trArticulo">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblArticulo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlArticulo" runat="server" EnableViewState="true" onchange="EjecutaRN(141076,29989,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcArticulo" runat="server" IdProceso="29982"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVArticulo" runat="server" ControlToValidate="ddlArticulo" Display="Dynamic" ErrorMessage="El campo Artículo es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trEtiqueta">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblEtiqueta" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                          <asp:PlaceHolder ID="phEtiqueta2" runat="server" >
                            <asp:Panel ID="pnlEtiqueta2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtEtiqueta"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(141077,29989,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblEtiqueta" runat="server" IdProceso="29988" DTId="141077" />
                              <asp:RequiredFieldValidator ID="RFVEtiqueta" runat="server" ErrorMessage="El campo Etiqueta es obligatorio" ControlToValidate="TxtEtiqueta" Display="Dynamic" >*</asp:RequiredFieldValidator>&nbsp;
                              <asp:CompareValidator ID="CVEtiqueta" runat="server" ControlToValidate="TxtEtiqueta" Display="Dynamic" ErrorMessage="El campo Etiqueta debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none"></asp:CompareValidator>
                            </asp:Panel>
                          </asp:PlaceHolder>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Detalle_de_Etiquetas_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Detalle_de_Etiquetas_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Etiquetas_Catalogo.aspx/' + metodo,
