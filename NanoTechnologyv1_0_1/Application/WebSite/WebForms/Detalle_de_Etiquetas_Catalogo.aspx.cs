...
Descripción:      Pantalla Catalogo Detalle_de_Etiquetas
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Etiquetas_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Etiquetas.objectBussinessDetalle_de_Etiquetas myDetalle_de_Etiquetas = new WSDetalle_de_Etiquetas.objectBussinessDetalle_de_Etiquetas();
    private WSDetalle_de_Etiquetas.GlobalData userData;
    public int iProcess = 29989;
    private String sDNTNombre = "Detalle_de_Etiquetas";
    private String sDNTDescripcion = "Detalle de Etiquetas";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        TTbcArticulo.ImgButton.Visible = false;

                                  txtEtiqueta.Enabled=false;
                                  TTblEtiqueta.ImgButton.Enabled = false;
    ...
    {
        WSDetalle_de_Etiquetas.objectBussinessDetalle_de_Etiquetas1 myDataDetalle_de_Etiquetas = myDetalle_de_Etiquetas.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Articulo"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSDetalle_de_Etiquetas.GlobalData();
        ...
        userData.Language = (WSDetalle_de_Etiquetas.GlobalDataLanguages)MyUserData.Language;
        ...
        //-------------------------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------
        TTbcArticulo.WebControl = ddlArticulo;
        TTbcArticulo.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcArticulo.GetControlDataSetFunctionWithString = myDetalle_de_Etiquetas.FillDataArticulo;
        TTbcArticulo.ParentWebControl = null;

                TTblEtiqueta.WebControl = txtEtiqueta;
    ...
    {
                MyFunctions.FillDataControl(ddlArticulo, myDetalle_de_Etiquetas.FillDataArticulo(""));
    ...
    {
        WSDetalle_de_Etiquetas.objectBussinessDetalle_de_Etiquetas1 myDataDetalle_de_Etiquetas = myDetalle_de_Etiquetas.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Articulo"].ToString()),true);
                if (myDataDetalle_de_Etiquetas.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Etiquetas.Clave.ToString();
        if (myDataDetalle_de_Etiquetas.Articulo.HasValue)
           ddlArticulo.SelectedValue = myDataDetalle_de_Etiquetas.Articulo.Value.ToString().TrimEnd(' ');
        //ddlArticulo_SelectedIndexChanged(ddlArticulo, new EventArgs());
        if (myDataDetalle_de_Etiquetas.Etiqueta.HasValue)
            txtEtiqueta.Text = myDataDetalle_de_Etiquetas.Etiqueta.Value.ToString();
        ShowDescriptionEtiqueta();
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 141075;
        ...
        lblClave.Text = MyTraductor.getTextDTID(141075, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141076;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblArticulo.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblArticulo.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblArticulo.Text = MyTraductor.getTextDTID(141076, lblArticulo.Text);
        ddlArticulo.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ddlArticulo.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        TTbcArticulo.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                {
                    ddlArticulo.SelectedValue = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                }
                else
                {
                    ddlArticulo.SelectedValue = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                }
            }
            else
            {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblArticulo.Style["display"] = "auto";
        else
            imgOblArticulo.Style["display"] = "none";
        RFVArticulo.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trArticulo.Style["display"] = "auto";
        else
            trArticulo.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141077;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblEtiqueta.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblEtiqueta.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblEtiqueta.Text = MyTraductor.getTextDTID(141077, lblEtiqueta.Text);
        txtEtiqueta.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        //lblEtiqueta_Desc.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtEtiqueta.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtEtiqueta.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtEtiqueta.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtEtiqueta.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        ShowDescriptionEtiqueta();
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblEtiqueta.Style["display"] = "auto";
        else
            imgOblEtiqueta.Style["display"] = "none";
        RFVEtiqueta.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trEtiqueta.Style["display"] = "auto";
        else
            trEtiqueta.Style["display"] = "none";
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Etiquetas.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlArticulo.SelectedValue), MyFunctions.FormatNumberNull(txtEtiqueta.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Etiquetas.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), MyFunctions.FormatNumberNull(ddlArticulo.SelectedValue), MyFunctions.FormatNumberNull(txtEtiqueta.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    protected bool IsValid3PointsRelations()
    {
        ...
        //        if (RFVEtiqueta.Enabled)
            if (!TTblEtiqueta.RelatedValueExists())
            {
                sError += "El campo Etiqueta es incorrecto o no existe.</br>";
                isValid = false;
            }
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Etiquetas_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Etiquetas_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Etiquetas_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Etiquetas_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Etiquetas_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Etiquetas_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Etiquetas_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Etiquetas_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Etiquetas_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Etiquetas_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Etiquetas_Catalogo.aspx?Fase=" + Fase, true, null);
            else
    ...
    /*public void ddlArticulo_SelectedIndexChanged(object sender, EventArgs e)
    {
    }*/
    private void ShowDescriptionEtiqueta()
    {
        TTblEtiqueta.FindSearch(txtEtiqueta.Text);
    }
