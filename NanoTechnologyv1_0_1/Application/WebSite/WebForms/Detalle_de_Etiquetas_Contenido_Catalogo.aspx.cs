...
Descripción:      Pantalla Catalogo Detalle_de_Etiquetas_Contenido
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Etiquetas_Contenido_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Etiquetas_Contenido.objectBussinessDetalle_de_Etiquetas_Contenido myDetalle_de_Etiquetas_Contenido = new WSDetalle_de_Etiquetas_Contenido.objectBussinessDetalle_de_Etiquetas_Contenido();
    private WSDetalle_de_Etiquetas_Contenido.GlobalData userData;
    public int iProcess = 30049;
    private String sDNTNombre = "Detalle_de_Etiquetas_Contenido";
    private String sDNTDescripcion = "NO VALIDO";
...
#region CallBackAsincrono
    ...
    {
        WSDetalle_de_Etiquetas_Contenido.objectBussinessDetalle_de_Etiquetas_Contenido1 myDataDetalle_de_Etiquetas_Contenido = myDetalle_de_Etiquetas_Contenido.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    {
        WSDetalle_de_Etiquetas_Contenido.objectBussinessDetalle_de_Etiquetas_Contenido1 myDataDetalle_de_Etiquetas_Contenido = myDetalle_de_Etiquetas_Contenido.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataDetalle_de_Etiquetas_Contenido.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Etiquetas_Contenido.Clave.ToString();
        txtDescripcion.Text = myDataDetalle_de_Etiquetas_Contenido.Descripcion;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 143368;
        ...
        lblClave.Text = MyTraductor.getTextDTID(143368, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143369;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblDescripcion.Text = MyTraductor.getTextDTID(143369, lblDescripcion.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Etiquetas_Contenido.InsertWithReturnValue(userData,  txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Etiquetas_Contenido.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Etiquetas_Contenido_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Etiquetas_Contenido_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Etiquetas_Contenido_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Etiquetas_Contenido_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Etiquetas_Contenido_Lista.aspx?Fase=" + Fase, true, null);
                else
