<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx.cs" Inherits="WebForms.Detalle_de_Notificacion_por_Observatorio_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Detalle de Notificación por Observatorio" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(149687,31010,0)"></asp:TextBox>
                    ...
                    <tr id="trContenido">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlContenido" runat="server" EnableViewState="true" onchange="EjecutaRN(149688,31010,0)"></asp:DropDownList>
                    ...
                    <tr id="trNotificar">
                        ...
                        <asp:PlaceHolder ID="phNotificar2" runat="server">
                          <asp:Panel ID="PnlNotificar2" runat="server" Height="100%" Width="100%">
                            <asp:CheckBox ID="ChNotificar" runat="server" onclick="EjecutaRN(149689,31010,0)"/>               
                          </asp:Panel>
                        </asp:PlaceHolder>
                               </td>                               
                             </tr>
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                          ...
                          <asp:PlaceHolder ID="phObservatorio2" runat="server" >
                            <asp:Panel ID="pnlObservatorio2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtObservatorio"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(149690,31010,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblObservatorio" runat="server" IdProceso="29984" DTId="149690" />
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx/' + metodo,
