...
Descripción:      Pantalla Catalogo Detalle_de_Notificacion_por_Observatorio
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Notificacion_por_Observatorio_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Notificacion_por_Observatorio.objectBussinessDetalle_de_Notificacion_por_Observatorio myDetalle_de_Notificacion_por_Observatorio = new WSDetalle_de_Notificacion_por_Observatorio.objectBussinessDetalle_de_Notificacion_por_Observatorio();
    private WSDetalle_de_Notificacion_por_Observatorio.GlobalData userData;
    public int iProcess = 31010;
    private String sDNTNombre = "Detalle_de_Notificacion_por_Observatorio";
    private String sDNTDescripcion = "Detalle de Notificación por Observatorio";
...
#region CallBackAsincrono
    ...
    {
        WSDetalle_de_Notificacion_por_Observatorio.objectBussinessDetalle_de_Notificacion_por_Observatorio1 myDataDetalle_de_Notificacion_por_Observatorio = myDetalle_de_Notificacion_por_Observatorio.GetByKey(MyFunctions.FormatNumberNull(Session["Contenido"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSDetalle_de_Notificacion_por_Observatorio.GlobalData();
        ...
        userData.Language = (WSDetalle_de_Notificacion_por_Observatorio.GlobalDataLanguages)MyUserData.Language;
        ...
        TTbcContenido.GetControlDataSetFunctionWithString = myDetalle_de_Notificacion_por_Observatorio.FillDataContenido;
    ...
    {
                MyFunctions.FillDataControl(ddlContenido, myDetalle_de_Notificacion_por_Observatorio.FillDataContenido(""));
    ...
    {
        WSDetalle_de_Notificacion_por_Observatorio.objectBussinessDetalle_de_Notificacion_por_Observatorio1 myDataDetalle_de_Notificacion_por_Observatorio = myDetalle_de_Notificacion_por_Observatorio.GetByKey(MyFunctions.FormatNumberNull(Session["Contenido"].ToString()), MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataDetalle_de_Notificacion_por_Observatorio.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Notificacion_por_Observatorio.Clave.ToString();
        if (myDataDetalle_de_Notificacion_por_Observatorio.Contenido.HasValue)
           ddlContenido.SelectedValue = myDataDetalle_de_Notificacion_por_Observatorio.Contenido.Value.ToString().TrimEnd(' ');
        //ddlContenido_SelectedIndexChanged(ddlContenido, new EventArgs());
       ChNotificar.Checked  = myDataDetalle_de_Notificacion_por_Observatorio.Notificar;
        if (myDataDetalle_de_Notificacion_por_Observatorio.Observatorio.HasValue)
            txtObservatorio.Text = myDataDetalle_de_Notificacion_por_Observatorio.Observatorio.Value.ToString();
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 149687;
        ...
        lblClave.Text = MyTraductor.getTextDTID(149687, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149688;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblContenido.Text = MyTraductor.getTextDTID(149688, lblContenido.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trContenido.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149689;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblNotificar.Text = MyTraductor.getTextDTID(149689, lblNotificar.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trNotificar.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149690;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblObservatorio.Text = MyTraductor.getTextDTID(149690, lblObservatorio.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Notificacion_por_Observatorio.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlContenido.SelectedValue), ChNotificar.Checked, MyFunctions.FormatNumberNull(txtObservatorio.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Notificacion_por_Observatorio.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), MyFunctions.FormatNumberNull(ddlContenido.SelectedValue), ChNotificar.Checked, MyFunctions.FormatNumberNull(txtObservatorio.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Notificacion_por_Observatorio_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Notificacion_por_Observatorio_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Notificacion_por_Observatorio_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Notificacion_por_Observatorio_Catalogo.aspx?Fase=" + Fase, true, null);
            else
