<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Detalle_de_Notificacion_por_Usuario_Catalogo.aspx.cs" Inherits="WebForms.Detalle_de_Notificacion_por_Usuario_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Detalle de Notificación por Usuario" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(149691,31011,0)"></asp:TextBox>
                    ...
                    <tr id="trContenido">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlContenido" runat="server" EnableViewState="true" onchange="EjecutaRN(149692,31011,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcContenido" runat="server" IdProceso="29982"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVContenido" runat="server" ControlToValidate="ddlContenido" Display="Dynamic" ErrorMessage="El campo Contenido es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trNotificar">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblNotificar" runat="server" Text="Notificar: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblNotificar" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                        <asp:PlaceHolder ID="phNotificar2" runat="server">
                          <asp:Panel ID="PnlNotificar2" runat="server" Height="100%" Width="100%">
                            <asp:CheckBox ID="ChNotificar" runat="server" onclick="EjecutaRN(149693,31011,0)"/>               
                          </asp:Panel>
                        </asp:PlaceHolder>
                               </td>                               
                             </tr>
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                          ...
                          <asp:PlaceHolder ID="phObservatorio2" runat="server" >
                            <asp:Panel ID="pnlObservatorio2" runat="server" Height="100%" Width="100%">
                              <asp:TextBox ID="txtObservatorio"  runat="server" Width="20%"  Font-Names="Arial" onblur="EjecutaRN(149694,31011,0)"></asp:TextBox>
                              &nbsp;<uc2:TTbuttonLista ID="TTblObservatorio" runat="server" IdProceso="29984" DTId="149694" />
                    ...
                    <tr id="trID_del_Cliente">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblID_del_Cliente" runat="server" Text="ID del Cliente: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblID_del_Cliente" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtID_del_Cliente" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(149695,31011,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVID_del_Cliente" runat="server" ControlToValidate="TxtID_del_Cliente" Display="Dynamic" ErrorMessage="El campo ID del Cliente debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVID_del_Cliente" runat="server" ErrorMessage="El campo ID del Cliente es obligatorio" ControlToValidate="TxtID_del_Cliente" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtNombre"  Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(149696,31011,0)"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Detalle_de_Notificacion_por_Usuario_Catalogo.aspx/' + metodo,
