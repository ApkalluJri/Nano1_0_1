...
Descripción:      Pantalla Catalogo Detalle_de_Notificacion_por_Usuario
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Detalle_de_Notificacion_por_Usuario_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSDetalle_de_Notificacion_por_Usuario.objectBussinessDetalle_de_Notificacion_por_Usuario myDetalle_de_Notificacion_por_Usuario = new WSDetalle_de_Notificacion_por_Usuario.objectBussinessDetalle_de_Notificacion_por_Usuario();
    private WSDetalle_de_Notificacion_por_Usuario.GlobalData userData;
    public int iProcess = 31011;
    private String sDNTNombre = "Detalle_de_Notificacion_por_Usuario";
    private String sDNTDescripcion = "Detalle de Notificación por Usuario";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        ddlContenido.Enabled=false;
        TTbcContenido.ImgButton.Visible = false;

        ChNotificar.Enabled=false;
                                  txtObservatorio.Enabled=false;
                                  TTblObservatorio.ImgButton.Enabled = false;

        txtID_del_Cliente.Enabled=false;
    ...
    {
        WSDetalle_de_Notificacion_por_Usuario.objectBussinessDetalle_de_Notificacion_por_Usuario1 myDataDetalle_de_Notificacion_por_Usuario = myDetalle_de_Notificacion_por_Usuario.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Contenido"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSDetalle_de_Notificacion_por_Usuario.GlobalData();
        ...
        userData.Language = (WSDetalle_de_Notificacion_por_Usuario.GlobalDataLanguages)MyUserData.Language;
        ...
        //-------------------------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------
        TTbcContenido.WebControl = ddlContenido;
        TTbcContenido.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcContenido.GetControlDataSetFunctionWithString = myDetalle_de_Notificacion_por_Usuario.FillDataContenido;
        TTbcContenido.ParentWebControl = null;

                TTblObservatorio.WebControl = txtObservatorio;
    ...
    {
                MyFunctions.FillDataControl(ddlContenido, myDetalle_de_Notificacion_por_Usuario.FillDataContenido(""));
    ...
    {
        WSDetalle_de_Notificacion_por_Usuario.objectBussinessDetalle_de_Notificacion_por_Usuario1 myDataDetalle_de_Notificacion_por_Usuario = myDetalle_de_Notificacion_por_Usuario.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Contenido"].ToString()),true);
                if (myDataDetalle_de_Notificacion_por_Usuario.Clave.HasValue)
            txtClave.Text = myDataDetalle_de_Notificacion_por_Usuario.Clave.ToString();
        if (myDataDetalle_de_Notificacion_por_Usuario.Contenido.HasValue)
           ddlContenido.SelectedValue = myDataDetalle_de_Notificacion_por_Usuario.Contenido.Value.ToString().TrimEnd(' ');
        //ddlContenido_SelectedIndexChanged(ddlContenido, new EventArgs());
       ChNotificar.Checked  = myDataDetalle_de_Notificacion_por_Usuario.Notificar;
        if (myDataDetalle_de_Notificacion_por_Usuario.Observatorio.HasValue)
            txtObservatorio.Text = myDataDetalle_de_Notificacion_por_Usuario.Observatorio.Value.ToString();
        ShowDescriptionObservatorio();
        if (myDataDetalle_de_Notificacion_por_Usuario.ID_del_Cliente.HasValue)
            txtID_del_Cliente.Text = myDataDetalle_de_Notificacion_por_Usuario.ID_del_Cliente.ToString();
        txtNombre.Text = myDataDetalle_de_Notificacion_por_Usuario.Nombre;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 149691;
        ...
        lblClave.Text = MyTraductor.getTextDTID(149691, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149692;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblContenido.Text = MyTraductor.getTextDTID(149692, lblContenido.Text);
        ddlContenido.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ddlContenido.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        TTbcContenido.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                {
                    ddlContenido.SelectedValue = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                }
                else
                {
                    ddlContenido.SelectedValue = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                }
            }
            else
            {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trContenido.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149693;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblNotificar.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblNotificar.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblNotificar.Text = MyTraductor.getTextDTID(149693, lblNotificar.Text);
        ChNotificar.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ChNotificar.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() == "1"){
            	ChNotificar.Checked = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString());
            }else{
        ...
        imgOblNotificar.Style["display"] = "none";
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trNotificar.Style["display"] = "auto";
        else
            trNotificar.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149694;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblObservatorio.Text = MyTraductor.getTextDTID(149694, lblObservatorio.Text);
        txtObservatorio.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        //lblObservatorio_Desc.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtObservatorio.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtObservatorio.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtObservatorio.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtObservatorio.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trObservatorio.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149695;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblID_del_Cliente.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblID_del_Cliente.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblID_del_Cliente.Text = MyTraductor.getTextDTID(149695, lblID_del_Cliente.Text);
        txtID_del_Cliente.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtID_del_Cliente.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtID_del_Cliente.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtID_del_Cliente.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtID_del_Cliente.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
                ...
                txtID_del_Cliente.Text = "";
            }
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblID_del_Cliente.Style["display"] = "auto";
        else
            imgOblID_del_Cliente.Style["display"] = "none";
        RFVID_del_Cliente.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trID_del_Cliente.Style["display"] = "auto";
        else
            trID_del_Cliente.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 149696;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblNombre.Text = MyTraductor.getTextDTID(149696, lblNombre.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myDetalle_de_Notificacion_por_Usuario.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlContenido.SelectedValue), ChNotificar.Checked, MyFunctions.FormatNumberNull(txtObservatorio.Text), MyFunctions.FormatNumberNull(txtID_del_Cliente.Text), txtNombre.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myDetalle_de_Notificacion_por_Usuario.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), MyFunctions.FormatNumberNull(ddlContenido.SelectedValue), ChNotificar.Checked, MyFunctions.FormatNumberNull(txtObservatorio.Text), MyFunctions.FormatNumberNull(txtID_del_Cliente.Text), txtNombre.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    protected bool IsValid3PointsRelations()
    {
        ...
        //        if (RFVObservatorio.Enabled)
            if (!TTblObservatorio.RelatedValueExists())
            {
                sError += "El campo Observatorio es incorrecto o no existe.</br>";
                isValid = false;
            }
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Detalle_de_Notificacion_por_Usuario_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Detalle_de_Notificacion_por_Usuario_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Detalle_de_Notificacion_por_Usuario_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Notificacion_por_Usuario_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Notificacion_por_Usuario_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Notificacion_por_Usuario_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Notificacion_por_Usuario_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Detalle_de_Notificacion_por_Usuario_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Detalle_de_Notificacion_por_Usuario_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("Detalle_de_Notificacion_por_Usuario_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("Detalle_de_Notificacion_por_Usuario_Catalogo.aspx?Fase=" + Fase, true, null);
            else
    ...
    /*public void ddlContenido_SelectedIndexChanged(object sender, EventArgs e)
    {
    }*/
    private void ShowDescriptionObservatorio()
    {
        TTblObservatorio.FindSearch(txtObservatorio.Text);
    }
