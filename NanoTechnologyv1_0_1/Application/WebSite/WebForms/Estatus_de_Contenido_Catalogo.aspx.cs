...
Descripción:      Pantalla Catalogo Estatus_de_Contenido
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Estatus_de_Contenido_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSEstatus_de_Contenido.objectBussinessEstatus_de_Contenido myEstatus_de_Contenido = new WSEstatus_de_Contenido.objectBussinessEstatus_de_Contenido();
    private WSEstatus_de_Contenido.GlobalData userData;
    public int iProcess = 30050;
    private String sDNTNombre = "Estatus_de_Contenido";
    private String sDNTDescripcion = "Estatus de Contenido";
...
#region CallBackAsincrono
    ...
    {
        WSEstatus_de_Contenido.objectBussinessEstatus_de_Contenido1 myDataEstatus_de_Contenido = myEstatus_de_Contenido.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    {
        WSEstatus_de_Contenido.objectBussinessEstatus_de_Contenido1 myDataEstatus_de_Contenido = myEstatus_de_Contenido.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataEstatus_de_Contenido.Clave.HasValue)
            txtClave.Text = myDataEstatus_de_Contenido.Clave.ToString();
        txtDescripcion.Text = myDataEstatus_de_Contenido.Descripcion;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 141532;
        ...
        lblClave.Text = MyTraductor.getTextDTID(141532, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141533;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblDescripcion.Text = MyTraductor.getTextDTID(141533, lblDescripcion.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myEstatus_de_Contenido.InsertWithReturnValue(userData,  txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myEstatus_de_Contenido.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Estatus_de_Contenido_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Estatus_de_Contenido_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Estatus_de_Contenido_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Estatus_de_Contenido_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Estatus_de_Contenido_Lista.aspx?Fase=" + Fase, true, null);
                else
