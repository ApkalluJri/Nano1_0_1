...
Descripción:      Pantalla Catalogo Estatus_de_Solicitud_Via_App
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Estatus_de_Solicitud_Via_App_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSEstatus_de_Solicitud_Via_App.objectBussinessEstatus_de_Solicitud_Via_App myEstatus_de_Solicitud_Via_App = new WSEstatus_de_Solicitud_Via_App.objectBussinessEstatus_de_Solicitud_Via_App();
    private WSEstatus_de_Solicitud_Via_App.GlobalData userData;
    public int iProcess = 30328;
    private String sDNTNombre = "Estatus_de_Solicitud_Via_App";
    private String sDNTDescripcion = "Estatus de Solicitud Vía App";
...
#region CallBackAsincrono
    ...
    {
        WSEstatus_de_Solicitud_Via_App.objectBussinessEstatus_de_Solicitud_Via_App1 myDataEstatus_de_Solicitud_Via_App = myEstatus_de_Solicitud_Via_App.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    {
        WSEstatus_de_Solicitud_Via_App.objectBussinessEstatus_de_Solicitud_Via_App1 myDataEstatus_de_Solicitud_Via_App = myEstatus_de_Solicitud_Via_App.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataEstatus_de_Solicitud_Via_App.Clave.HasValue)
            txtClave.Text = myDataEstatus_de_Solicitud_Via_App.Clave.ToString();
        txtDescripcion.Text = myDataEstatus_de_Solicitud_Via_App.Descripcion;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 143365;
        ...
        lblClave.Text = MyTraductor.getTextDTID(143365, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143366;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblDescripcion.Text = MyTraductor.getTextDTID(143366, lblDescripcion.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myEstatus_de_Solicitud_Via_App.InsertWithReturnValue(userData,  txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myEstatus_de_Solicitud_Via_App.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Estatus_de_Solicitud_Via_App_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Estatus_de_Solicitud_Via_App_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Estatus_de_Solicitud_Via_App_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Estatus_de_Solicitud_Via_App_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Estatus_de_Solicitud_Via_App_Lista.aspx?Fase=" + Fase, true, null);
                else
