<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Fuentes_Catalogo.aspx.cs" Inherits="WebForms.Fuentes_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Fuentes" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Fuentes_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Fuentes_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(141505,30048,0)"></asp:TextBox>
                    ...
                    <tr id="trArticulo">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlArticulo" runat="server" EnableViewState="true" onchange="EjecutaRN(141903,30048,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcArticulo" runat="server" IdProceso="29982"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVArticulo" runat="server" ControlToValidate="ddlArticulo" Display="Dynamic" ErrorMessage="El campo Articulo es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trFuente">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblFuente" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtFuente"  Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(141904,30048,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVFuente" runat="server" ControlToValidate="TxtFuente" Display="Dynamic" ErrorMessage="El campo Fuente debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVFuente" runat="server" ControlToValidate="TxtFuente" Display="Dynamic" ErrorMessage="El campo Fuente es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Fuentes_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Fuentes_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Fuentes_Catalogo.aspx/' + metodo,
