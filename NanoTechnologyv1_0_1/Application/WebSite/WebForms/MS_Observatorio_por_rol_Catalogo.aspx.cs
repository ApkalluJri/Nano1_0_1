...
Descripción:      Pantalla Catalogo MS_Observatorio_por_rol
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class MS_Observatorio_por_rol_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSMS_Observatorio_por_rol.objectBussinessMS_Observatorio_por_rol myMS_Observatorio_por_rol = new WSMS_Observatorio_por_rol.objectBussinessMS_Observatorio_por_rol();
    private WSMS_Observatorio_por_rol.GlobalData userData;
    public int iProcess = 30401;
    private String sDNTNombre = "MS_Observatorio_por_rol";
    private String sDNTDescripcion = "MS Observatorio por rol";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        TTbcClave.ImgButton.Visible = false;
    ...
    {
        WSMS_Observatorio_por_rol.objectBussinessMS_Observatorio_por_rol1 myDataMS_Observatorio_por_rol = myMS_Observatorio_por_rol.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Observatorio"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        LoadSecurityPage();
        //-------------------------------------------------------------------------------------------------------------
        userData = new WSMS_Observatorio_por_rol.GlobalData();
        ...
        userData.Language = (WSMS_Observatorio_por_rol.GlobalDataLanguages)MyUserData.Language;
        ...
        //-------------------------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------
        TTbcClave.WebControl = ddlClave;
        TTbcClave.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcClave.GetControlDataSetFunctionWithString = myMS_Observatorio_por_rol.FillDataClave;
        TTbcClave.ParentWebControl = null;
        //------------------------------------------------------------------------------------
        TTbcObservatorio.WebControl = ddlObservatorio;
        TTbcObservatorio.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcObservatorio.GetControlDataSetFunctionWithString = myMS_Observatorio_por_rol.FillDataObservatorio;
    ...
    {
                MyFunctions.FillDataControl(ddlClave, myMS_Observatorio_por_rol.FillDataClave(""));
        MyFunctions.FillDataControl(ddlObservatorio, myMS_Observatorio_por_rol.FillDataObservatorio(""));
    ...
    {
        WSMS_Observatorio_por_rol.objectBussinessMS_Observatorio_por_rol1 myDataMS_Observatorio_por_rol = myMS_Observatorio_por_rol.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), MyFunctions.FormatNumberNull(Session["Observatorio"].ToString()),true);
                if (myDataMS_Observatorio_por_rol.Clave.HasValue)
           ddlClave.SelectedValue = myDataMS_Observatorio_por_rol.Clave.Value.ToString().TrimEnd(' ');
        //ddlClave_SelectedIndexChanged(ddlClave, new EventArgs());
        if (myDataMS_Observatorio_por_rol.Observatorio.HasValue)
           ddlObservatorio.SelectedValue = myDataMS_Observatorio_por_rol.Observatorio.Value.ToString().TrimEnd(' ');
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 143842;
        ...
        lblClave.Text = MyTraductor.getTextDTID(143842, lblClave.Text);
        ddlClave.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ddlClave.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        TTbcClave.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
            {
                ...
                {
                    ddlClave.SelectedValue = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                }
                else
                {
                    ddlClave.SelectedValue = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                }
            }
            else
            {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 143843;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblObservatorio.Text = MyTraductor.getTextDTID(143843, lblObservatorio.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myMS_Observatorio_por_rol.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(ddlClave.SelectedValue), MyFunctions.FormatNumberNull(ddlObservatorio.SelectedValue));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myMS_Observatorio_por_rol.Update(userData,  MyFunctions.FormatNumberNull(ddlClave.SelectedValue), MyFunctions.FormatNumberNull(ddlObservatorio.SelectedValue));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("MS_Observatorio_por_rol_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("MS_Observatorio_por_rol_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("MS_Observatorio_por_rol_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("MS_Observatorio_por_rol_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("MS_Observatorio_por_rol_Lista.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("MS_Observatorio_por_rol_Lista.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("MS_Observatorio_por_rol_Lista.aspx?Fase=" + Fase, true, null);
            else
    ...
    public static JsonResult Clear(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("MS_Observatorio_por_rol_Catalogo.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("MS_Observatorio_por_rol_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                        return new JsonResult("MS_Observatorio_por_rol_Catalogo.aspx", true, null);
            }
            else if (Fase != null)
                return new JsonResult("MS_Observatorio_por_rol_Catalogo.aspx?Fase=" + Fase, true, null);
            else
    ...
    /*public void ddlClave_SelectedIndexChanged(object sender, EventArgs e)
    {
    }*/
