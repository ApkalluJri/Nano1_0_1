...
Descripción:      Pantalla Lista Observatorio
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Observatorio_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Observatorio";
    const String sDNTDescripcion = "Observatorio";
    const Int32 idProceso = 29984;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=29984 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSObservatorio.objectBussinessObservatorio myObservatorio = new WSObservatorio.objectBussinessObservatorio();
                    WSObservatorio.GlobalData userData = new WSObservatorio.GlobalData();
                    ...
                    Session["Clave"] = Funcion.RegresaDato("insert into Observatorio(Nombre) values(null); select @@identity");
                ...
                Response.Redirect("Observatorio_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Observatorio_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Observatorio_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSObservatorio.GlobalData userData;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(141057, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "Observatorio_Clave";
        colClave.SortExpression = "Observatorio.Clave";
        colClave.UniqueName = "Observatorio.Clave";
        ...
        colNombre.HeaderText = MyTraductor.getTextDTID(141058, "Nombre");
        colNombre.DataField = "Observatorio_Nombre";
        colNombre.DataFormatString = "";
        colNombre.SortExpression = "Observatorio.Nombre";
        colNombre.UniqueName = "Observatorio.Nombre";
        colNombre.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colNombre.DataType = typeof(string);
        grdRadMov.Columns.Add(colNombre);
        GridBoundColumn colIcono = new GridBoundColumn();
        colIcono.HeaderText = MyTraductor.getTextDTID(141059, "Ícono");
        colIcono.DataField = "Observatorio_Icono";
        colIcono.DataFormatString = "";
        colIcono.SortExpression = "Observatorio.Icono";
        colIcono.UniqueName = "Observatorio.Icono";
        colIcono.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colIcono.DataType = typeof(string);
        grdRadMov.Columns.Add(colIcono);
        //grdMov.Columns[7+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[7+1].ItemStyle.CssClass = "Hide";
        colIcono.HeaderStyle.CssClass = "Hide";
        colIcono.ItemStyle.CssClass = "Hide";
        colIcono.Visible = false;
	        //GridBoundColumn colIcono_Desc = new GridBoundColumn();
	        //colIcono_Desc.ButtonType = ButtonType.Link;
	        //colIcono_Desc.CommandName = "Observatorio_Icono";
	        //colIcono_Desc.HeaderText = "Ícono";
	        //colIcono_Desc.DataTextField = "TTArchivos_Nombre";
	        //colIcono_Desc.SortExpression = "TTArchivos.Nombre";
	       //colIcono.UniqueName = "TTArchivos.Nombre";
	       //colIcono.DataType = typeof(string);
	        //grdRadMov.Columns.Add(colIcono_Desc);
        GridBoundColumn colColor = new GridBoundColumn();
        colColor.HeaderText = MyTraductor.getTextDTID(141060, "Color");
        colColor.DataField = "Observatorio_Color";
        colColor.DataFormatString = "";
        colColor.SortExpression = "Observatorio.Color";
        colColor.UniqueName = "Observatorio.Color";
        colColor.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colColor.DataType = typeof(string);
        grdRadMov.Columns.Add(colColor);
        //grdMov.Columns[9+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[9+1].ItemStyle.CssClass = "Hide";
        colColor.HeaderStyle.CssClass = "Hide";
        colColor.ItemStyle.CssClass = "Hide";
        colColor.Visible = false;
        GridBoundColumn colColor_Desc = new GridBoundColumn();
        colColor_Desc.DataField = "Color_Descripcion";
        colColor_Desc.HeaderText = MyTraductor.getTextDTID(141060, "Color");
        colColor_Desc.SortExpression = "Color.Descripcion";
        colColor_Desc.UniqueName = "Color.Descripcion";
        colColor_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colColor_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colColor_Desc);
        GridBoundColumn colTipo_de_Observatorio = new GridBoundColumn();
        colTipo_de_Observatorio.HeaderText = MyTraductor.getTextDTID(141063, "Tipo de Observatorio");
        colTipo_de_Observatorio.DataField = "Observatorio_Tipo_de_Observatorio";
        colTipo_de_Observatorio.DataFormatString = "";
        colTipo_de_Observatorio.SortExpression = "Observatorio.Tipo_de_Observatorio";
        colTipo_de_Observatorio.UniqueName = "Observatorio.Tipo_de_Observatorio";
        colTipo_de_Observatorio.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colTipo_de_Observatorio.DataType = typeof(string);
        grdRadMov.Columns.Add(colTipo_de_Observatorio);
        //grdMov.Columns[11+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[11+1].ItemStyle.CssClass = "Hide";
        colTipo_de_Observatorio.HeaderStyle.CssClass = "Hide";
        colTipo_de_Observatorio.ItemStyle.CssClass = "Hide";
        colTipo_de_Observatorio.Visible = false;
        GridBoundColumn colTipo_de_Observatorio_Desc = new GridBoundColumn();
        colTipo_de_Observatorio_Desc.DataField = "Tipo_de_Observatorio_Descripcion";
        colTipo_de_Observatorio_Desc.HeaderText = MyTraductor.getTextDTID(141063, "Tipo de Observatorio");
        colTipo_de_Observatorio_Desc.SortExpression = "Tipo_de_Observatorio.Descripcion";
        colTipo_de_Observatorio_Desc.UniqueName = "Tipo_de_Observatorio.Descripcion";
        colTipo_de_Observatorio_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colTipo_de_Observatorio_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colTipo_de_Observatorio_Desc);
        GridBoundColumn colAdministrador = new GridBoundColumn();
        colAdministrador.HeaderText = MyTraductor.getTextDTID(141905, "Administrador");
        colAdministrador.DataField = "Observatorio_Administrador";
        colAdministrador.DataFormatString = "";
        colAdministrador.SortExpression = "Observatorio.Administrador";
        colAdministrador.UniqueName = "Observatorio.Administrador";
        colAdministrador.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colAdministrador.DataType = typeof(string);
        grdRadMov.Columns.Add(colAdministrador);
        //grdMov.Columns[13+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[13+1].ItemStyle.CssClass = "Hide";
        colAdministrador.HeaderStyle.CssClass = "Hide";
        colAdministrador.ItemStyle.CssClass = "Hide";
        colAdministrador.Visible = false;
        GridBoundColumn colAdministrador_Desc = new GridBoundColumn();
        colAdministrador_Desc.DataField = "Administrador_Nombre";
        colAdministrador_Desc.HeaderText = MyTraductor.getTextDTID(141905, "Administrador");
        colAdministrador_Desc.SortExpression = "Administrador.Nombre";
        colAdministrador_Desc.UniqueName = "Administrador.Nombre";
        colAdministrador_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colAdministrador_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colAdministrador_Desc);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Observatorio_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Observatorio_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Observatorio&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myObservatorio.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myObservatorio.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myObservatorio.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myObservatorio.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Observatorio_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Clave"] = Funcion.RegresaDato("insert into Observatorio(Nombre) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Observatorio_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Observatorio_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myObservatorio.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Observatorio&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Observatorio_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Observatorio_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
