...
Descripción:      Pantalla Catalogo Opciones_de_Solicitud_via_App
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class Opciones_de_Solicitud_via_App_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App myOpciones_de_Solicitud_via_App = new WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App();
    private WSOpciones_de_Solicitud_via_App.GlobalData userData;
    public int iProcess = 29991;
    private String sDNTNombre = "Opciones_de_Solicitud_via_App";
    private String sDNTDescripcion = "Opciones de Solicitud Vía App";
...
#region CallBackAsincrono
    ...
    {
        WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App1 myDataOpciones_de_Solicitud_via_App = myOpciones_de_Solicitud_via_App.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()), true);
    ...
    {
        WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App1 myDataOpciones_de_Solicitud_via_App = myOpciones_de_Solicitud_via_App.GetByKey(MyFunctions.FormatNumberNull(Session["Clave"].ToString()),true);
                if (myDataOpciones_de_Solicitud_via_App.Clave.HasValue)
            txtClave.Text = myDataOpciones_de_Solicitud_via_App.Clave.ToString();
        txtDescripcion.Text = myDataOpciones_de_Solicitud_via_App.Descripcion;
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 141083;
        ...
        lblClave.Text = MyTraductor.getTextDTID(141083, lblClave.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trClave.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 141084;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblDescripcion.Text = MyTraductor.getTextDTID(141084, lblDescripcion.Text);
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myOpciones_de_Solicitud_via_App.InsertWithReturnValue(userData,  txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myOpciones_de_Solicitud_via_App.Update(userData,  MyFunctions.FormatNumberNull(txtClave.Text), txtDescripcion.Text);
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
               	...
               	Response.Redirect("Opciones_de_Solicitud_via_App_Lista.aspx?Fase=" + Request["Fase"]);
               else
               	Response.Redirect("Opciones_de_Solicitud_via_App_Lista.aspx");
            }
            else if (Request["Fase"] != null)
               Response.Redirect("Opciones_de_Solicitud_via_App_Lista.aspx?Fase=" + Request["Fase"]);
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("Opciones_de_Solicitud_via_App_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("Opciones_de_Solicitud_via_App_Lista.aspx?Fase=" + Fase, true, null);
                else
