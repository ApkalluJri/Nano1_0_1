<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Opciones_de_Solicitud_via_App_Lista.aspx.cs" Inherits="WebForms.Opciones_de_Solicitud_via_App_Lista"
    Theme="SpanishLanguage" Title="Lista de Opciones de Solicitud Vía App" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="grid_div" style="overflow:scroll">                       
            ...
            <MasterTableView DataKeyNames="Opciones_de_Solicitud_via_App_Clave" ClientDataKeyNames="Opciones_de_Solicitud_via_App_Clave" CurrentResetPageIndexAction="ReportError"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" > 
                ...
                <DataBinding Location="Opciones_de_Solicitud_via_App_Lista.aspx" SelectMethod="GetDataAndCount" EnableCaching="false" >
                </DataBinding>
            </ClientSettings>
            </telerik:RadGrid>                                                    
  </div>
...
function RadGrid_Command(sender, args) {
            ...
            if (command == "Delete") {
                Idelement = args.get_tableView().get_dataItems()[args.get_commandArgument()].getDataKeyValue('Opciones_de_Solicitud_via_App_Clave');
                ...
                jQuery.ajax({
                    ...
                    data: '{ Id: "' + sender._clientKeyValues[args.get_commandArgument()].Opciones_de_Solicitud_via_App_Clave + '"}',
                    dataType: 'json',
                    url: 'Opciones_de_Solicitud_via_App_lista.aspx/Select',
                    success: successCommandRedirect
                });
            }
            else if (command == "Consult") {
                SendFolio(args, 'Opciones_de_Solicitud_via_App_lista.aspx/Consult', successCommandRedirect);
            }
            else if (command == "Edit") {
                SendFolio(args, 'Opciones_de_Solicitud_via_App_lista.aspx/Edit', successCommandRedirect);
            }
            else if (command == "Print") {
                SendPrint(args, 'Opciones_de_Solicitud_via_App_lista.aspx/Print', successCommandPrint);
            }
            ...
            if (sender.value == "") {
                ...
                if (encontro) {
                    ...
                    jQuery.ajax({
                        ...
                        data: sdata,
                        dataType: 'json',
                        url: 'Opciones_de_Solicitud_via_App_lista.aspx/GetDataAndCount',
        ...
        function confirmDeleteCallBackFn(arg) {
            ...
            if (id != 0 && arg) {
                ...
                jQuery.ajax({
                    ...
                    data: sdata,
                    dataType: 'json',
                    url: 'Opciones_de_Solicitud_via_App_lista.aspx/Delete_Row',
        ...
        function successCommandRedirect(result) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Opciones_de_Solicitud_via_App_lista.aspx/New',
                success: successCommandRedirect
            });
        }
        function btn_todosClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'Opciones_de_Solicitud_via_App_lista.aspx/GetAllDataAndCount',
                success: successCommandClear
            });
        }
        ...
        function btn_imprimirClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'Opciones_de_Solicitud_via_App_lista.aspx/PrintAll',
