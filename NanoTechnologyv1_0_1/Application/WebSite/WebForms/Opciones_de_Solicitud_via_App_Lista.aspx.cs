...
Descripción:      Pantalla Lista Opciones_de_Solicitud_via_App
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Opciones_de_Solicitud_via_App_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Opciones_de_Solicitud_via_App";
    const String sDNTDescripcion = "Opciones de Solicitud Vía App";
    const Int32 idProceso = 29991;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=29991 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App myOpciones_de_Solicitud_via_App = new WSOpciones_de_Solicitud_via_App.objectBussinessOpciones_de_Solicitud_via_App();
                    WSOpciones_de_Solicitud_via_App.GlobalData userData = new WSOpciones_de_Solicitud_via_App.GlobalData();
                    ...
                    userData.Language = (WSOpciones_de_Solicitud_via_App.GlobalDataLanguages)MyUserData.Language;
                    ...
                    Session["Clave"] = Funcion.RegresaDato("insert into Opciones_de_Solicitud_via_App(Descripcion) values(null); select @@identity");
                ...
                Response.Redirect("Opciones_de_Solicitud_via_App_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSOpciones_de_Solicitud_via_App.GlobalData userData;
        userData = new WSOpciones_de_Solicitud_via_App.GlobalData();
        userData.AppToTempFiles = MyUserData.AppToTempFiles;
        userData.ComputerName = MyUserData.ComputerName;
        userData.DatabaseName = MyUserData.DatabaseName;
        userData.Folio = MyUserData.Folio;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(141083, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "Opciones_de_Solicitud_via_App_Clave";
        colClave.SortExpression = "Opciones_de_Solicitud_via_App.Clave";
        colClave.UniqueName = "Opciones_de_Solicitud_via_App.Clave";
        ...
        colDescripcion.HeaderText = MyTraductor.getTextDTID(141084, "Descripción");
        colDescripcion.DataField = "Opciones_de_Solicitud_via_App_Descripcion";
        colDescripcion.DataFormatString = "";
        colDescripcion.SortExpression = "Opciones_de_Solicitud_via_App.Descripcion";
        colDescripcion.UniqueName = "Opciones_de_Solicitud_via_App.Descripcion";
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Opciones_de_Solicitud_via_App_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Opciones_de_Solicitud_via_App_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Opciones de Solicitud Vía App&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myOpciones_de_Solicitud_via_App.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myOpciones_de_Solicitud_via_App.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myOpciones_de_Solicitud_via_App.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myOpciones_de_Solicitud_via_App.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        public static JsonResult Consult(string Folio, string Fase)
        {
            try
            {
                ...
                if (Fase != null && Fase != string.Empty)
                    return new JsonResult("Opciones_de_Solicitud_via_App_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                    return new JsonResult("Opciones_de_Solicitud_via_App_Catalogo.aspx", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Clave"] = Funcion.RegresaDato("insert into Opciones_de_Solicitud_via_App(Descripcion) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Opciones_de_Solicitud_via_App_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
                        return new JsonResult("Opciones_de_Solicitud_via_App_Catalogo.aspx?MenuVisible=false", true, null);
                }
                else
                {
                    if (Fase != null && Fase != string.Empty)
        ...
        //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myOpciones_de_Solicitud_via_App.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Opciones_de_Solicitud_via_App&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        public static JsonResult Select(string Id)
        {
            try
            {
                ...
                return new JsonResult("Opciones_de_Solicitud_via_App_Lista.aspx", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Opciones_de_Solicitud_via_App_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
