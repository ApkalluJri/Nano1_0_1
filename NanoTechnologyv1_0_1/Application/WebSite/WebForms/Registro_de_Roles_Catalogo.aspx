<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Registro_de_Roles_Catalogo.aspx.cs" Inherits="WebForms.Registro_de_Roles_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Registro de Roles" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Registro_de_Roles_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Registro_de_Roles_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtFolio" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(143582,30351,0)"></asp:TextBox>
                    ...
                    <tr id="trUsuario_que_Registra">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlUsuario_que_Registra" runat="server" EnableViewState="true" onchange="EjecutaRN(143583,30351,0)"></asp:DropDownList>
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <telerik:RadDatePicker  MinDate="01/01/1900" ID="txtFecha_de_Registro" runat="server" onkeyup="rad_keyup(this,event);" onkeydown="rad_keydown(this,event);" DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                                    ...
                                                    <DateInput  LabelCssClass="" Width="" ClientEvents-OnLoad="RadDate_Load" DTid="143584" idProceso="30351"
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <telerik:RadTimePicker ID="txtHora_de_Registro" runat="server"  DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                <DateInput DateFormat="HH:mm:ss" DisplayDateFormat="HH:mm:ss" OnChange="OnChangeDateInput(this)"  DTid="143585" idProceso="30351"></DateInput>
                                <ClientEvents>
                                </ClientEvents>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtNombre" TextMode="MultiLine" Rows="2" Columns="100"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143586,30351,0)"></asp:TextBox>
                    ...
                    <tr id="trClave_de_Acceso">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtClave_de_Acceso"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143588,30351,0)"></asp:TextBox>
                    ...
                    <tr id="trContrasena">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtContrasena"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143589,30351,0)"></asp:TextBox>
                    ...
                    <tr id="trCorreo">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtCorreo"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143590,30351,0)"></asp:TextBox>
                    ...
                    <tr id="trRol">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblRol" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlRol" runat="server" EnableViewState="true" onchange="EjecutaRN(143593,30351,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcRol" runat="server" IdProceso="30352"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVRol" runat="server" ControlToValidate="ddlRol" Display="Dynamic" ErrorMessage="El campo Rol es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    </tr>
                    <tr id="trUsuario_de_Sistema">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblUsuario_de_Sistema" runat="server" Text="Usuario de Sistema: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblUsuario_de_Sistema" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlUsuario_de_Sistema" runat="server" EnableViewState="true" onchange="EjecutaRN(143631,30351,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcUsuario_de_Sistema" runat="server" IdProceso=""/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVUsuario_de_Sistema" runat="server" ControlToValidate="ddlUsuario_de_Sistema" Display="Dynamic" ErrorMessage="El campo Usuario de Sistema es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trObservatorios">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblObservatorios" runat="server" Text="Observatorios: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblObservatorios" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtObservatorios" TextMode="MultiLine" Rows="10" Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(143950,30351,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVObservatorios" runat="server" ControlToValidate="TxtObservatorios" Display="Dynamic" ErrorMessage="El campo Observatorios debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVObservatorios" runat="server" ControlToValidate="TxtObservatorios" Display="Dynamic" ErrorMessage="El campo Observatorios es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Registro_de_Roles_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Registro_de_Roles_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Registro_de_Roles_Catalogo.aspx/' + metodo,
