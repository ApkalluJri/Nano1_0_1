...
Descripción:      Pantalla Lista Registro_de_Roles
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Registro_de_Roles_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Registro_de_Roles";
    const String sDNTDescripcion = "Registro de Roles";
    const Int32 idProceso = 30351;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=30351 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSRegistro_de_Roles.objectBussinessRegistro_de_Roles myRegistro_de_Roles = new WSRegistro_de_Roles.objectBussinessRegistro_de_Roles();
                    WSRegistro_de_Roles.GlobalData userData = new WSRegistro_de_Roles.GlobalData();
                    ...
                    Session["Folio"] = Funcion.RegresaDato("insert into Registro_de_Roles(Usuario_que_Registra) values(null); select @@identity");
                ...
                Response.Redirect("Registro_de_Roles_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSRegistro_de_Roles.GlobalData userData;
    ...
    { 
        ...
        colFolio.HeaderText = MyTraductor.getTextDTID(143582, "Folio");
        colFolio.HtmlEncode = false;
        colFolio.DataField = "Registro_de_Roles_Folio";
        colFolio.SortExpression = "Registro_de_Roles.Folio";
        colFolio.UniqueName = "Registro_de_Roles.Folio";
        ...
        colUsuario_que_Registra.HeaderText = MyTraductor.getTextDTID(143583, "Usuario que Registra");
        colUsuario_que_Registra.DataField = "Registro_de_Roles_Usuario_que_Registra";
        colUsuario_que_Registra.DataFormatString = "";
        colUsuario_que_Registra.SortExpression = "Registro_de_Roles.Usuario_que_Registra";
        colUsuario_que_Registra.UniqueName = "Registro_de_Roles.Usuario_que_Registra";
        ...
        colUsuario_que_Registra_Desc.HeaderText = MyTraductor.getTextDTID(143583, "Usuario que Registra");
        ...
        colFecha_de_Registro.DataField = "Registro_de_Roles_Fecha_de_Registro";
        colFecha_de_Registro.HeaderText = MyTraductor.getTextDTID(143584, "Fecha de Registro");
        colFecha_de_Registro.SortExpression = "Registro_de_Roles.Fecha_de_Registro";
        colFecha_de_Registro.UniqueName = "Registro_de_Roles.Fecha_de_Registro";
        ...
        colHora_de_Registro.HeaderText = MyTraductor.getTextDTID(143585, "Hora de Registro");
        colHora_de_Registro.DataField = "Registro_de_Roles_Hora_de_Registro";
        colHora_de_Registro.DataFormatString = "";
        colHora_de_Registro.SortExpression = "Registro_de_Roles.Hora_de_Registro";
        colHora_de_Registro.UniqueName = "Registro_de_Roles.Hora_de_Registro";
        ...
        colNombre.HeaderText = MyTraductor.getTextDTID(143586, "Nombre");
        colNombre.DataField = "Registro_de_Roles_Nombre";
        colNombre.DataFormatString = "";
        colNombre.SortExpression = "Registro_de_Roles.Nombre";
        colNombre.UniqueName = "Registro_de_Roles.Nombre";
        colNombre.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colNombre.DataType = typeof(string);
        grdRadMov.Columns.Add(colNombre);
        GridBoundColumn colClave_de_Acceso = new GridBoundColumn();
        colClave_de_Acceso.HeaderText = MyTraductor.getTextDTID(143588, "Clave de Acceso");
        colClave_de_Acceso.DataField = "Registro_de_Roles_Clave_de_Acceso";
        colClave_de_Acceso.DataFormatString = "";
        colClave_de_Acceso.SortExpression = "Registro_de_Roles.Clave_de_Acceso";
        colClave_de_Acceso.UniqueName = "Registro_de_Roles.Clave_de_Acceso";
        colClave_de_Acceso.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colClave_de_Acceso.DataType = typeof(string);
        grdRadMov.Columns.Add(colClave_de_Acceso);
        GridBoundColumn colContrasena = new GridBoundColumn();
        colContrasena.HeaderText = MyTraductor.getTextDTID(143589, "Contraseña");
        colContrasena.DataField = "Registro_de_Roles_Contrasena";
        colContrasena.DataFormatString = "";
        colContrasena.SortExpression = "Registro_de_Roles.Contrasena";
        colContrasena.UniqueName = "Registro_de_Roles.Contrasena";
        ...
        colCorreo.HeaderText = MyTraductor.getTextDTID(143590, "Correo");
        colCorreo.DataField = "Registro_de_Roles_Correo";
        colCorreo.DataFormatString = "";
        colCorreo.SortExpression = "Registro_de_Roles.Correo";
        colCorreo.UniqueName = "Registro_de_Roles.Correo";
        colCorreo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colCorreo.DataType = typeof(string);
        grdRadMov.Columns.Add(colCorreo);
        GridBoundColumn colRol = new GridBoundColumn();
        colRol.HeaderText = MyTraductor.getTextDTID(143593, "Rol");
        colRol.DataField = "Registro_de_Roles_Rol";
        colRol.DataFormatString = "";
        colRol.SortExpression = "Registro_de_Roles.Rol";
        colRol.UniqueName = "Registro_de_Roles.Rol";
        colRol.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colRol.DataType = typeof(string);
        grdRadMov.Columns.Add(colRol);
        //grdMov.Columns[14+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[14+1].ItemStyle.CssClass = "Hide";
        colRol.HeaderStyle.CssClass = "Hide";
        colRol.ItemStyle.CssClass = "Hide";
        colRol.Visible = false;
        GridBoundColumn colRol_Desc = new GridBoundColumn();
        colRol_Desc.DataField = "Rol_Descripcion";
        colRol_Desc.HeaderText = MyTraductor.getTextDTID(143593, "Rol");
        colRol_Desc.SortExpression = "Rol.Descripcion";
        colRol_Desc.UniqueName = "Rol.Descripcion";
        colRol_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colRol_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colRol_Desc);
        GridBoundColumn colUsuario_de_Sistema = new GridBoundColumn();
        colUsuario_de_Sistema.HeaderText = MyTraductor.getTextDTID(143631, "Usuario de Sistema");
        colUsuario_de_Sistema.DataField = "Registro_de_Roles_Usuario_de_Sistema";
        colUsuario_de_Sistema.DataFormatString = "";
        colUsuario_de_Sistema.SortExpression = "Registro_de_Roles.Usuario_de_Sistema";
        colUsuario_de_Sistema.UniqueName = "Registro_de_Roles.Usuario_de_Sistema";
        colUsuario_de_Sistema.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario_de_Sistema.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario_de_Sistema);
        //grdMov.Columns[16+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[16+1].ItemStyle.CssClass = "Hide";
        colUsuario_de_Sistema.HeaderStyle.CssClass = "Hide";
        colUsuario_de_Sistema.ItemStyle.CssClass = "Hide";
        colUsuario_de_Sistema.Visible = false;
        GridBoundColumn colUsuario_de_Sistema_Desc = new GridBoundColumn();
        colUsuario_de_Sistema_Desc.DataField = "Usuario_de_Sistema_Nombre";
        colUsuario_de_Sistema_Desc.HeaderText = MyTraductor.getTextDTID(143631, "Usuario de Sistema");
        colUsuario_de_Sistema_Desc.SortExpression = "Usuario_de_Sistema.Nombre";
        colUsuario_de_Sistema_Desc.UniqueName = "Usuario_de_Sistema.Nombre";
        colUsuario_de_Sistema_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario_de_Sistema_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario_de_Sistema_Desc);
        GridBoundColumn colObservatorio = new GridBoundColumn();
        colObservatorio.HeaderText = MyTraductor.getTextDTID(143844, "Observatorio");
        colObservatorio.HtmlEncode = false;
        colObservatorio.DataField = "Registro_de_Roles_Observatorio";
        colObservatorio.SortExpression = "Registro_de_Roles.Observatorio";
        colObservatorio.UniqueName = "Registro_de_Roles.Observatorio";
        ...
        GridBoundColumn colObservatorios = new GridBoundColumn();
        colObservatorios.HeaderText = MyTraductor.getTextDTID(143950, "Observatorios");
        colObservatorios.DataField = "Registro_de_Roles_Observatorios";
        colObservatorios.DataFormatString = "";
        colObservatorios.SortExpression = "Registro_de_Roles.Observatorios";
        colObservatorios.UniqueName = "Registro_de_Roles.Observatorios";
        colObservatorios.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colObservatorios.DataType = typeof(string);
        grdRadMov.Columns.Add(colObservatorios);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Registro_de_Roles_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Registro_de_Roles_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Registro de Roles&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myRegistro_de_Roles.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myRegistro_de_Roles.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myRegistro_de_Roles.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myRegistro_de_Roles.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Folio"] = Funcion.RegresaDato("insert into Registro_de_Roles(Usuario_que_Registra) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Registro_de_Roles_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myRegistro_de_Roles.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Registro_de_Roles&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Registro_de_Roles_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
