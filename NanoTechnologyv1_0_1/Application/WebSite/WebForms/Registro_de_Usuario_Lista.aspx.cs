...
Descripción:      Pantalla Lista Registro_de_Usuario
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Registro_de_Usuario_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Registro_de_Usuario";
    const String sDNTDescripcion = "Registro de Usuario";
    const Int32 idProceso = 29981;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=29981 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSRegistro_de_Usuario.objectBussinessRegistro_de_Usuario myRegistro_de_Usuario = new WSRegistro_de_Usuario.objectBussinessRegistro_de_Usuario();
                    WSRegistro_de_Usuario.GlobalData userData = new WSRegistro_de_Usuario.GlobalData();
                    ...
                    Session["Folio"] = Funcion.RegresaDato("insert into Registro_de_Usuario(Usuario_que_Registra) values(null); select @@identity");
                ...
                Response.Redirect("Registro_de_Usuario_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSRegistro_de_Usuario.GlobalData userData;
    ...
    { 
        ...
        colFolio.HeaderText = MyTraductor.getTextDTID(141033, "Folio");
        colFolio.HtmlEncode = false;
        colFolio.DataField = "Registro_de_Usuario_Folio";
        colFolio.SortExpression = "Registro_de_Usuario.Folio";
        colFolio.UniqueName = "Registro_de_Usuario.Folio";
        ...
        colUsuario_que_Registra.HeaderText = MyTraductor.getTextDTID(141034, "Usuario que Registra");
        colUsuario_que_Registra.DataField = "Registro_de_Usuario_Usuario_que_Registra";
        colUsuario_que_Registra.DataFormatString = "";
        colUsuario_que_Registra.SortExpression = "Registro_de_Usuario.Usuario_que_Registra";
        colUsuario_que_Registra.UniqueName = "Registro_de_Usuario.Usuario_que_Registra";
        ...
        colUsuario_que_Registra_Desc.HeaderText = MyTraductor.getTextDTID(141034, "Usuario que Registra");
        ...
        colFecha_de_Registro.DataField = "Registro_de_Usuario_Fecha_de_Registro";
        colFecha_de_Registro.HeaderText = MyTraductor.getTextDTID(141035, "Fecha de Registro");
        colFecha_de_Registro.SortExpression = "Registro_de_Usuario.Fecha_de_Registro";
        colFecha_de_Registro.UniqueName = "Registro_de_Usuario.Fecha_de_Registro";
        ...
        colHora_de_Registro.HeaderText = MyTraductor.getTextDTID(141036, "Hora de Registro");
        colHora_de_Registro.DataField = "Registro_de_Usuario_Hora_de_Registro";
        colHora_de_Registro.DataFormatString = "";
        colHora_de_Registro.SortExpression = "Registro_de_Usuario.Hora_de_Registro";
        colHora_de_Registro.UniqueName = "Registro_de_Usuario.Hora_de_Registro";
        ...
        colNombre.HeaderText = MyTraductor.getTextDTID(141037, "Nombre");
        colNombre.DataField = "Registro_de_Usuario_Nombre";
        colNombre.DataFormatString = "";
        colNombre.SortExpression = "Registro_de_Usuario.Nombre";
        colNombre.UniqueName = "Registro_de_Usuario.Nombre";
        colNombre.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colNombre.DataType = typeof(string);
        grdRadMov.Columns.Add(colNombre);
        GridBoundColumn colApellido = new GridBoundColumn();
        colApellido.HeaderText = MyTraductor.getTextDTID(141038, "Apellido");
        colApellido.DataField = "Registro_de_Usuario_Apellido";
        colApellido.DataFormatString = "";
        colApellido.SortExpression = "Registro_de_Usuario.Apellido";
        colApellido.UniqueName = "Registro_de_Usuario.Apellido";
        colApellido.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colApellido.DataType = typeof(string);
        grdRadMov.Columns.Add(colApellido);
        GridBoundColumn colNombre_Completo = new GridBoundColumn();
        colNombre_Completo.HeaderText = MyTraductor.getTextDTID(141039, "Nombre Completo");
        colNombre_Completo.DataField = "Registro_de_Usuario_Nombre_Completo";
        colNombre_Completo.DataFormatString = "";
        colNombre_Completo.SortExpression = "Registro_de_Usuario.Nombre_Completo";
        colNombre_Completo.UniqueName = "Registro_de_Usuario.Nombre_Completo";
        colNombre_Completo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colNombre_Completo.DataType = typeof(string);
        grdRadMov.Columns.Add(colNombre_Completo);
        GridBoundColumn colCorreo = new GridBoundColumn();
        colCorreo.HeaderText = MyTraductor.getTextDTID(141040, "Correo");
        colCorreo.DataField = "Registro_de_Usuario_Correo";
        colCorreo.DataFormatString = "";
        colCorreo.SortExpression = "Registro_de_Usuario.Correo";
        colCorreo.UniqueName = "Registro_de_Usuario.Correo";
        ...
        colContrasena.HeaderText = MyTraductor.getTextDTID(141041, "Contraseña");
        colContrasena.DataField = "Registro_de_Usuario_Contrasena";
        colContrasena.DataFormatString = "";
        colContrasena.SortExpression = "Registro_de_Usuario.Contrasena";
        colContrasena.UniqueName = "Registro_de_Usuario.Contrasena";
        ...
        GridBoundColumn colConfirmar_Contrasena = new GridBoundColumn();
        colConfirmar_Contrasena.HeaderText = MyTraductor.getTextDTID(141042, "Confirmar Contraseña");
        colConfirmar_Contrasena.DataField = "Registro_de_Usuario_Confirmar_Contrasena";
        colConfirmar_Contrasena.DataFormatString = "";
        colConfirmar_Contrasena.SortExpression = "Registro_de_Usuario.Confirmar_Contrasena";
        colConfirmar_Contrasena.UniqueName = "Registro_de_Usuario.Confirmar_Contrasena";
        colConfirmar_Contrasena.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colConfirmar_Contrasena.DataType = typeof(string);
        grdRadMov.Columns.Add(colConfirmar_Contrasena);
        GridBoundColumn colAcepta_Terminos = new GridBoundColumn();
        colAcepta_Terminos.HeaderText = MyTraductor.getTextDTID(141043, "Acepta Términos y Condiciones");
        colAcepta_Terminos.DataField = "Registro_de_Usuario_Acepta_Terminos";
        colAcepta_Terminos.DataFormatString = "";
        colAcepta_Terminos.SortExpression = "Registro_de_Usuario.Acepta_Terminos";
        colAcepta_Terminos.UniqueName = "Registro_de_Usuario.Acepta_Terminos";
        colAcepta_Terminos.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colAcepta_Terminos.DataType = typeof(string);
        grdRadMov.Columns.Add(colAcepta_Terminos);
        GridBoundColumn colFoto_de_Perfil = new GridBoundColumn();
        colFoto_de_Perfil.HeaderText = MyTraductor.getTextDTID(141044, "Foto de Perfil");
        colFoto_de_Perfil.DataField = "Registro_de_Usuario_Foto_de_Perfil";
        colFoto_de_Perfil.DataFormatString = "";
        colFoto_de_Perfil.SortExpression = "Registro_de_Usuario.Foto_de_Perfil";
        colFoto_de_Perfil.UniqueName = "Registro_de_Usuario.Foto_de_Perfil";
        colFoto_de_Perfil.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colFoto_de_Perfil.DataType = typeof(string);
        grdRadMov.Columns.Add(colFoto_de_Perfil);
        //grdMov.Columns[17+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[17+1].ItemStyle.CssClass = "Hide";
        colFoto_de_Perfil.HeaderStyle.CssClass = "Hide";
        colFoto_de_Perfil.ItemStyle.CssClass = "Hide";
        colFoto_de_Perfil.Visible = false;
	        //GridBoundColumn colFoto_de_Perfil_Desc = new GridBoundColumn();
	        //colFoto_de_Perfil_Desc.ButtonType = ButtonType.Link;
	        //colFoto_de_Perfil_Desc.CommandName = "Registro_de_Usuario_Foto_de_Perfil";
	        //colFoto_de_Perfil_Desc.HeaderText = "Foto de Perfil";
	        //colFoto_de_Perfil_Desc.DataTextField = "TTArchivos_Nombre";
	        //colFoto_de_Perfil_Desc.SortExpression = "TTArchivos.Nombre";
	       //colFoto_de_Perfil.UniqueName = "TTArchivos.Nombre";
	       //colFoto_de_Perfil.DataType = typeof(string);
	        //grdRadMov.Columns.Add(colFoto_de_Perfil_Desc);
        GridBoundColumn colUsuario_del_Sistema = new GridBoundColumn();
        colUsuario_del_Sistema.HeaderText = MyTraductor.getTextDTID(141104, "Usuario del Sistema");
        colUsuario_del_Sistema.DataField = "Registro_de_Usuario_Usuario_del_Sistema";
        colUsuario_del_Sistema.DataFormatString = "";
        colUsuario_del_Sistema.SortExpression = "Registro_de_Usuario.Usuario_del_Sistema";
        colUsuario_del_Sistema.UniqueName = "Registro_de_Usuario.Usuario_del_Sistema";
        colUsuario_del_Sistema.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario_del_Sistema.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario_del_Sistema);
        //grdMov.Columns[19+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[19+1].ItemStyle.CssClass = "Hide";
        colUsuario_del_Sistema.HeaderStyle.CssClass = "Hide";
        colUsuario_del_Sistema.ItemStyle.CssClass = "Hide";
        colUsuario_del_Sistema.Visible = false;
        GridBoundColumn colUsuario_del_Sistema_Desc = new GridBoundColumn();
        colUsuario_del_Sistema_Desc.DataField = "Usuario_del_Sistema_Nombre";
        colUsuario_del_Sistema_Desc.HeaderText = MyTraductor.getTextDTID(141104, "Usuario del Sistema");
        colUsuario_del_Sistema_Desc.SortExpression = "Usuario_del_Sistema.Nombre";
        colUsuario_del_Sistema_Desc.UniqueName = "Usuario_del_Sistema.Nombre";
        colUsuario_del_Sistema_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario_del_Sistema_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario_del_Sistema_Desc);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Registro_de_Usuario_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Registro_de_Usuario_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Registro de Usuario&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myRegistro_de_Usuario.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myRegistro_de_Usuario.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myRegistro_de_Usuario.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myRegistro_de_Usuario.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Folio"] = Funcion.RegresaDato("insert into Registro_de_Usuario(Usuario_que_Registra) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Registro_de_Usuario_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myRegistro_de_Usuario.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Registro_de_Usuario&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Registro_de_Usuario_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
