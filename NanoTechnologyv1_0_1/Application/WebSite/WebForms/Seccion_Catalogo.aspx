<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Seccion_Catalogo.aspx.cs" Inherits="WebForms.Seccion_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Sección" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Seccion_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Seccion_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
        ...
        <ContentTemplate>
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" ScrollBars="None" CssClass="rad_tab_strip_tabs_controls" > 
                ...
                <table id="tbDatos_Generales" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">                    
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(141606,30054,0)"></asp:TextBox>
                    ...
                    <tr id="trDescripcion">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblDescripcion" runat="server" Text="Sección: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtDescripcion"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(141607,30054,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVDescripcion" runat="server" ControlToValidate="TxtDescripcion" Display="Dynamic" ErrorMessage="El campo Sección debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVDescripcion" runat="server" ControlToValidate="TxtDescripcion" Display="Dynamic" ErrorMessage="El campo Sección es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Seccion_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Seccion_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Seccion_Catalogo.aspx/' + metodo,
