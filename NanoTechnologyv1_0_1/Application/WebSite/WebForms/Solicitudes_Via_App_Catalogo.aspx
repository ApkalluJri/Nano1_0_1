<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Solicitudes_Via_App_Catalogo.aspx.cs" Inherits="WebForms.Solicitudes_Via_App_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Solicitudes Vía App" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Solicitudes_Via_App_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Solicitudes_Via_App_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtFolio" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(141079,29990,0)"></asp:TextBox>
                    ...
                    <tr id="trUsuario_que_Registra">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlUsuario_que_Registra" runat="server" EnableViewState="true" onchange="EjecutaRN(141080,29990,0)"></asp:DropDownList>
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <telerik:RadDatePicker  MinDate="01/01/1900" ID="txtFecha_de_Registro" runat="server" onkeyup="rad_keyup(this,event);" onkeydown="rad_keydown(this,event);" DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                                    ...
                                                    <DateInput  LabelCssClass="" Width="" ClientEvents-OnLoad="RadDate_Load" DTid="141081" idProceso="29990"
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <telerik:RadTimePicker ID="txtHora_de_Registro" runat="server"  DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                <DateInput DateFormat="HH:mm:ss" DisplayDateFormat="HH:mm:ss" OnChange="OnChangeDateInput(this)"  DTid="141082" idProceso="29990"></DateInput>
                                <ClientEvents>
                                </ClientEvents>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtNombre" TextMode="MultiLine" Rows="2" Columns="100"  runat="server" Font-Names="Arial" onblur="EjecutaRN(146128,29990,0)"></asp:TextBox>
                    ...
                    <tr id="trCorreo">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtCorreo"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(146129,29990,0)"></asp:TextBox>
                    ...
                    <tr id="trOpcion">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblOpcion" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlOpcion" runat="server" EnableViewState="true" onchange="EjecutaRN(141085,29990,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcOpcion" runat="server" IdProceso="29991"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVOpcion" runat="server" ControlToValidate="ddlOpcion" Display="Dynamic" ErrorMessage="El campo Opción es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trDescripcion">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtDescripcion" TextMode="MultiLine" Rows="7" Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(141086,29990,0)"></asp:TextBox>
                    ...
                    <tr id="trLada">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblLada" runat="server" Text="Lada: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblLada" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtLada"  Columns="5"  runat="server" Font-Names="Arial" onblur="EjecutaRN(141087,29990,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVLada" runat="server" ControlToValidate="TxtLada" Display="Dynamic" ErrorMessage="El campo Lada debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVLada" runat="server" ControlToValidate="TxtLada" Display="Dynamic" ErrorMessage="El campo Lada es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trTelefono">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblTelefono" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtTelefono"  Columns="11"  runat="server" Font-Names="Arial" onblur="EjecutaRN(141088,29990,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVTelefono" runat="server" ControlToValidate="TxtTelefono" Display="Dynamic" ErrorMessage="El campo Teléfono debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVTelefono" runat="server" ControlToValidate="TxtTelefono" Display="Dynamic" ErrorMessage="El campo Teléfono es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trEstatus">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlEstatus" runat="server" EnableViewState="true" onchange="EjecutaRN(143367,29990,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcEstatus" runat="server" IdProceso="30328"/>
                    ...
                    <tr id="trObservatorio">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlObservatorio" runat="server" EnableViewState="true" onchange="EjecutaRN(143754,29990,0)"></asp:DropDownList>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Solicitudes_Via_App_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Solicitudes_Via_App_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Solicitudes_Via_App_Catalogo.aspx/' + metodo,
