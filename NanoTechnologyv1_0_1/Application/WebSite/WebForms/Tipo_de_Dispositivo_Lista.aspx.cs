...
Descripción:      Pantalla Lista Tipo_de_Dispositivo
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Tipo_de_Dispositivo_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Tipo_de_Dispositivo";
    const String sDNTDescripcion = "Tipo de Dispositivo";
    const Int32 idProceso = 32545;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=32545 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSTipo_de_Dispositivo.objectBussinessTipo_de_Dispositivo myTipo_de_Dispositivo = new WSTipo_de_Dispositivo.objectBussinessTipo_de_Dispositivo();
                    WSTipo_de_Dispositivo.GlobalData userData = new WSTipo_de_Dispositivo.GlobalData();
                    ...
                    userData.Language = (WSTipo_de_Dispositivo.GlobalDataLanguages)MyUserData.Language;
                    ...
                    Session["Clave"] = Funcion.RegresaDato("insert into Tipo_de_Dispositivo(Tipo) values(null); select @@identity");
                ...
                Response.Redirect("Tipo_de_Dispositivo_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSTipo_de_Dispositivo.GlobalData userData;
        userData = new WSTipo_de_Dispositivo.GlobalData();
        userData.AppToTempFiles = MyUserData.AppToTempFiles;
        userData.ComputerName = MyUserData.ComputerName;
        userData.DatabaseName = MyUserData.DatabaseName;
        userData.Folio = MyUserData.Folio;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(164342, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "Tipo_de_Dispositivo_Clave";
        colClave.SortExpression = "Tipo_de_Dispositivo.Clave";
        colClave.UniqueName = "Tipo_de_Dispositivo.Clave";
        ...
        GridBoundColumn colTipo = new GridBoundColumn();
        colTipo.HeaderText = MyTraductor.getTextDTID(164343, "Tipo");
        colTipo.DataField = "Tipo_de_Dispositivo_Tipo";
        colTipo.DataFormatString = "";
        colTipo.SortExpression = "Tipo_de_Dispositivo.Tipo";
        colTipo.UniqueName = "Tipo_de_Dispositivo.Tipo";
        colTipo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colTipo.DataType = typeof(string);
        grdRadMov.Columns.Add(colTipo);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Tipo_de_Dispositivo_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Tipo_de_Dispositivo_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Tipo de Dispositivo&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myTipo_de_Dispositivo.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myTipo_de_Dispositivo.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myTipo_de_Dispositivo.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myTipo_de_Dispositivo.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        public static JsonResult Consult(string Folio, string Fase)
        {
            try
            {
                ...
                if (Fase != null && Fase != string.Empty)
                    return new JsonResult("Tipo_de_Dispositivo_Catalogo.aspx?Fase=" + Fase, true, null);
                else
                    return new JsonResult("Tipo_de_Dispositivo_Catalogo.aspx", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Clave"] = Funcion.RegresaDato("insert into Tipo_de_Dispositivo(Tipo) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Tipo_de_Dispositivo_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
                        return new JsonResult("Tipo_de_Dispositivo_Catalogo.aspx?MenuVisible=false", true, null);
                }
                else
                {
                    if (Fase != null && Fase != string.Empty)
        ...
        //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myTipo_de_Dispositivo.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Tipo_de_Dispositivo&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        public static JsonResult Select(string Id)
        {
            try
            {
                ...
                return new JsonResult("Tipo_de_Dispositivo_Lista.aspx", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Tipo_de_Dispositivo_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
