<%@ Page Culture="es-MX" UICulture="es-MX" Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Tipo_de_Observatorio_Lista.aspx.cs" Inherits="WebForms.Tipo_de_Observatorio_Lista"
    Theme="SpanishLanguage" Title="Lista de Tipo de Observatorio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="grid_div" style="overflow:scroll">                       
            ...
            <MasterTableView DataKeyNames="Tipo_de_Observatorio_Clave" ClientDataKeyNames="Tipo_de_Observatorio_Clave" CurrentResetPageIndexAction="ReportError"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" > 
                ...
                <DataBinding Location="Tipo_de_Observatorio_Lista.aspx" SelectMethod="GetDataAndCount" EnableCaching="false" >
                </DataBinding>
            </ClientSettings>
            </telerik:RadGrid>                                                    
  </div>
...
function RadGrid_Command(sender, args) {
            ...
            if (command == "Delete") {
                Idelement = args.get_tableView().get_dataItems()[args.get_commandArgument()].getDataKeyValue('Tipo_de_Observatorio_Clave');
                ...
                jQuery.ajax({
                    ...
                    data: '{ Id: "' + sender._clientKeyValues[args.get_commandArgument()].Tipo_de_Observatorio_Clave + '"}',
                    dataType: 'json',
                    url: 'Tipo_de_Observatorio_lista.aspx/Select',
                    success: successCommandRedirect
                });
            }
            else if (command == "Consult") {
                SendFolio(args, 'Tipo_de_Observatorio_lista.aspx/Consult', successCommandRedirect);
            }
            else if (command == "Edit") {
                SendFolio(args, 'Tipo_de_Observatorio_lista.aspx/Edit', successCommandRedirect);
            }
            else if (command == "Print") {
                SendPrint(args, 'Tipo_de_Observatorio_lista.aspx/Print', successCommandPrint);
            }
            ...
            if (sender.value == "") {
                ...
                if (encontro) {
                    ...
                    jQuery.ajax({
                        ...
                        data: sdata,
                        dataType: 'json',
                        url: 'Tipo_de_Observatorio_lista.aspx/GetDataAndCount',
        ...
        function confirmDeleteCallBackFn(arg) {
            ...
            if (id != 0 && arg) {
                ...
                jQuery.ajax({
                    ...
                    data: sdata,
                    dataType: 'json',
                    url: 'Tipo_de_Observatorio_lista.aspx/Delete_Row',
        ...
        function successCommandRedirect(result) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Tipo_de_Observatorio_lista.aspx/New',
                success: successCommandRedirect
            });
        }
        function btn_todosClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'Tipo_de_Observatorio_lista.aspx/GetAllDataAndCount',
                success: successCommandClear
            });
        }
        ...
        function btn_imprimirClick() {
            ...
            jQuery.ajax({
                ...
                data: sdata,
                dataType: 'json',
                url: 'Tipo_de_Observatorio_lista.aspx/PrintAll',
