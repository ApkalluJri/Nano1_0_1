<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="Usuarios_Registrados_en_Observatorios_Catalogo.aspx.cs" Inherits="WebForms.Usuarios_Registrados_en_Observatorios_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de Usuarios Registrados en Observatorios" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Usuarios_Registrados_en_Observatorios_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtClave" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(143410,30330,0)"></asp:TextBox>
                    ...
                    <tr id="trObservatorio">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlObservatorio" runat="server" EnableViewState="true" onchange="EjecutaRN(143411,30330,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcObservatorio" runat="server" IdProceso="29984"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVObservatorio" runat="server" ControlToValidate="ddlObservatorio" Display="Dynamic" ErrorMessage="El campo Observatorio es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trUsuario">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblUsuario" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlUsuario" runat="server" EnableViewState="true" onchange="EjecutaRN(143753,30330,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcUsuario" runat="server" IdProceso="29981"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVUsuario" runat="server" ControlToValidate="ddlUsuario" Display="Dynamic" ErrorMessage="El campo Usuario es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trNombre">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtNombre" TextMode="MultiLine" Rows="2" Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(143412,30330,0)"></asp:TextBox>
                    ...
                    <tr id="trCorreo">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtCorreo"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143413,30330,0)"></asp:TextBox>
                    ...
                    <tr id="trContrasena">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtContrasena"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(143414,30330,0)"></asp:TextBox>
                    ...
                    <tr id="trFecha_de_Ingreso">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblFecha_de_Ingreso" runat="server" Text="Fecha de Ingreso: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblFecha_de_Ingreso" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                            <telerik:RadDatePicker  MinDate="01/01/1900" ID="txtFecha_de_Ingreso" runat="server" onkeyup="rad_keyup(this,event);" onkeydown="rad_keydown(this,event);" DateInput-ClientEvents-OnValueChanged="OnChangeDateRN">
                                                    <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x">
                                                    </Calendar>
                                                    <DateInput  LabelCssClass="" Width="" ClientEvents-OnLoad="RadDate_Load" DTid="143415" idProceso="30330"
                            ...
                            &nbsp;<asp:RequiredFieldValidator ID="RFVFecha_de_Ingreso" runat="server" ControlToValidate="TxtFecha_de_Ingreso" Display="Dynamic" ErrorMessage="El campo Fecha de Ingreso es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trToken">
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtToken"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(164340,30330,0)"></asp:TextBox>
                    ...
                    <tr id="trIdentificador_Dispositivo">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblIdentificador_Dispositivo" runat="server" Text="Identificador Dispositivo: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblIdentificador_Dispositivo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtIdentificador_Dispositivo"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(164341,30330,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVIdentificador_Dispositivo" runat="server" ControlToValidate="TxtIdentificador_Dispositivo" Display="Dynamic" ErrorMessage="El campo Identificador Dispositivo debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVIdentificador_Dispositivo" runat="server" ControlToValidate="TxtIdentificador_Dispositivo" Display="Dynamic" ErrorMessage="El campo Identificador Dispositivo es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trTipo_de_Dispositivo">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblTipo_de_Dispositivo" runat="server" Text="Tipo de Dispositivo: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblTipo_de_Dispositivo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlTipo_de_Dispositivo" runat="server" EnableViewState="true" onchange="EjecutaRN(164344,30330,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcTipo_de_Dispositivo" runat="server" IdProceso="32545"/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVTipo_de_Dispositivo" runat="server" ControlToValidate="ddlTipo_de_Dispositivo" Display="Dynamic" ErrorMessage="El campo Tipo de Dispositivo es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    </tr>
                    <tr id="trEstado_Token">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblEstado_Token" runat="server" Text="Estado Token: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblEstado_Token" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                        <asp:PlaceHolder ID="phEstado_Token2" runat="server">
                          <asp:Panel ID="PnlEstado_Token2" runat="server" Height="100%" Width="100%">
                            <asp:CheckBox ID="ChEstado_Token" runat="server" onclick="EjecutaRN(164345,30330,0)"/>               
                          </asp:Panel>
                        </asp:PlaceHolder>
                               </td>                               
                             </tr>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'Usuarios_Registrados_en_Observatorios_Catalogo.aspx/' + metodo,
