...
Descripción:      Pantalla Lista Usuarios_Registrados_en_Observatorios
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Usuarios_Registrados_en_Observatorios_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Usuarios_Registrados_en_Observatorios";
    const String sDNTDescripcion = "Usuarios Registrados en Observatorios";
    const Int32 idProceso = 30330;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=30330 and idoperacion=7");
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    WSUsuarios_Registrados_en_Observatorios.GlobalData userData = new WSUsuarios_Registrados_en_Observatorios.GlobalData();
                    ...
                    Session["Clave"] = Funcion.RegresaDato("insert into Usuarios_Registrados_en_Observatorios(Observatorio) values(null); select @@identity");
                ...
                Response.Redirect("Usuarios_Registrados_en_Observatorios_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        WSUsuarios_Registrados_en_Observatorios.GlobalData userData;
    ...
    { 
        ...
        colClave.HeaderText = MyTraductor.getTextDTID(143410, "Clave");
        colClave.HtmlEncode = false;
        colClave.DataField = "Usuarios_Registrados_en_Observatorios_Clave";
        colClave.SortExpression = "Usuarios_Registrados_en_Observatorios.Clave";
        colClave.UniqueName = "Usuarios_Registrados_en_Observatorios.Clave";
        ...
        colObservatorio.HeaderText = MyTraductor.getTextDTID(143411, "Observatorio");
        colObservatorio.DataField = "Usuarios_Registrados_en_Observatorios_Observatorio";
        colObservatorio.DataFormatString = "";
        colObservatorio.SortExpression = "Usuarios_Registrados_en_Observatorios.Observatorio";
        colObservatorio.UniqueName = "Usuarios_Registrados_en_Observatorios.Observatorio";
        ...
        colObservatorio_Desc.HeaderText = MyTraductor.getTextDTID(143411, "Observatorio");
        ...
        GridBoundColumn colUsuario = new GridBoundColumn();
        colUsuario.HeaderText = MyTraductor.getTextDTID(143753, "Usuario");
        colUsuario.DataField = "Usuarios_Registrados_en_Observatorios_Usuario";
        colUsuario.DataFormatString = "";
        colUsuario.SortExpression = "Usuarios_Registrados_en_Observatorios.Usuario";
        colUsuario.UniqueName = "Usuarios_Registrados_en_Observatorios.Usuario";
        colUsuario.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario);
        //grdMov.Columns[8+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[8+1].ItemStyle.CssClass = "Hide";
        colUsuario.HeaderStyle.CssClass = "Hide";
        colUsuario.ItemStyle.CssClass = "Hide";
        colUsuario.Visible = false;
        GridBoundColumn colUsuario_Desc = new GridBoundColumn();
        colUsuario_Desc.DataField = "Usuario_Nombre";
        colUsuario_Desc.HeaderText = MyTraductor.getTextDTID(143753, "Usuario");
        colUsuario_Desc.SortExpression = "Usuario.Nombre";
        colUsuario_Desc.UniqueName = "Usuario.Nombre";
        colUsuario_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuario_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuario_Desc);
        GridBoundColumn colNombre = new GridBoundColumn();
        colNombre.HeaderText = MyTraductor.getTextDTID(143412, "Nombre");
        colNombre.DataField = "Usuarios_Registrados_en_Observatorios_Nombre";
        colNombre.DataFormatString = "";
        colNombre.SortExpression = "Usuarios_Registrados_en_Observatorios.Nombre";
        colNombre.UniqueName = "Usuarios_Registrados_en_Observatorios.Nombre";
        ...
        colCorreo.HeaderText = MyTraductor.getTextDTID(143413, "Correo");
        colCorreo.DataField = "Usuarios_Registrados_en_Observatorios_Correo";
        colCorreo.DataFormatString = "";
        colCorreo.SortExpression = "Usuarios_Registrados_en_Observatorios.Correo";
        colCorreo.UniqueName = "Usuarios_Registrados_en_Observatorios.Correo";
        colCorreo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colCorreo.DataType = typeof(string);
        grdRadMov.Columns.Add(colCorreo);
        GridBoundColumn colContrasena = new GridBoundColumn();
        colContrasena.HeaderText = MyTraductor.getTextDTID(143414, "Contraseña");
        colContrasena.DataField = "Usuarios_Registrados_en_Observatorios_Contrasena";
        colContrasena.DataFormatString = "";
        colContrasena.SortExpression = "Usuarios_Registrados_en_Observatorios.Contrasena";
        colContrasena.UniqueName = "Usuarios_Registrados_en_Observatorios.Contrasena";
        colContrasena.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colContrasena.DataType = typeof(string);
        grdRadMov.Columns.Add(colContrasena);
        GridBoundColumn colFecha_de_Ingreso = new GridBoundColumn();
        colFecha_de_Ingreso.DataField = "Usuarios_Registrados_en_Observatorios_Fecha_de_Ingreso";
        colFecha_de_Ingreso.HeaderText = MyTraductor.getTextDTID(143415, "Fecha de Ingreso");
        colFecha_de_Ingreso.SortExpression = "Usuarios_Registrados_en_Observatorios.Fecha_de_Ingreso";
        colFecha_de_Ingreso.UniqueName = "Usuarios_Registrados_en_Observatorios.Fecha_de_Ingreso";
        colFecha_de_Ingreso.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colFecha_de_Ingreso.DataFormatString = "{0:" + System.Configuration.ConfigurationSettings.AppSettings["FormatoFechaGrid"].ToString() + "}";
        colFecha_de_Ingreso.DataType = typeof(DateTime);
        grdRadMov.Columns.Add(colFecha_de_Ingreso);
        GridBoundColumn colToken = new GridBoundColumn();
        colToken.HeaderText = MyTraductor.getTextDTID(164340, "Token");
        colToken.DataField = "Usuarios_Registrados_en_Observatorios_Token";
        colToken.DataFormatString = "";
        colToken.SortExpression = "Usuarios_Registrados_en_Observatorios.Token";
        colToken.UniqueName = "Usuarios_Registrados_en_Observatorios.Token";
        colToken.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colToken.DataType = typeof(string);
        grdRadMov.Columns.Add(colToken);
        GridBoundColumn colIdentificador_Dispositivo = new GridBoundColumn();
        colIdentificador_Dispositivo.HeaderText = MyTraductor.getTextDTID(164341, "Identificador Dispositivo");
        colIdentificador_Dispositivo.DataField = "Usuarios_Registrados_en_Observatorios_Identificador_Dispositivo";
        colIdentificador_Dispositivo.DataFormatString = "";
        colIdentificador_Dispositivo.SortExpression = "Usuarios_Registrados_en_Observatorios.Identificador_Dispositivo";
        colIdentificador_Dispositivo.UniqueName = "Usuarios_Registrados_en_Observatorios.Identificador_Dispositivo";
        colIdentificador_Dispositivo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colIdentificador_Dispositivo.DataType = typeof(string);
        grdRadMov.Columns.Add(colIdentificador_Dispositivo);
        GridBoundColumn colTipo_de_Dispositivo = new GridBoundColumn();
        colTipo_de_Dispositivo.HeaderText = MyTraductor.getTextDTID(164344, "Tipo de Dispositivo");
        colTipo_de_Dispositivo.DataField = "Usuarios_Registrados_en_Observatorios_Tipo_de_Dispositivo";
        colTipo_de_Dispositivo.DataFormatString = "";
        colTipo_de_Dispositivo.SortExpression = "Usuarios_Registrados_en_Observatorios.Tipo_de_Dispositivo";
        colTipo_de_Dispositivo.UniqueName = "Usuarios_Registrados_en_Observatorios.Tipo_de_Dispositivo";
        colTipo_de_Dispositivo.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colTipo_de_Dispositivo.DataType = typeof(string);
        grdRadMov.Columns.Add(colTipo_de_Dispositivo);
        //grdMov.Columns[16+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[16+1].ItemStyle.CssClass = "Hide";
        colTipo_de_Dispositivo.HeaderStyle.CssClass = "Hide";
        colTipo_de_Dispositivo.ItemStyle.CssClass = "Hide";
        colTipo_de_Dispositivo.Visible = false;
        GridBoundColumn colTipo_de_Dispositivo_Desc = new GridBoundColumn();
        colTipo_de_Dispositivo_Desc.DataField = "Tipo_de_Dispositivo_Tipo";
        colTipo_de_Dispositivo_Desc.HeaderText = MyTraductor.getTextDTID(164344, "Tipo de Dispositivo");
        colTipo_de_Dispositivo_Desc.SortExpression = "Tipo_de_Dispositivo.Tipo";
        colTipo_de_Dispositivo_Desc.UniqueName = "Tipo_de_Dispositivo.Tipo";
        colTipo_de_Dispositivo_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colTipo_de_Dispositivo_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colTipo_de_Dispositivo_Desc);
        GridBoundColumn colEstado_Token = new GridBoundColumn();
        colEstado_Token.HeaderText = MyTraductor.getTextDTID(164345, "Estado Token");
        colEstado_Token.DataField = "Usuarios_Registrados_en_Observatorios_Estado_Token";
        colEstado_Token.DataFormatString = "";
        colEstado_Token.SortExpression = "Usuarios_Registrados_en_Observatorios.Estado_Token";
        colEstado_Token.UniqueName = "Usuarios_Registrados_en_Observatorios.Estado_Token";
        colEstado_Token.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colEstado_Token.DataType = typeof(string);
        grdRadMov.Columns.Add(colEstado_Token);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Usuarios_Registrados_en_Observatorios_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Usuarios_Registrados_en_Observatorios_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Usuarios Registrados en Observatorios&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myUsuarios_Registrados_en_Observatorios.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myUsuarios_Registrados_en_Observatorios.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myUsuarios_Registrados_en_Observatorios.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myUsuarios_Registrados_en_Observatorios.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Clave"] = Funcion.RegresaDato("insert into Usuarios_Registrados_en_Observatorios(Observatorio) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Usuarios_Registrados_en_Observatorios_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myUsuarios_Registrados_en_Observatorios.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Usuarios_Registrados_en_Observatorios&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Usuarios_Registrados_en_Observatorios_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
