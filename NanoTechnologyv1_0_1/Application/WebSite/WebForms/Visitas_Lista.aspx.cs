...
Descripción:      Pantalla Lista Visitas
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{
public partial class Visitas_Lista : TTBasePage.TTBasePage
{
    public string sortExpression_;
    public string sortDirection_;
    const String sDNTNombre = "Visitas";
    const String sDNTDescripcion = "Visitas";
    const Int32 idProceso = 41560;
	...
	if (Request["pf"] != null && Request["Fase"] != null)
            if(Request["pf"].ToString() == "1")
            {
                ...
                SqlCommand com = new SqlCommand("Select * from ttpermisos_por_proceso where idproceso=41560 and idoperacion=7");
                com.CommandType = CommandType.Text;
                DataSet ds = db.Consulta(com);
                if (ds.Tables[0].Rows.Count>0)
                {
                    WSVisitas.objectBussinessVisitas myVisitas = new WSVisitas.objectBussinessVisitas();
                    WSVisitas.GlobalData userData = new WSVisitas.GlobalData();
                    ...
                    Session["Folio"] = Funcion.RegresaDato("insert into Visitas(Fecha_de_visita) values(null); select @@identity");
                ...
                Response.Redirect("Visitas_Catalogo.aspx?pf=1&Fase=" + Request["Fase"].ToString());
            }        
    ...
    private void SetLanguage() 
    {
        try
        {
            ...
            //TODO:WEBFORMS/Visitas_LISTA.ASPX INICIO SETLANGUAGE() LINEA 103 JZAMORA
            ...
            #endregion
            //TODO:WEBFORMS/Visitas_LISTA.ASPX END SetLanguage() LINEA 127 JZAMORA
    ...
    { 
        ...
        colFolio.HeaderText = MyTraductor.getTextDTID(235565, "Folio");
        colFolio.HtmlEncode = false;
        colFolio.DataField = "Visitas_Folio";
        colFolio.SortExpression = "Visitas.Folio";
        colFolio.UniqueName = "Visitas.Folio";
        ...
        GridBoundColumn colFecha_de_visita = new GridBoundColumn();
        colFecha_de_visita.DataField = "Visitas_Fecha_de_visita";
        colFecha_de_visita.HeaderText = MyTraductor.getTextDTID(235572, "Fecha de visita");
        colFecha_de_visita.SortExpression = "Visitas.Fecha_de_visita";
        colFecha_de_visita.UniqueName = "Visitas.Fecha_de_visita";
        colFecha_de_visita.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colFecha_de_visita.DataFormatString = "{0:" + System.Configuration.ConfigurationSettings.AppSettings["FormatoFechaGrid"].ToString() + "}";
        colFecha_de_visita.DataType = typeof(DateTime);
        grdRadMov.Columns.Add(colFecha_de_visita);
        GridBoundColumn colHora_de_visita = new GridBoundColumn();
        colHora_de_visita.HeaderText = MyTraductor.getTextDTID(235573, "Hora de visita");
        colHora_de_visita.DataField = "Visitas_Hora_de_visita";
        colHora_de_visita.DataFormatString = "";
        colHora_de_visita.SortExpression = "Visitas.Hora_de_visita";
        colHora_de_visita.UniqueName = "Visitas.Hora_de_visita";
        colHora_de_visita.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colHora_de_visita.DataType = typeof(string);
        grdRadMov.Columns.Add(colHora_de_visita);
        GridBoundColumn colContenidoId = new GridBoundColumn();
        colContenidoId.HeaderText = MyTraductor.getTextDTID(235578, "ContenidoId");
        colContenidoId.DataField = "Visitas_ContenidoId";
        colContenidoId.DataFormatString = "";
        colContenidoId.SortExpression = "Visitas.ContenidoId";
        colContenidoId.UniqueName = "Visitas.ContenidoId";
        colContenidoId.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colContenidoId.DataType = typeof(string);
        grdRadMov.Columns.Add(colContenidoId);
        //grdMov.Columns[8+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[8+1].ItemStyle.CssClass = "Hide";
        colContenidoId.HeaderStyle.CssClass = "Hide";
        colContenidoId.ItemStyle.CssClass = "Hide";
        colContenidoId.Visible = false;
        GridBoundColumn colContenidoId_Desc = new GridBoundColumn();
        colContenidoId_Desc.DataField = "ContenidoId_Descripcion";
        colContenidoId_Desc.HeaderText = MyTraductor.getTextDTID(235578, "ContenidoId");
        colContenidoId_Desc.SortExpression = "ContenidoId.Descripcion";
        colContenidoId_Desc.UniqueName = "ContenidoId.Descripcion";
        colContenidoId_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colContenidoId_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colContenidoId_Desc);
        GridBoundColumn colUsuarioId = new GridBoundColumn();
        colUsuarioId.HeaderText = MyTraductor.getTextDTID(235579, "UsuarioId");
        colUsuarioId.DataField = "Visitas_UsuarioId";
        colUsuarioId.DataFormatString = "";
        colUsuarioId.SortExpression = "Visitas.UsuarioId";
        colUsuarioId.UniqueName = "Visitas.UsuarioId";
        colUsuarioId.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuarioId.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuarioId);
        //grdMov.Columns[10+1].HeaderStyle.CssClass = "Hide";
        //grdMov.Columns[10+1].ItemStyle.CssClass = "Hide";
        colUsuarioId.HeaderStyle.CssClass = "Hide";
        colUsuarioId.ItemStyle.CssClass = "Hide";
        colUsuarioId.Visible = false;
        GridBoundColumn colUsuarioId_Desc = new GridBoundColumn();
        colUsuarioId_Desc.DataField = "UsuarioId_Nombre_Completo";
        colUsuarioId_Desc.HeaderText = MyTraductor.getTextDTID(235579, "UsuarioId");
        colUsuarioId_Desc.SortExpression = "UsuarioId.Nombre_Completo";
        colUsuarioId_Desc.UniqueName = "UsuarioId.Nombre_Completo";
        colUsuarioId_Desc.ItemStyle.HorizontalAlign = HorizontalAlign.Left;
        colUsuarioId_Desc.DataType = typeof(string);
        grdRadMov.Columns.Add(colUsuarioId_Desc);
    ...
    protected void cmdNew_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request["MenuVisible"] != null)
            Response.Redirect("Visitas_Catalogo.aspx?MenuVisible=false");
        else
            Response.Redirect("Visitas_Catalogo.aspx");
    }
    ...
    protected void cmdExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["dsGrid"] = grid;
        rwExport.NavigateUrl = "../FormsSystem/TTExporta.aspx?Titulo=Lista de Visitas&process="+idProceso.ToString()+"&brOperation=Export";
        ...
        string sQ = myVisitas.ListaGetFullQuery(swhere, new GridGenericSorter(sortExpression).GetOrder());
...
[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        if (HttpContext.Current.Session["OrderFromBR"] != null)
        {
            ...
            foreach (GridSortExpression item in OrderFromBR)
            {
                ...
                DataSet dat = myVisitas.ListaSelAll(startRowIndex, maximumRows, swhere, new GridGenericSorter(sortExpression).GetOrder());

                data.Add("Data", JsonMethods.RowsToDictionary(dat.Tables[0]));
                data.Add("Count", myVisitas.ListaSelCount(swhere));
                return data;
            }
            catch (Exception ex)
            {
        ...
        public static JsonResult Delete_Row(string Folio, int startRowIndex, int maximumRows, List<GridSortExpression> sortExpression, List<GridFilterExpression> filterExpression, string faseworkflow)
        {
            try
            {
                ...
                userData.UserName = MyUserData.UserName;
                userData.WindowsVersion = MyUserData.WindowsVersion;
                myVisitas.Delete(userData, MyFunctions.FormatNumberNull(Folio));
        ...
        //TODO:WEBFORMS/Visitas_LISTA.ASPX.CS INICIO New() LINEA 1446 JZAMORA
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod(EnableSession = true)]
        public static JsonResult New(bool MenuVisible, string Fase)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count>0)
                {
                    ...
                    userData.UserName = MyUserData.UserName;
                    userData.WindowsVersion = MyUserData.WindowsVersion;
                    HttpContext.Current.Session["Folio"] = Funcion.RegresaDato("insert into Visitas(Fecha_de_visita) values(null); select @@identity");
                    HttpContext.Current.Session["Tipo_Transaccion"] = "Update";
                }
                else
                {
                ...
                {
                    if (Fase != null && Fase != string.Empty)
                        return new JsonResult("Visitas_Catalogo.aspx?MenuVisible=false&Fase=" + Fase, true, null);
                    else
        ...
        //TODO:WEBFORMS/Visitas_LISTA.ASPX.CS FIN New() LINEA 1476 JZAMORA
...

        {
            try
            {
                ...
                DataTable dat = myVisitas.ImpresionSelAll(swhere, new GridGenericSorter(sortExpression).GetOrder()).Tables[0];
            Again:
                ...
                //ApplyBusinessRules(TTenumBusinessRules_Operacion.Print, TTenumBusinessRules_ProcessEvent.AfterSave, idProceso);
                //---------------------------------------------------------------------------------------------------------------           
                return new JsonResult("../FormsSystem/TTExportaRad.aspx?Titulo=Lista de Visitas&PrintDialog=true&process=" + idProceso.ToString() + "&brOperation=Print", true, null);
            }
            catch (Exception ex)
            {
                return new JsonResult(null, false, ex.Message.ToString());
        ...
        //TODO:WEBFORMS/Visitas_LISTA.ASPX.CS INICIO #region WorkFlows LINEA 1525 JZAMORA
        #region WorkFlows
        ...
        public static string ttWorkFlowAplicaCondiciones(string strFase)
      {
        ...
        #endregion
        //TODO:WEBFORMS/Visitas_LISTA.ASPX.CS FIN #region WorkFlows LINEA 1626 JZAMORA
    }
