<%@ Page Language="C#" MasterPageFile="~/WebForms/DefaultMasterCatalogosRad.master"
    AutoEventWireup="true" CodeFile="ttusuarios_token_Catalogo.aspx.cs" Inherits="WebForms.ttusuarios_token_Catalogo"
    Theme="SpanishLanguage" Title="Catálogo de ttusuarios token" %>
...
<script type="text/javascript">
    ...
    function TrapKey(obj, e) {
        ...
        function validatipo(file, ext, estatus) {
            ...
            function clickverarchivo(objfile) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ttusuarios_token_Catalogo.aspx/SetSession",
                    data: '{value: "' + value + '" }',
    ...
    function EnviaDato(commandName,multiRenlgonName, controlId, Skey, ValueData, columName) {
        jQuery.ajax({
            ...
            dataType: 'json',
            url: 'ttusuarios_token_Catalogo.aspx/EnviaDato',
            success: OnSuccess
        });
        ...
        <ContentTemplate>
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" ScrollBars="None" CssClass="rad_tab_strip_tabs_controls" > 
                ...
                <table id="tbDatos_Generales" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">                    
                        ...
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                              ...
                              <asp:TextBox ID="txtFolio" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(183881,34793,0)"></asp:TextBox>
                    ...
                    <tr id="trUsuario_Token_Campo">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblUsuario_Token_Campo" runat="server" Text="Usuario Token: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblUsuario_Token_Campo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtUsuario_Token_Campo" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(183882,34793,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVUsuario_Token_Campo" runat="server" ControlToValidate="TxtUsuario_Token_Campo" Display="Dynamic" ErrorMessage="El campo Usuario Token debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVUsuario_Token_Campo" runat="server" ErrorMessage="El campo Usuario Token es obligatorio" ControlToValidate="TxtUsuario_Token_Campo" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trId_Usuario">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblId_Usuario" runat="server" Text="Id Usuario: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblId_Usuario" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtId_Usuario" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(183883,34793,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVId_Usuario" runat="server" ControlToValidate="TxtId_Usuario" Display="Dynamic" ErrorMessage="El campo Id Usuario debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVId_Usuario" runat="server" ErrorMessage="El campo Id Usuario es obligatorio" ControlToValidate="TxtId_Usuario" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trToken">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblToken" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtToken" TextMode="MultiLine" Rows="2" Columns="80" runat="server" Font-Names="Arial" onkeypress="keypress(event,this)" onkeyUp="maximo_largo(this)" onblur="EjecutaRN(183884,34793,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVToken" runat="server" ControlToValidate="TxtToken" Display="Dynamic" ErrorMessage="El campo Token debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVToken" runat="server" ControlToValidate="TxtToken" Display="Dynamic" ErrorMessage="El campo Token es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    </tr>
                    <tr id="trIdentificador">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblIdentificador" runat="server" Text="Identificador: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblIdentificador" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                             <asp:TextBox ID="txtIdentificador"  Columns="50"  runat="server" Font-Names="Arial" onblur="EjecutaRN(183885,34793,0)"></asp:TextBox>
                             &nbsp;<asp:CompareValidator ID="CVIdentificador" runat="server" ControlToValidate="TxtIdentificador" Display="Dynamic" ErrorMessage="El campo Identificador debe ser de tipo Texto" Operator="DataTypeCheck"></asp:CompareValidator>
                             &nbsp;<asp:RequiredFieldValidator ID="RFVIdentificador" runat="server" ControlToValidate="TxtIdentificador" Display="Dynamic" ErrorMessage="El campo Identificador es obligatorio" Enabled="False" style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                    ...
                    <tr id="trEstado_Logico">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblEstado_Logico" runat="server" Text="Estado Logico: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblEstado_Logico" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                        <asp:PlaceHolder ID="phEstado_Logico2" runat="server">
                          <asp:Panel ID="PnlEstado_Logico2" runat="server" Height="100%" Width="100%">
                            <asp:CheckBox ID="ChEstado_Logico" runat="server" onclick="EjecutaRN(183886,34793,0)"/>               
                          </asp:Panel>
                        </asp:PlaceHolder>
                               </td>                               
                             </tr>
                    ...
                    <tr id="trTipoDispositivo">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblTipoDispositivo" runat="server" Text="TipoDispositivo: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblTipoDispositivo" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtTipoDispositivo" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(183887,34793,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVTipoDispositivo" runat="server" ControlToValidate="TxtTipoDispositivo" Display="Dynamic" ErrorMessage="El campo TipoDispositivo debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVTipoDispositivo" runat="server" ErrorMessage="El campo TipoDispositivo es obligatorio" ControlToValidate="TxtTipoDispositivo" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    </tr>
                    <tr id="trId_Usuario_TTUsuarios">
                        <td valign="middle" class="columna1_empty" style="width: 34%;">
                            <asp:Label ID="lblId_Usuario_TTUsuarios" runat="server" Text="Id Usuario TTUsuarios: "></asp:Label>
                        </td>
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblId_Usuario_TTUsuarios" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
    <asp:DropDownList ID="ddlId_Usuario_TTUsuarios" runat="server" EnableViewState="true" onchange="EjecutaRN(183888,34793,0)"></asp:DropDownList>
                            &nbsp;<uc1:TTbuttonCatalogo ID="TTbcId_Usuario_TTUsuarios" runat="server" IdProceso=""/>
                            &nbsp;<asp:RequiredFieldValidator ID="RFVId_Usuario_TTUsuarios" runat="server" ControlToValidate="ddlId_Usuario_TTUsuarios" Display="Dynamic" ErrorMessage="El campo Id Usuario TTUsuarios es obligatorio" Style="vertical-align: super">Requerido</asp:RequiredFieldValidator>
                               </td>                               
                             </tr>
                           </table>
                        </td>
                    ...
                    <tr id="trId">
                        ...
                        <td class="icon_labels" valign="middle" style="width: 1%;">
                            <asp:Image ID="imgOblId" runat="server" ImageUrl="~/Images/Design/green_arrow.png" />
                        </td>
                        <td class="columna_controls" valign="middle" style="width: 65%;">
                           <table width="380px" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                               <td class="control_style">
                              <asp:TextBox ID="txtId" Columns="9"   runat="server" Font-Names="Arial" onblur="EjecutaRN(183889,34793,0)"></asp:TextBox>
                              &nbsp;<asp:CompareValidator ID="CVId" runat="server" ControlToValidate="TxtId" Display="Dynamic" ErrorMessage="El campo Id debe ser de tipo Numerico" Operator="DataTypeCheck" Type="Integer" ValidationGroup="none" Style="vertical-align: super"></asp:CompareValidator>&nbsp;&nbsp;
                              &nbsp;<asp:RequiredFieldValidator ID="RFVId" runat="server" ErrorMessage="El campo Id es obligatorio" ControlToValidate="TxtId" Display="Dynamic" Style="vertical-align: super" >Requerido</asp:RequiredFieldValidator>&nbsp;
                               </td>                               
                             </tr>
                           </table>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function btn_cmdCloseClick() {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/Cancel',
        ...
        function btn_cmdClearClick() {
            ...
            jQuery.ajax({
                ...
                data: '{ MenuVisible: ' + MenuVisible + ', pf: ' + pf + ' ,Fase:"' + Fase + '"}',
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/Clear',
                success: successCommandRedirect
            });
        }
        ...
        function EjecutaRN(DTid, idProceso, indexRow) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/EvaluaRN',
                success: evaluaRN
            });
        }
        ...
        function EjecutaQuery(query) {
            jQuery.ajax({
                ...
                data: '{ Query: "' + query + '"}',
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/EjecutaQuery',
                success: QueryRN
            });
        }
        ...
        function SetSessionName(NombreVariable, Valor) {
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/AsignaVariableGlobal',
        ...
        function GetSessionName(NombreVariable) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/ObtenVariableGlobal',
       ...
       function findNextBracket(cadena, startIndex) {
                ...
                if (combo != null) {
                    ...
                    try {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: 'json',
                            url: 'ttusuarios_token_Catalogo.aspx/setValueToRadComboBox',
                            success: function(Result) {
                                desc = Result.d.data;
                            },
        ...
        function FiltraCombo(controlname, query) {
            try {
                jQuery.ajax({
                    ...
                    data: '{ Query: "' + query + '"}',
                    dataType: 'json',
                    url: 'ttusuarios_token_Catalogo.aspx/FiltraCombo',
                    success: function(Result) {
                    Result = Result.d;
        ...
        function autoPopulateGrid(querySQL, metodo) {
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                url: 'ttusuarios_token_Catalogo.aspx/' + metodo,
