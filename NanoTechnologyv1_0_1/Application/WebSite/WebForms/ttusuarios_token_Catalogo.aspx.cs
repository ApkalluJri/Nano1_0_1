...
Descripción:      Pantalla Catalogo ttusuarios_token
**************************************************************************************************/
using System;
using System.Data;
...
namespace WebForms
{	
public partial class ttusuarios_token_Catalogo : TTBasePage.TTBasePage, ICallbackEventHandler 
{
    private WSttusuarios_token.objectBussinessttusuarios_token myttusuarios_token = new WSttusuarios_token.objectBussinessttusuarios_token();
    private WSttusuarios_token.GlobalData userData;
    public int iProcess = 34793;
    private String sDNTNombre = "ttusuarios_token";
    private String sDNTDescripcion = "ttusuarios token";
...
#region CallBackAsincrono
    ...
    protected void DisableControls()    
    {
        ...
        txtUsuario_Token_Campo.Enabled=false;
        txtId_Usuario.Enabled=false;
        txtToken.Enabled=false;
        txtIdentificador.Enabled=false;
        ChEstado_Logico.Enabled=false;
        txtTipoDispositivo.Enabled=false;
        ddlId_Usuario_TTUsuarios.Enabled=false;
        TTbcId_Usuario_TTUsuarios.ImgButton.Visible = false;
    ...
    {
        WSttusuarios_token.objectBussinessttusuarios_token1 myDatattusuarios_token = myttusuarios_token.GetByKey(MyFunctions.FormatNumberNull(Session["Folio"].ToString()), true);
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        //-------------------------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------
        TTbcId_Usuario_TTUsuarios.WebControl = ddlId_Usuario_TTUsuarios;
        TTbcId_Usuario_TTUsuarios.FillDataControlFunction = MyFunctions.FillDataControl;
        TTbcId_Usuario_TTUsuarios.GetControlDataSetFunctionWithString = myttusuarios_token.FillDataId_Usuario_TTUsuarios;
        TTbcId_Usuario_TTUsuarios.ParentWebControl = null;
    ...
    {
                MyFunctions.FillDataControl(ddlId_Usuario_TTUsuarios, myttusuarios_token.FillDataId_Usuario_TTUsuarios(""));
    ...
    {
        WSttusuarios_token.objectBussinessttusuarios_token1 myDatattusuarios_token = myttusuarios_token.GetByKey(MyFunctions.FormatNumberNull(Session["Folio"].ToString()),true);
                if (myDatattusuarios_token.Folio.HasValue)
            txtFolio.Text = myDatattusuarios_token.Folio.ToString();
        if (myDatattusuarios_token.Usuario_Token_Campo.HasValue)
            txtUsuario_Token_Campo.Text = myDatattusuarios_token.Usuario_Token_Campo.ToString();
        if (myDatattusuarios_token.Id_Usuario.HasValue)
            txtId_Usuario.Text = myDatattusuarios_token.Id_Usuario.ToString();
        txtToken.Text = myDatattusuarios_token.Token;
        txtIdentificador.Text = myDatattusuarios_token.Identificador;
       ChEstado_Logico.Checked  = myDatattusuarios_token.Estado_Logico;
        if (myDatattusuarios_token.TipoDispositivo.HasValue)
            txtTipoDispositivo.Text = myDatattusuarios_token.TipoDispositivo.ToString();
        if (myDatattusuarios_token.Id_Usuario_TTUsuarios.HasValue)
           ddlId_Usuario_TTUsuarios.SelectedValue = myDatattusuarios_token.Id_Usuario_TTUsuarios.Value.ToString().TrimEnd(' ');
        //ddlId_Usuario_TTUsuarios_SelectedIndexChanged(ddlId_Usuario_TTUsuarios, new EventArgs());
        if (myDatattusuarios_token.Id.HasValue)
            txtId.Text = myDatattusuarios_token.Id.ToString();
    ...
    public void ConfigWithMetadata()
    {
        ...
        DataView dv = new DataView(ds_controles.Tables[0]);
                ...
                dv.RowFilter = "TTMetadata_DTID = " + 183881;
        ...
        lblFolio.Text = MyTraductor.getTextDTID(183881, lblFolio.Text);
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trFolio.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183882;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblUsuario_Token_Campo.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblUsuario_Token_Campo.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblUsuario_Token_Campo.Text = MyTraductor.getTextDTID(183882, lblUsuario_Token_Campo.Text);
        txtUsuario_Token_Campo.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtUsuario_Token_Campo.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtUsuario_Token_Campo.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtUsuario_Token_Campo.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtUsuario_Token_Campo.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
                ...
                txtUsuario_Token_Campo.Text = "";
            }
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblUsuario_Token_Campo.Style["display"] = "auto";
        else
            imgOblUsuario_Token_Campo.Style["display"] = "none";
        RFVUsuario_Token_Campo.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trUsuario_Token_Campo.Style["display"] = "auto";
        else
            trUsuario_Token_Campo.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183883;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblId_Usuario.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblId_Usuario.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblId_Usuario.Text = MyTraductor.getTextDTID(183883, lblId_Usuario.Text);
        txtId_Usuario.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtId_Usuario.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtId_Usuario.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtId_Usuario.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtId_Usuario.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblId_Usuario.Style["display"] = "auto";
        else
            imgOblId_Usuario.Style["display"] = "none";
        RFVId_Usuario.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trId_Usuario.Style["display"] = "auto";
        else
            trId_Usuario.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183884;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
        ...
        lblToken.Text = MyTraductor.getTextDTID(183884, lblToken.Text);
	...
	txtToken.Attributes.Add("MaxLength", dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            ...
            trToken.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183885;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblIdentificador.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblIdentificador.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblIdentificador.Text = MyTraductor.getTextDTID(183885, lblIdentificador.Text);
        txtIdentificador.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtIdentificador.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtIdentificador.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtIdentificador.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtIdentificador.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblIdentificador.Style["display"] = "auto";
        else
            imgOblIdentificador.Style["display"] = "none";
        RFVIdentificador.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trIdentificador.Style["display"] = "auto";
        else
            trIdentificador.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183886;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblEstado_Logico.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblEstado_Logico.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblEstado_Logico.Text = MyTraductor.getTextDTID(183886, lblEstado_Logico.Text);
        ChEstado_Logico.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ChEstado_Logico.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() == "1"){
            	ChEstado_Logico.Checked = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString());
            }else{
                ChEstado_Logico.Checked = false;
            }
        }else{
            ChEstado_Logico.Checked = false;
        }
        imgOblEstado_Logico.Style["display"] = "none";
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trEstado_Logico.Style["display"] = "auto";
        else
            trEstado_Logico.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183887;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblTipoDispositivo.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblTipoDispositivo.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblTipoDispositivo.Text = MyTraductor.getTextDTID(183887, lblTipoDispositivo.Text);
        txtTipoDispositivo.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtTipoDispositivo.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtTipoDispositivo.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtTipoDispositivo.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtTipoDispositivo.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblTipoDispositivo.Style["display"] = "auto";
        else
            imgOblTipoDispositivo.Style["display"] = "none";
        RFVTipoDispositivo.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trTipoDispositivo.Style["display"] = "auto";
        else
            trTipoDispositivo.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183888;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblId_Usuario_TTUsuarios.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblId_Usuario_TTUsuarios.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblId_Usuario_TTUsuarios.Text = MyTraductor.getTextDTID(183888, lblId_Usuario_TTUsuarios.Text);
        ddlId_Usuario_TTUsuarios.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        ddlId_Usuario_TTUsuarios.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        TTbcId_Usuario_TTUsuarios.Visible = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
        {
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                {
                    ddlId_Usuario_TTUsuarios.SelectedValue = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                }
                else
                {
                    ddlId_Usuario_TTUsuarios.SelectedValue = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                }
            }
            else
            {
                ...
                ddlId_Usuario_TTUsuarios.SelectedValue = "";
        }
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblId_Usuario_TTUsuarios.Style["display"] = "auto";
        else
            imgOblId_Usuario_TTUsuarios.Style["display"] = "none";
        RFVId_Usuario_TTUsuarios.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trId_Usuario_TTUsuarios.Style["display"] = "auto";
        else
            trId_Usuario_TTUsuarios.Style["display"] = "none";        dv.RowFilter = "TTMetadata_DTID = " + 183889;
        if (dv.ToTable().Rows[0]["TTMetadata_Descripcion"] is DBNull || dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString() == "")
            lblId.Text = dv.ToTable().Rows[0]["TTMetadata_Nombre"].ToString();
        else
            lblId.Text = dv.ToTable().Rows[0]["TTMetadata_Descripcion"].ToString();
        lblId.Text = MyTraductor.getTextDTID(183889, lblId.Text);
        txtId.ToolTip = dv.ToTable().Rows[0]["TTMetadata_Texto_Ayuda"].ToString();
        txtId.Enabled = !Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Solo_lectura"].ToString());
        txtId.MaxLength = int.Parse(dv.ToTable().Rows[0]["TTMetadata_Longitud"].ToString());
        if (Session["Tipo_Transaccion"].ToString() == "New" || !(dv.ToTable().Rows[0]["TTMetadata_Identificador"].ToString() == "True"))
            if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString() != "")
            {
                if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length >= 7)
                {
                    if (dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(0, 7) == "GLOBAL(")
                    {
                        txtId.Text = Session[dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Substring(7, dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString().Length - 8)].ToString();
                    }
                    else
                    {
                        txtId.Text = dv.ToTable().Rows[0]["TTMetadata_Valor_por_defecto"].ToString();
                    }
                }
                else
                {
        ...
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString()))
            imgOblId.Style["display"] = "auto";
        else
            imgOblId.Style["display"] = "none";
        RFVId.Enabled = Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Obligatorio"].ToString());
        if (Boolean.Parse(dv.ToTable().Rows[0]["TTMetadata_Visible"].ToString()))
            trId.Style["display"] = "auto";
        else
    ...
    public Boolean Insert_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.New, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Session["KeyValueInserted"] = myttusuarios_token.InsertWithReturnValue(userData,  MyFunctions.FormatNumberNull(txtUsuario_Token_Campo.Text), MyFunctions.FormatNumberNull(txtId_Usuario.Text), txtToken.Text, txtIdentificador.Text, ChEstado_Logico.Checked, MyFunctions.FormatNumberNull(txtTipoDispositivo.Text), MyFunctions.FormatNumberNull(ddlId_Usuario_TTUsuarios.SelectedValue), MyFunctions.FormatNumberNull(txtId.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public Boolean Update_row()
    {
        ...
        try
        {
            ...
            if (ApplyBusinessRulesWithBreak(TTenumBusinessRules_Operacion.Modification, TTenumBusinessRules_ProcessEvent.BeforeSave, iProcess))
                return false;
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
            myttusuarios_token.Update(userData,  MyFunctions.FormatNumberNull(txtFolio.Text), MyFunctions.FormatNumberNull(txtUsuario_Token_Campo.Text), MyFunctions.FormatNumberNull(txtId_Usuario.Text), txtToken.Text, txtIdentificador.Text, ChEstado_Logico.Checked, MyFunctions.FormatNumberNull(txtTipoDispositivo.Text), MyFunctions.FormatNumberNull(ddlId_Usuario_TTUsuarios.SelectedValue), MyFunctions.FormatNumberNull(txtId.Text));
            //--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if (OperationCompleted)
        {
            ...
            if (Request["pf"] != null)
            {
               if (Request["pf"].ToString() == "1")
					...
					redirect="ttusuarios_token_Lista.aspx?Fase=" + Request["Fase"];
               else
                    redirect="ttusuarios_token_Lista.aspx";
            }
            else if (Request["Fase"] != null)
				redirect="ttusuarios_token_Lista.aspx?Fase=" + Request["Fase"];
            else
  ...
  [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    ...
    public static JsonResult Cancel(bool MenuVisible, bool pf, string Fase)
    {
        try
        {
            ...
            if (MenuVisible)
                return new JsonResult("ttusuarios_token_Lista.aspx?MenuVisible=false", true, null);
            else if (pf != null)
            {
                if (pf)
                        return new JsonResult("../FormsSystem/Default.aspx", true, null);
                else if (Fase != null)
                        return new JsonResult("ttusuarios_token_Lista.aspx?Fase=" + Fase, true, null);
                else
    ...
    /*public void ddlId_Usuario_TTUsuarios_SelectedIndexChanged(object sender, EventArgs e)
    {
    }*/
